...
#include "L1Trc.h"
	...
	#define TrcQBM_InitByCfg1(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x000D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_InitByCfg2(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x010D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_AllocQueueStr(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_4_word(0x020D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define TrcQBM_AllocQueueEnd(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x030D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	#define TrcQBM_AllocQueueEnd(v1, v2, v3, v4)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define TrcQBM_AllocOne(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x040D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TrcQBM_FreeQueue(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x050D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_FreeOne(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_2_word(0x060D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_FreeQ_Str(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_3_word(0x070D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TrcQBM_FreeQ_End(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_4_word(0x080D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_AllocFromFLC(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_2_word(0x090D | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define TrcQBM_Rel2FLCStr(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_2_word(0x0A0D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_Rel2FLCEnd(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_2_word(0x0B0D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_ReloadFromFLC(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_4_word(0x0C0D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_EnQCommon(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x80)!=0 )\
			l2trc_send_4_word(0x0D0D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_EnQWthBypass(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x01)!=0 )\
			l2trc_send_4_word(0x0E0D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define TrcQBM_EnQCommonRx(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x02)!=0 )\
			l2trc_send_3_word(0x0F0D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define TrcQBM_EnQCommonRx(v1, v2, v3)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define TrcQBM_DeQ(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x04)!=0 )\
			l2trc_send_2_word(0x100D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_DeQTx(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x08)!=0 )\
			l2trc_send_4_word(0x110D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_DeQHIF_UL_Str(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x08)!=0 )\
			l2trc_send_4_word(0x120D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_DeQHIF_UL_End(v1, v2, v3, v4, v5) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x04)!=0 )\
			l2trc_send_5_word(0x130D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define TrcQBM_DeQHIF_UL_Skip(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x08)!=0 )\
			l2trc_send_2_word(0x140D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_SetExtParam(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x10)!=0 )\
			l2trc_send_2_word(0x150D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_GetRemain(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x20)!=0 )\
			l2trc_send_2_word(0x160D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_GetRemainFLC_Chk(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x20)!=0 )\
			l2trc_send_3_word(0x170D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TrcQBM_PoolStatus(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x10)!=0 )\
			l2trc_send_3_word(0x180D | ((short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)((char)(v4))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
...
void L1TRC_Send_TrcQBM_AllocQueueEnd(unsigned short v1, unsigned long v2, char v3, unsigned long v4);
...
void L1TRC_Send_TrcQBM_EnQCommonRx(short v1, unsigned long v2, unsigned long v3);
...
void L1TRC_Send_TrcQBM_DeQHIF_UL_Skip(short v1, char v2);
