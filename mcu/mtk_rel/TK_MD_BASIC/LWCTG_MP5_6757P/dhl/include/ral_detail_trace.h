...
#include "L1Trc.h"
	...
	#define RAL_LOG_CR4_TRG_INT(v1) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0011 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define RAL_LOG_CR4_UL_POLL(v1, v2) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x0111 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define RAL_LOG_CR4_DL_POLL(v1, v2) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x0211 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define RAL_LOG_CR4_FDBK_POLL(v1) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0311 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define RAL_LOG_MCU_UL_NO_PKT(v1) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0411 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define RAL_LOG_MCU_ROHC_PROC_START(v1) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0A11 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define RAL_LOG_MCU_ROHC_PROC_STOP(v1) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0B11 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define RAL_LOG_MCU_CR4_CTRL_INFO_ADDR(v1, v2) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x0C11 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define RAL_LOG_MCU_ROHC_ISR(v1) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0D11 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define RAL_LOG_DL_EPDCP_CNT_2_IPID(v1, v2, v3) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x0E11 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
