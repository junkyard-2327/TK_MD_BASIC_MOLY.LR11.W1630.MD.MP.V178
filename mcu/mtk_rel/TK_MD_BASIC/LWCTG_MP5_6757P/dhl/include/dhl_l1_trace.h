...
#define LTE_4G_TIME_GFRC_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0A00, (short)(v2)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v3))
	...
	#define LTE_4G_TIME_RTOS(v1, v2) do {\
		if(DHL_L1_Trace_Filter[0]==1 && (DHL_L1_Trace_Filter[1]&0x04)!=0 )\
...
#define ChkL1ClsFltr_DHL_L1_RTOS_Time_Info()	(ChkL1ModFltr_DHL_L1()&&((DHL_L1_Trace_Filter[1]&0x04)!=0))
...
#define ChkL1MsgFltr_LTE_4G_TIME_RTOS()	ChkL1ClsFltr_DHL_L1_RTOS_Time_Info()
#define ChkL1MsgFltr_PCORE_TRC()	ChkL1ClsFltr_DHL_L1_L1_Info()
#define ChkL1MsgFltr_L1CORE_TRC()	ChkL1ClsFltr_DHL_L1_L1_Info()
