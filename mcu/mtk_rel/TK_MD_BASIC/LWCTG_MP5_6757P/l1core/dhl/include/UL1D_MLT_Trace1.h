...
#include "L1Trc.h"
	...
	#define UL1D_TRC_MLT_ON_OFF(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0019, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_ON_OFF(v1, v2)
#endif
#define UL1D_TRC_MLT_ON_OFF_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0019, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_FILTER_SETTING(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0119, (unsigned short)(v1)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_FILTER_SETTING(v1)
#endif
#define UL1D_TRC_MLT_FILTER_SETTING_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0119, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_TXCRP_DEFAULT(v1, v2, v3, v4, v5) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0219, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_DEFAULT(v1, v2, v3, v4, v5)
#endif
#define UL1D_TRC_MLT_TXCRP_DEFAULT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0219, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_ULPC_RPP_ITP(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0319, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_ULPC_RPP_ITP(v1, v2)
#endif
#define UL1D_TRC_MLT_ULPC_RPP_ITP_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0319, (unsigned char)(v1), (unsigned char)(v2)))
	...
	#define UL1D_TRC_MLT_ULDCH_GAP_FOR_LTE_ONLY(v1, v2, v3, v4, v5) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0419, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_ULDCH_GAP_FOR_LTE_ONLY(v1, v2, v3, v4, v5)
#endif
#define UL1D_TRC_MLT_ULDCH_GAP_FOR_LTE_ONLY_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0419, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_TXBRP_RECONFIG_FLAG_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0519, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXBRP_MIN_MAX_TTI(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0619, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXBRP_MIN_MAX_TTI(v1, v2)
#endif
#define UL1D_TRC_MLT_TXBRP_MIN_MAX_TTI_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0619, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_TG_METHOD(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0719, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_TG_METHOD(v1)
#endif
#define UL1D_TRC_MLT_TXCRP_TG_METHOD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0719, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_CFN(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0819, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_CFN(v1)
#endif
#define UL1D_TRC_MLT_TXCRP_CFN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0819, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_MSG_STSP(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0919, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_MSG_STSP(v1, v2)
#endif
#define UL1D_TRC_MLT_TXCRP_MSG_STSP_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0919, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_PRACH_STSP_SFCC(v1, v2, v3) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A19, (short)(v1)), TRC_MERGE_2S((short)(v2), (unsigned short)(v3)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_PRACH_STSP_SFCC(v1, v2, v3)
#endif
#define UL1D_TRC_MLT_TXCRP_PRACH_STSP_SFCC_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A19, (short)(v1)), TRC_MERGE_2S((short)(v2), (unsigned short)(v3)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_PRE_STSP(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B19, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_PRE_STSP(v1, v2)
#endif
#define UL1D_TRC_MLT_TXCRP_PRE_STSP_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B19, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_PRE_SFCC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C19, (unsigned short)(v1)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_PRE_SFCC(v1)
#endif
#define UL1D_TRC_MLT_TXCRP_PRE_SFCC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C19, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0D19, (unsigned short)(v1)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC(v1)
#endif
#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0D19, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0E19, (unsigned short)(v1)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC(v1)
#endif
#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0E19, (unsigned short)(v1)))

#if defined(L1_CATCHER)
	#define UL1D_TRC_MLT_TM_ST_STROBE(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F19, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TM_ST_STROBE(v1)
#endif
#define UL1D_TRC_MLT_TM_ST_STROBE_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F19, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER)
	#define UL1D_TRC_MLT_TM_CS4_STROBE(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1019, (unsigned short)(v1)), (unsigned long)(v2));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TM_CS4_STROBE(v1, v2)
#endif
#define UL1D_TRC_MLT_TM_CS4_STROBE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1019, (unsigned short)(v1)), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_TM_DD_STROBE(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1119, (unsigned short)(v1)), (unsigned long)(v2));\
	} while(0)
#else
	#define UL1D_TRC_MLT_TM_DD_STROBE(v1, v2)
#endif
#define UL1D_TRC_MLT_TM_DD_STROBE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1119, (unsigned short)(v1)), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_CS_EST_BIN(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1219, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_CS_EST_BIN(v1)
#endif
#define UL1D_TRC_MLT_CS_EST_BIN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1219, (unsigned char)(v1), TRC_BOXSTER_PAD))
	...
	#define UL1D_TRC_MLT_RFM_S_RLID2PSC(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x1319, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_RFM_S_RLID2PSC(v1, v2, v3, v4, v5, v6)
#endif
#define UL1D_TRC_MLT_RFM_S_RLID2PSC_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1319, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_DC_S_RLID2PSC(v1, v2, v3, v4) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1419, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_RFM_DC_S_RLID2PSC(v1, v2, v3, v4)
#endif
#define UL1D_TRC_MLT_RFM_DC_S_RLID2PSC_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1419, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_N_RLID2PSC(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1519, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_RFM_N_RLID2PSC(v1, v2)
#endif
#define UL1D_TRC_MLT_RFM_N_RLID2PSC_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1519, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1619, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX(v1, v2, v3, v4, v5, v6)
#endif
#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1619, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_DC_S_ST0_SYM_IDX(v1, v2, v3, v4) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1719, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_MLT_RFM_DC_S_ST0_SYM_IDX(v1, v2, v3, v4)
#endif
#define UL1D_TRC_MLT_RFM_DC_S_ST0_SYM_IDX_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1719, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1819, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX(v1, v2)
#endif
#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1819, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_AGPS_IMPORTAN(v1, v2, v3, v4) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1919, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define UL1D_TRC_AGPS_IMPORTAN(v1, v2, v3, v4)
#endif
#define UL1D_TRC_AGPS_IMPORTAN_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1919, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_AGPS_REPORT(v1, v2, v3) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1A19, (char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define UL1D_TRC_AGPS_REPORT(v1, v2, v3)
#endif
#define UL1D_TRC_AGPS_REPORT_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1A19, (char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_AGPS_FRC_PARAM(v1, v2, v3, v4) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1B19, (char)(v1), (char)(v3)), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	#define UL1D_TRC_AGPS_FRC_PARAM(v1, v2, v3, v4)
#endif
#define UL1D_TRC_AGPS_FRC_PARAM_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1B19, (char)(v1), (char)(v3)), (unsigned long)(v2), (unsigned long)(v4))

#if defined(L1_CATCHER)
	#define UL1D_TRC_DCH_ASU_CHECK(v1, v2, v3) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1C19, (unsigned short)(v3)), (long)(v1), (long)(v2));\
	} while(0)
#else
	#define UL1D_TRC_DCH_ASU_CHECK(v1, v2, v3)
#endif
#define UL1D_TRC_DCH_ASU_CHECK_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1C19, (unsigned short)(v3)), (long)(v1), (long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_ULDCH_PRINT_FRC_DBG(v1, v2, v3) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1D19, (unsigned char)(v1), (unsigned char)(v3)), (unsigned long)(v2));\
	} while(0)
#else
	#define UL1D_TRC_ULDCH_PRINT_FRC_DBG(v1, v2, v3)
#endif
#define UL1D_TRC_ULDCH_PRINT_FRC_DBG_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1D19, (unsigned char)(v1), (unsigned char)(v3)), (unsigned long)(v2))
...
void L1TRC_Send_UL1D_TRC_MLT_ULDCH_GAP_FOR_LTE_ONLY(unsigned char v1, unsigned char v2, unsigned char v3, unsigned char v4, unsigned char v5);
void L1TRC_Send_UL1D_TRC_MLT_TXBRP_RECONFIG_FLAG(void);
void L1TRC_Send_UL1D_TRC_MLT_TXBRP_MIN_MAX_TTI(unsigned char v1, unsigned char v2);
void L1TRC_Send_UL1D_TRC_MLT_TXCRP_TG_METHOD(unsigned char v1);
void L1TRC_Send_UL1D_TRC_MLT_TXCRP_CFN(unsigned char v1);
void L1TRC_Send_UL1D_TRC_MLT_TXCRP_MSG_STSP(short v1, short v2);
void L1TRC_Send_UL1D_TRC_MLT_TXCRP_PRACH_STSP_SFCC(short v1, short v2, unsigned short v3);
void L1TRC_Send_UL1D_TRC_MLT_TXCRP_PRE_STSP(short v1, short v2);
...
void L1TRC_Send_UL1D_TRC_MLT_TM_CS4_STROBE(unsigned short v1, unsigned long v2);
void L1TRC_Send_UL1D_TRC_MLT_TM_DD_STROBE(unsigned short v1, unsigned long v2);
...
void L1TRC_Send_UL1D_TRC_MLT_RFM_DC_S_RLID2PSC(short v1, short v2, short v3, short v4);
void L1TRC_Send_UL1D_TRC_MLT_RFM_N_RLID2PSC(unsigned char v1, unsigned short v2);
...
void L1TRC_Send_UL1D_TRC_MLT_RFM_DC_S_ST0_SYM_IDX(unsigned char v1, unsigned char v2, unsigned char v3, unsigned char v4);
void L1TRC_Send_UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX(unsigned char v1, unsigned char v2);
...
void L1TRC_Send_UL1D_TRC_ULDCH_PRINT_FRC_DBG(unsigned char v1, unsigned long v2, unsigned char v3);
...
#define ChkL1MsgFltr_UL1D_TRC_MLT_ULDCH_GAP_FOR_LTE_ONLY()	ChkL1ClsFltr_UL1D_MLT_SET1_TX_Mod_M()
