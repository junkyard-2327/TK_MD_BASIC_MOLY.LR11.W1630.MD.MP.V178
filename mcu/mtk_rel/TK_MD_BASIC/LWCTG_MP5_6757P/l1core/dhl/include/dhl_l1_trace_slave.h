#ifndef L1TRC_DHL_L1_SLAVE_DEF_H
#define L1TRC_DHL_L1_SLAVE_DEF_H
...
#include "L1Trc.h"
	...
	#define UMTS_3G_GEMINI_TIME(v1, v2, v3, v4, v5) do {\
		if(DHL_L1_SLAVE_Trace_Filter[0]==1 && (DHL_L1_SLAVE_Trace_Filter[1]&0x01)!=0 )\
...
#define LTE_4G_L2_TIME_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0800, (short)(v1)), (long)(v2), (long)(v3), (long)(v4))
	...
	#define L1_TRC_REDUMP() do {\
		if(DHL_L1_SLAVE_Trace_Filter[0]==1 && (DHL_L1_SLAVE_Trace_Filter[1]&0x02)!=0 )\
...
#define L1_TRC_REDUMP_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0900, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
	...
	#define LTE_4G_TIME_GFRC(v1, v2, v3, v4) do {\
		if(DHL_L1_SLAVE_Trace_Filter[0]==1 && (DHL_L1_SLAVE_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0A00, (short)(v2)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v3));\
	} while(0)
#else
	#define LTE_4G_TIME_GFRC(v1, v2, v3, v4)
#endif
#define LTE_4G_TIME_GFRC_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0A00, (short)(v2)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define LTE_4G_TIME_RTOS(v1, v2) do {\
		if(DHL_L1_SLAVE_Trace_Filter[0]==1 && (DHL_L1_SLAVE_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0B00, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2));\
	} while(0)
#else
	#define LTE_4G_TIME_RTOS(v1, v2)
#endif
#define LTE_4G_TIME_RTOS_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0B00, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PCORE_TRC() do {\
		if(DHL_L1_SLAVE_Trace_Filter[0]==1 && (DHL_L1_SLAVE_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C00, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PCORE_TRC()
#endif
#define PCORE_TRC_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C00, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1CORE_TRC() do {\
		if(DHL_L1_SLAVE_Trace_Filter[0]==1 && (DHL_L1_SLAVE_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D00, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1CORE_TRC()
#endif
#define L1CORE_TRC_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D00, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
/*******************************/
extern unsigned char DHL_L1_SLAVE_Trace_Filter[5];
/*************************/
...
void L1TRC_Send_LTE_4G_TIME_GFRC(long v1, short v2, long v3, short v4);
void L1TRC_Send_LTE_4G_TIME_RTOS(long v1, long v2);
void L1TRC_Send_PCORE_TRC(void);
void L1TRC_Send_L1CORE_TRC(void);

void Set_DHL_L1_SLAVE_Filter(unsigned char *setting);
...
#define ChkL1ModFltr_DHL_L1_SLAVE()	(DHL_L1_SLAVE_Trace_Filter[0]==1)
#define ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()	(ChkL1ModFltr_DHL_L1_SLAVE()&&((DHL_L1_SLAVE_Trace_Filter[1]&0x01)!=0))
#define ChkL1ClsFltr_DHL_L1_SLAVE_L1_Info()	(ChkL1ModFltr_DHL_L1_SLAVE()&&((DHL_L1_SLAVE_Trace_Filter[1]&0x02)!=0))
#define ChkL1ClsFltr_DHL_L1_SLAVE_RTOS_Time_Info()	(ChkL1ModFltr_DHL_L1_SLAVE()&&((DHL_L1_SLAVE_Trace_Filter[1]&0x04)!=0))
#define ChkL1MsgFltr_UMTS_3G_GEMINI_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_UMTS_3G_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_UMTS_2G_GEMINI_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_UMTS_2G_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_UMTS_2G_HANDOVER_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_UMTS_3G_HANDOVER_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_LTE_4G_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_LTE_4G_TIME_2()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_LTE_4G_L2_TIME()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_L1_TRC_REDUMP()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Info()
#define ChkL1MsgFltr_LTE_4G_TIME_GFRC()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Time_Info()
#define ChkL1MsgFltr_LTE_4G_TIME_RTOS()	ChkL1ClsFltr_DHL_L1_SLAVE_RTOS_Time_Info()
#define ChkL1MsgFltr_PCORE_TRC()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Info()
#define ChkL1MsgFltr_L1CORE_TRC()	ChkL1ClsFltr_DHL_L1_SLAVE_L1_Info()
