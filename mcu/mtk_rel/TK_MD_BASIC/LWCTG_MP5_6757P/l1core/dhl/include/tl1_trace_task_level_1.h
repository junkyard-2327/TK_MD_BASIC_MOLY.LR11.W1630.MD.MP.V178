...
#include "L1Trc.h"
	...
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_SERVICE_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0060, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_SERVICE_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_SERVICE_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0060, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_SYNC_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0160, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_SYNC_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_SYNC_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0160, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_TIMING_SYNC_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0260, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_TIMING_SYNC_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_TIMING_SYNC_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0260, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_CALC_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0360, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_CALC_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_CALC_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0360, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_CTRL_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0460, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_CTRL_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_GAP_CTRL_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0460, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_RESET_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0560, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_RESET_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_RESET_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0560, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_RF_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0660, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_RF_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_RF_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0660, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_RAT_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0760, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_RAT_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_RAT_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0760, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_FS_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0860, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_FS_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_FS_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0860, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_SNIFFER_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0960, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_SNIFFER_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_SNIFFER_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0960, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_SCS_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_SCS_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_SCS_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_CONTAINER_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_CONTAINER_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_CONTAINER_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_BCH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_BCH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_BCH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_PCH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_PCH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_PCH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_FACH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0E60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_FACH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_FACH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0E60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_RACH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0F60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_RACH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_RACH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0F60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_RA_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1060, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_RA_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_RA_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1060, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_UL_DCH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1160, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_UL_DCH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_UL_DCH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1160, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_DL_DCH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1260, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_DL_DCH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_DL_DCH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1260, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_HSDSCH_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1360, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_HSDSCH_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_HSDSCH_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1360, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1460, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1460, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_INTERNAL_STATE(v1, v2) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1560, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_INTERNAL_STATE(v1, v2)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_INTERNAL_STATE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1560, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_REL_MEAS_INTERNAL_STATE(v1, v2) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1660, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_REL_MEAS_INTERNAL_STATE(v1, v2)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_REL_MEAS_INTERNAL_STATE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1660, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_INTERNAL_RSLT_STATE(v1, v2) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1760, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_INTERNAL_RSLT_STATE(v1, v2)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_MEAS_INTERNAL_RSLT_STATE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1760, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_SUSPEND_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1860, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_SUSPEND_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_SUSPEND_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1860, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_PEER_2G_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1960, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_PEER_2G_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_PEER_2G_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1960, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_VIRTUAL_MODE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_VIRTUAL_MODE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_VIRTUAL_MODE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_CHANNEL_PROTECT_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1B60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_CHANNEL_PROTECT_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_CHANNEL_PROTECT_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1B60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_PEER_2G_OPEN(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C60, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_PEER_2G_OPEN(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_PEER_2G_OPEN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C60, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_L1R_Peer2GOpenConfirm() do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1D60, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_L1R_Peer2GOpenConfirm()
#endif
#define AST_L1_Trace_Task_Context_Group1_L1R_Peer2GOpenConfirm_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1D60, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_L1R_3GProtectChannel() do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1E60, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_L1R_3GProtectChannel()
#endif
#define AST_L1_Trace_Task_Context_Group1_L1R_3GProtectChannel_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1E60, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_L1R_3GCancelProtection() do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1F60, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_L1R_3GCancelProtection()
#endif
#define AST_L1_Trace_Task_Context_Group1_L1R_3GCancelProtection_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1F60, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_L1R_3GEnterVirtualMode(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2060, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_L1R_3GEnterVirtualMode(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_L1R_3GEnterVirtualMode_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2060, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_B39_TX_STATE(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2160, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_B39_TX_STATE(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_B39_TX_STATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2160, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_RX_POWER(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2260, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_RX_POWER(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_RX_POWER_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2260, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_DVFS_SCENARIO_SWITCH(v1, v2) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2360, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_DVFS_SCENARIO_SWITCH(v1, v2)
#endif
#define AST_L1_Trace_Task_Context_Group1_DVFS_SCENARIO_SWITCH_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2360, (unsigned char)(v1), (unsigned char)(v2)))
	...
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE1(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2460, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE1(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE1_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2460, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE2(v1, v2) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2560, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE2(v1, v2)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE2_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2560, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE3(v1, v2, v3) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2660, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE3(v1, v2, v3)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE3_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2660, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE4(v1, v2, v3, v4) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2760, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE4(v1, v2, v3, v4)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE4_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2760, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE5(v1, v2, v3, v4, v5) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2860, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE5(v1, v2, v3, v4, v5)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_TRACE5_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2860, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_MSG_2(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2960, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_MSG_2(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_MSG_2_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2960, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group1_TEST_MSG_3(v1) do {\
		if(AST_L1_Trace_Task_Context_Group1_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x2A60, (unsigned short)(v1)));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group1_TEST_MSG_3(v1)
#endif
#define AST_L1_Trace_Task_Context_Group1_TEST_MSG_3_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2A60, (unsigned short)(v1)))
...
void L1TRC_Send_AST_L1_Trace_Task_Context_Group1_DVFS_SCENARIO_SWITCH(unsigned char v1, unsigned char v2);
