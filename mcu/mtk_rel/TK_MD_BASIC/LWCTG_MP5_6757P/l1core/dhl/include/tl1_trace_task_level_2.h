...
#include "L1Trc.h"
	...
	#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_1(v1) do {\
		if(AST_L1_Trace_Task_Context_Group2_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group2_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0061, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_1(v1)
#endif
#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_1_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0061, (unsigned char)(v1), TRC_BOXSTER_PAD))
	...
	#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_2(v1) do {\
		if(AST_L1_Trace_Task_Context_Group2_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group2_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0161, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_2(v1)
#endif
#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_2_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0161, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_3(v1) do {\
		if(AST_L1_Trace_Task_Context_Group2_Trace_Filter[0]==1 && (AST_L1_Trace_Task_Context_Group2_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0261, (unsigned short)(v1)));\
	} while(0)
#else
	#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_3(v1)
#endif
#define AST_L1_Trace_Task_Context_Group2_TEST_MSG_3_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0261, (unsigned short)(v1)))
