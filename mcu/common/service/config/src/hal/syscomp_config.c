...
#define task_multi_core_module_map(p1,p2)
#define task_multi_core_module_map_with_assignment(p1,p2,p3)
#define multi_core_module_remap(p1)
#define MODULE_ID_MULTI_CORE_MAP_TO_NULL_TASK_CAN_ALLOCATE_ILM(p1)
#define MODULE_ID_MULTI_CORE_FOR_PRINT_TRACE(p1)
...
#define task_multi_core_module_map(task, mod)                       task,
#define task_multi_core_module_map_with_assignment(task,mod1,mod2)  task,
#define MODULE_ID_MAP_TO_NULL_TASK_CAN_ALLOCATE_ILM(p1) INDX_NIL,
#define MODULE_ID_FOR_PRINT_TRACE(p1) INDX_NIL,
#define MODULE_ID_MULTI_CORE_MAP_TO_NULL_TASK_CAN_ALLOCATE_ILM(p1)  INDX_NIL,
#define MODULE_ID_MULTI_CORE_FOR_PRINT_TRACE(p1)                    INDX_NIL,
...
/* if you change KAL_MAX_NUM_HISRS, please also modify HISR_ID_CODE_MAX in HISR_ID_CODE_BEGIN*/
...
#define X_MULTI_CORE_HISR_MOD(a,h)
...
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const buffer_size_s cfg_cc_ctrl_buff[] =
{
    {CC_CTRL_BUFF_POOL_SIZE32, (NUM_CC_CTRL_BUFF_POOL_SIZE32 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE32)},
    {CC_CTRL_BUFF_POOL_SIZE64, (NUM_CC_CTRL_BUFF_POOL_SIZE64 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE64)},
    {CC_CTRL_BUFF_POOL_SIZE128, (NUM_CC_CTRL_BUFF_POOL_SIZE128 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE128)},
    {CC_CTRL_BUFF_POOL_SIZE256, (NUM_CC_CTRL_BUFF_POOL_SIZE256 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE256)},
    {CC_CTRL_BUFF_POOL_SIZE512, (NUM_CC_CTRL_BUFF_POOL_SIZE512 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE512)},
    {CC_CTRL_BUFF_POOL_SIZE1024, (NUM_CC_CTRL_BUFF_POOL_SIZE1024 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE1024)},
    {CC_CTRL_BUFF_POOL_SIZE2048, (NUM_CC_CTRL_BUFF_POOL_SIZE2048 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE2048)},
    {CC_CTRL_BUFF_POOL_SIZE4096, (NUM_CC_CTRL_BUFF_POOL_SIZE4096 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE4096)},
#if defined(__UMTS_RAT__)
    {CC_CTRL_BUFF_POOL_SIZE8192, (NUM_CC_CTRL_BUFF_POOL_SIZE8192 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE8192)},
    {CC_CTRL_BUFF_POOL_SIZE16384, (NUM_CC_CTRL_BUFF_POOL_SIZE16384 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE16384)},
    {CC_CTRL_BUFF_POOL_SIZE32768, (NUM_CC_CTRL_BUFF_POOL_SIZE32768 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE32768)},
    {CC_CTRL_BUFF_POOL_SIZE65536, (NUM_CC_CTRL_BUFF_POOL_SIZE65536 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE65536)},
    {CC_CTRL_BUFF_POOL_SIZE100000, (NUM_CC_CTRL_BUFF_POOL_SIZE100000 + NUM_CUSTOM_CC_CTRL_BUFF_POOL_SIZE100000)},
#endif
};
...
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_cb = sizeof(CC_AFM_CB_T);


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_pool_cb = sizeof(CC_AFM_POOL_CB_T);


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_MB_overhead = sizeof(CC_AFM_MB_HEAD_T) + sizeof(CC_AFM_MB_HEADGUD_T) + sizeof(CC_AFM_MB_FOOTGUD_T) ;


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_pool_stat = sizeof(CC_AFM_POOL_STAT_T);

#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_MB_stat = sizeof(CC_AFM_MB_STAT_T);


#else /* !defined(__KAL_CROSS_CORE_SUPPORT__) */


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const buffer_size_s cfg_cc_ctrl_buff[] = {    {0, (0)},};


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_cb = 0;


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_pool_cb = 0;


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_MB_overhead = 0;


#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_pool_stat = 0;

#ifdef __MTK_TARGET__
__attribute__ ((section ("SHOULD_NOT_USED_RODATA"))) 
#endif /* __MTK_TARGET__ */
const kal_uint32 cfg_cc_afm_MB_stat = 0;
