 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_21B, "In kal_init_hisr(), the parameter HISR index is not found in hisr_info[]!")
   ...
   TRC_MSG(SST_PHASE2_207_TASKID_SUB2_P1, "Task %c%c%c%c%c%c%c%c sufferes from stack overflow, and its stack size is %dBytes.")   
    ...
    TRC_MSG(SST_PHASE2_20A_01, "Setting an invalid active module id 0x%x. Task owner please check.")
    TRC_MSG(SST_PHASE2_20A_02, "Setting an invalid active module id. Task owner please check.")
   ...
   TRC_MSG(SST_PHASE2_216_9_1_P1, "My dear, pointer used in activating HISR is corrupted, where tc_id is no longer 0x48495352!")
    ...
    TRC_MSG(SST_PHASE2_21B, "kal_init_hisr() with invaild HISR index is called by caller address 0x%08X")
   ...
   TRC_MSG(SST_PHASE3_21B_P1, "Please contact the owner in-charge of caller address 0x%08X to check")
   TRC_MSG(SST_PHASE3_21B_P2, "whether this HISR should be initialized in this compile option!")
