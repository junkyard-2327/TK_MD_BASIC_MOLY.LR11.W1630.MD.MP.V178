 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_881_PTR_P1, "In kal_get_buffer(), it is detected that buffer pool ID is incorrect in PM header. It was previously ")
   TRC_MSG(SST_PHASE1_881_PTR_P2, "successfully released and is now regarded as free entry.  It may be corrupted during the free period.")
   ...
   TRC_MSG(SST_PHASE2_BUFFER_CORRUPT_REASONS, "Buffer may be corrupted by the owner of current, previous or next buffer entry!")
   ...
   /* KAL_ERROR_BUFFMNGR_POOLID_FAILED_GET */   
   TRC_MSG(SST_PHASE2_881_PTR, "Please refer to buffer header listed above, buffer pool ID value 0x%08X is incorrect, it should be 0x%08X!")
