...
typedef enum {
    ...
    LAST_MOD_ID = ( MODULE_TAG_CO_PROCESSOR_SRV_TAIL - MOD_ID_CO_PROCESSOR_SRV_CODE_BEGIN + 1 +
                    MODULE_TAG_CO_PROCESSOR_MODEM_DUMMY_TAIL - MOD_CO_PROCESSOR_MODEM_DUMMY_BEGIN + 1 +
                    MODULE_TAG_CO_PROCESSOR_MODEM_4G_DUMMY_TAIL - MOD_CO_PROCESSOR_MODEM_4G_DUMMY_BEGIN + 1 +
                    MODULE_TAG_CO_PROCESSOR_MW_DUMMY_TAIL - MOD_CO_PROCESSOR_MW_DUMMY_BEGIN + 1 + 
                    MODULE_TAG_CO_PROCESSOR_DRV_DUMMY_TAIL - MOD_CO_PROCESSOR_DRV_DUMMY_BEGIN + 1) + (2 + KAL_MAX_NUM_HISRS),
