...
typedef struct kalcc_internal_rcu_t{
    ...
    kal_uint8                   rcu_padding[36];   /* align to 128 bytes since spinlock is 64 bytes alignment */
}kalcc_internal_rcu_type, *kalcc_internal_rcuid;


/* v4, hard code for spinlock requirement */
#define SPINLOCK_SIZE           (64)
#define SPINLOCK_ALIGNMENT      (64)
