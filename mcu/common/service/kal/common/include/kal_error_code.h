...
X_KAL_ERROR(KAL_ERROR_TASKMNGT_STACKOVERFLOW_BY_MPU,                             kal_fatal_error_handler_int__stack_overflow)
X_KAL_ERROR(KAL_ERROR_TASKMNGT_SET_ACTIVE_MODULE_ID_INVALID,                     set_active_module_id_invalid)
...
/* DSM */
X_KAL_ERROR_ASSIGN(KAL_ERROR_INVALID_DSM_LOAD_ID_OUT_OF_RANGE,            0x1900,    dsm_load___load_section_id_out_of_range)
...
/* CC AFM */
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_CREATE_FAILED,                        0x2000,   create___ccafm_create_failed)
X_KAL_ERROR(KAL_ERROR_CC_AFM_CREATE_NOT_IN_INIT_STAGE,                              create___ccafm_create_not_in_init_stage)
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_DELETE_FAILED,                        0x2010,   delete___ccafm_delete_failed)
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_ALLOC_FAILED,                         0x2020,   alloc___ccafm_alloc_failed)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_DYNCACHE_FAILED,                                 alloc___ccafm_switch_cache_failed)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_IN_INIT_STAGE,                                   alloc___ccafm_alloc_in_init_stage_failed)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_NOT_AVAILABLE,                                   alloc___ccafm_run_out_of_avaiable_buffer)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_NOT_CACHELINE_ALIGNED,                           alloc___ccafm_alloc_not_cacheline_aligned)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_DOUBLEALLOC,                                     alloc___ccafm_double_alloc)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_GETBUFF_POOLINDX_OUT_OF_RANGE,                   alloc___ccafm_alloc_out_of_range)
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_FREE_IN_INIT_STAGE,                   0x2040,   alloc___ccafm_free_failed)
X_KAL_ERROR(KAL_ERROR_CC_AFM_FREE_DOUBLEFREE,                                       free___ccafm_double_free)
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_FOOTER_FAILED,                        0x2050,   check___ccafm_footer_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_HEADER_FAILED,                                         check___ccafm_header_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_FOOTER_FAILED_GET,                                     alloc___ccafm_footer_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_HEADER_FAILED_GET,                                     alloc___ccafm_header_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_FREEPATTERN_CORRUPTION,                                alloc___ccafm_freepattern_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_MBSTATUS_INCORRECT,                                    fail___ccafm_mb_status_incorrect)
X_KAL_ERROR(KAL_ERROR_CC_AFM_EXT_FOOTER_FAILED,                                     alloc___ccafm_ext_footer_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_CACHED_EXT_FOOTER_CORRUPTION,                    alloc___ccafmid_cached_ext_footer_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOCATE_MB_INDEX_CORRUPTION,                          alloc___ccafm_mb_index_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_FREE_MB_INDEX_CORRUPTION,                              free___ccafm_mb_index_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_MB_INDEX_CORRUPTION,                                   check___ccafm_mb_index_corrupted)
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_NILPTR,                               0x2060,   fail___ccafm_get_a_null_pointer)
X_KAL_ERROR(KAL_ERROR_CC_AFM_DELETE_NILPTR,                                         fail___ccafm_delete_null_pool)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_NILPTR,                                          fail___ccafm_alloc_null_pool)
X_KAL_ERROR(KAL_ERROR_CC_AFM_FREE_NILPTR,                                           fail___ccafm_free_null_pool)
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_AFM_BADID,                                0x2070,   fail___ccafmid_in_cb_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_DELETE_BADID,                                          delete___ccafmid_in_cb_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_ALLOC_BADID,                                           alloc___ccafmid_in_cb_corrupted)
X_KAL_ERROR(KAL_ERROR_CC_AFM_FREE_BADID,                                            free___ccafmid_in_cb_corrupted)
...
X_KAL_ERROR(KAL_ERROR_CC_INVALID_RCU_CACHED_MEM_IN_GET_BUFF,                     rcu_get_buff___rcu_is_cached_memory)
X_KAL_ERROR(KAL_ERROR_CC_INVALID_RCU_CACHED_MEM_IN_COMMIT_BUFF,                  rcu_commit_data___rcu_buff_is_cached_memory)
X_KAL_ERROR(KAL_ERROR_CC_INVALID_RCU_CACHED_MEM_IN_GET_READ_LOCK,                rcu_get_data___rcu_is_cached_memory)
X_KAL_ERROR(KAL_ERROR_CC_INVALID_RCU_CACHED_MEM_IN_FREE_READ_LOCK,               rcu_free_data___rcu_buff_is_cached_memory)
X_KAL_ERROR(KAL_ERROR_CC_INVALID_RCU_NONSHARED,                                  rcu_create___rcu_is_not_in_share_memory)
X_KAL_ERROR(KAL_ERROR_CC_INVALID_RCU_DATA_RCU_ID,                                rcu_general___wrong_buffer_pointer)

/* Cross Core IRQ - intercore */
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_IRQ_INVALID_ACCESS_AT_EPOF,            0x2200,   ccirq_invalid_access_during_epof___fail)


/* Cross Core ILM */
X_KAL_ERROR_ASSIGN(KAL_ERROR_CC_INVALID_MODULE_ID_OUT_OF_RANGE,           0x2300,   ilm___module_id_out_of_range)
X_KAL_ERROR(KAL_ERROR_CC_INVALID_ILM_MEMORY,                                        ilm___cross_core_ilm_not_allocated_from_shared_memory)
X_KAL_ERROR(KAL_ERROR_CC_GLOBAL_DEST_MOD_ID_TO_LOCAL_NOT_FOUND,                     ilm___cross_core_global_dest_mod_id_to_local_not_found)
...
X_KAL_ERROR(KAL_ERROR_CC_ILM_CONSTRUCT_IN_INVALID_SIZE,                             construct_int_cc__unexpected_allocated_size)
X_KAL_ERROR(KAL_ERROR_CC_ILM_QENQUE_EXT_FAILED,                                     do_send_msg_extq_to_head___fail)
...
X_KAL_ERROR(KAL_ERROR_CC_ITC_EG_LONG_TIME_NO_RESPONSE,                              cc_event_group___no_ack_from_another_core)
...
X_KAL_ERROR(KAL_ERROR_CC_ARM7_EXCP,                                                  ARM7___excp)
