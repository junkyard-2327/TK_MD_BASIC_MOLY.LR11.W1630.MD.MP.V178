...
// Cache profiling facilities for EL1
#ifdef __L1CORE__
#define __L1CORE_CACHE_PROFILING__
typedef enum
{
    PMU_L1_CACHE_PROFILING_DISABLE,
    PMU_L1_CACHE_PROFILING_ENABLE,
} PMU_L1_CACHE_PROFILING_STATUS;
typedef enum
{
    PMU_L1_ICACHE,
    PMU_L1_DCACHE,
} PMU_L1_CACHE_PROFILING_SWITCH;
extern PMU_L1_CACHE_PROFILING_STATUS volatile l1_cache_profiling_en;
typedef struct {
	kal_uint32 miss_count;
	kal_uint32 access_count;
	PMU_L1_CACHE_PROFILING_STATUS status;
}cache_profiling;

PMU_L1_CACHE_PROFILING_STATUS L1CORE_PMU_CacheProf_Config(PMU_L1_CACHE_PROFILING_SWITCH cache_switch);
kal_bool L1CORE_PMU_CacheProf_Enable();
kal_bool L1CORE_PMU_CacheProf_Disable();
cache_profiling L1CORE_PMU_CacheProf_GetCounter();
#endif
