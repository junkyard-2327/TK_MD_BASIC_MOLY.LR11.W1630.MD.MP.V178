 ...
 * Description:
 * ------------
 *   Custom MPU region setting for TK6291
 *
 * Author:
 * -------
 * -------
...
X_MPU_PREINIT_REGION(   MDSYS_APB_SO,   0x80000000, RGN_SIZE_256MB, MPU_SOM|MPU_PRW_URW,  1)
X_MPU_PREINIT_REGION(   MDSYS_APB_SO,   0xF0000000, RGN_SIZE_256MB, MPU_SOM|MPU_PRW_URW,  1)
X_MPU_PREINIT_REGION(   APSYS_APB_SO,   0xC0000000, RGN_SIZE_256MB, MPU_SOM|MPU_PRW_URW,  1)
X_MPU_PREINIT_REGION(   APSYS_APB_SO,   0x90000000, RGN_SIZE_256MB, MPU_SOM|MPU_PRW_URW,  1)
#ifdef __MASE__
X_MPU_PREINIT_REGION(   MDSYS_APB_SO2,   0xE0000000, RGN_SIZE_256MB, MPU_SOM|MPU_PRW_URW,  1)
#endif
//X_MPU_PREINIT_REGION(   MDSYS_APB_SO,   0xC0000000, RGN_SIZE_128MB, MPU_SOM|MPU_PRW_URW,                1       )
...
//X_MPU_INIT_REGION_EX(   APB_DEV,        0x0,        RGN_SIZE_2GB,   MPU_DEVICE_INNS_OUTDEV|MPU_PRW_URW|MPU_XN,  0xC7)
X_MPU_INIT_REGION_EX(   BR_0,        0x0,        RGN_SIZE_2GB,   MPU_NORMAL_INNC_OUTNC|MPU_PN_UN|MPU_XN,  0x40)
#ifdef __MASE__
X_MPU_INIT_REGION_EX(   BR_1, 0x80000000,        RGN_SIZE_2GB,   MPU_NORMAL_INNC_OUTNC|MPU_PN_UN|MPU_XN,  0xF3)
#else
X_MPU_INIT_REGION_EX(   BR_1, 0x80000000,        RGN_SIZE_2GB,   MPU_NORMAL_INNC_OUTNC|MPU_PN_UN|MPU_XN,  0xB3)
#endif
