...
MODULE_MOD_BEGIN(MOD_ID_MODEM_2G3G_CODE_BEGIN)
    #include "pcore_modem_2g3g_task_config.h"
...
MODULE_MOD_BEGIN(MOD_ID_CO_PROCESSOR_MODEM_2G3G_CODE_BEGIN)
    #include "l1core_modem_2g3g_task_config.h"
MODULE_MOD_END(MOD_ID_CO_PROCESSOR_MODEM_2G3G_CODE_TAIL)
...
MODULE_MOD_BEGIN(MOD_ID_MODEM_2G3G_CODE_REMAP_BEGIN)  
    #include "modem_2g3g_task_config.h"
MODULE_MOD_END(MOD_ID_MODEM_2G3G_CODE_REMAP_TAIL)
#endif /* !GEN_FOR_PC */
