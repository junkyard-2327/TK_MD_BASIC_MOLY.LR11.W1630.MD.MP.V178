...
#ifdef __REMOTE_SIM__
 MSG_ID_EMM_SEC_EVALIF_RSIM_AUTH_FINISH_IND,
...
#if defined(__MULTIPLE_PS__) || defined(__REMOTE_SIM__)
//Currently this interface is only used for RSIM, multiple PS part is reserved for flexibility.
MSG_ID_EMM_PLMNSEL_SEC_VIRTUAL_MODE_STATUS_UPDATE_IND,
#endif
...
#ifdef __REMOTE_SIM__
MSG_ID_EMM_TIMERIF_SEC_T_RESEND_AUTH_TIMEOUT_IND,
#endif /* __REMOTE_SIM__ */
