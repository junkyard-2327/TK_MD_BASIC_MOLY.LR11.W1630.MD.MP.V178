...
MODULE_MOD_BEGIN(MOD_ID_SRV_CODE_BEGIN) 
    #include "pcore_srv_task_config.h"
...
MODULE_MOD_BEGIN(MOD_ID_CO_PROCESSOR_SRV_CODE_BEGIN)
    MOD_CO_PROCESSOR_NIL = MOD_ID_CO_PROCESSOR_SRV_CODE_BEGIN, 
    #include "l1core_srv_task_config.h"
MODULE_MOD_END(MOD_ID_CO_PROCESSOR_SRV_CODE_TAIL)
...
MODULE_MOD_BEGIN(MOD_ID_SRV_CODE_REMAP_BEGIN)  
    #include "srv_task_config.h"
MODULE_MOD_END(MOD_ID_SRV_CODE_REMAP_TAIL)
#endif /* !GEN_FOR_PC */
