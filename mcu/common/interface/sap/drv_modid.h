...
MODULE_MOD_BEGIN(MOD_ID_DRV_CODE_BEGIN)
	#include "pcore_drv_task_config.h"
...
MODULE_MOD_BEGIN(MOD_ID_CO_PROCESSOR_DRV_CODE_BEGIN)
    #include "l1core_drv_task_config.h"
MODULE_MOD_END(MOD_ID_CO_PROCESSOR_DRV_CODE_TAIL)
...
MODULE_MOD_BEGIN(MOD_ID_DRV_CODE_REMAP_BEGIN)  
    #include "drv_task_config.h"
MODULE_MOD_END(MOD_ID_DRV_CODE_REMAP_TAIL)
#endif /* !GEN_FOR_PC */
