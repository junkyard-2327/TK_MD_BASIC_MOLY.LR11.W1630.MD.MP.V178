...
MODULE_MSG_BEGIN( MSG_ID_HIF_SVC_CODE_BEGIN )
	...
	/* L1Core -> Pcore -> AP */
	MSG_ID_CCCI_AP_L1C_SYSMSG_IND,
    MSG_ID_CCCI_PSC_L1C_IPC_IND,
    MSG_ID_CCCI_PSC_L1C_IPC_RSP,
	MSG_ID_CCCI_PSC_L1C_RPC_IND,
    MSG_ID_CCCI_PSC_L1C_RPC_RSP,

	/* AP -> PCore -> L1Core */
	MSG_ID_CCCI_AP_L1C_SYSMSG_REQ,
	//MSG_ID_AP_L1C_CCCIIPC_REQ, // AP to MD ipc is send by CCILM
    
	/* Reserved for L1Core CCCI Service IT */
    MSG_ID_CCCI_IT_L1C_RPC_REQ,
    MSG_ID_CCCI_IT_L1C_RPC_CNF,
	MSG_ID_CCCI_IT_L1C_IPC_REQ,
    MSG_ID_CCCI_IT_L1C_IPC_CNF,
    MSG_ID_CCCI_IT_L1C_SYSMSG_REQ,
    MSG_ID_CCCI_IT_L1C_SYSMSG_CNF,
    MSG_ID_CCCI_EMI_ACCESS_VIOLATION_L1C_IND,
