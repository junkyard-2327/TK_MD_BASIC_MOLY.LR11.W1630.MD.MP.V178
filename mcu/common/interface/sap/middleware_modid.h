...
MODULE_MOD_BEGIN(MOD_ID_MIDDLEWARE_CODE_BEGIN)
    #include "pcore_middleWare_task_config.h"
...
MODULE_MOD_BEGIN(MOD_ID_CO_PROCESSOR_MIDDLEWARE_CODE_BEGIN)
    #include "l1core_middleWare_task_config.h"
MODULE_MOD_END(MOD_ID_CO_PROCESSOR_MIDDLEWARE_CODE_TAIL)
...
MODULE_MOD_BEGIN(MOD_ID_MIDDLEWARE_CODE_REMAP_BEGIN)  
    #include "middleWare_task_config.h"
MODULE_MOD_END(MOD_ID_MIDDLEWARE_CODE_REMAP_TAIL)
#endif /* !GEN_FOR_PC */
