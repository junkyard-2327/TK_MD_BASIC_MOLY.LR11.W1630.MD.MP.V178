...
LID_BIT VER_LID(NVRAM_EF_FAILURE_LIST_LID)
    ...
    {        
        ...
        event_counter:"EVENT_COUNTER[50]"
        {
        };    
        maxlogtime:"MAX_LOGTIME"
        {
        };    
        maxevtcounter:"MAX_EVTCOUNTER"
        {
        };    
...
LID_BIT VER_LID(NVRAM_EF_T3402_INFO_LID)
    ...
    {        
        t3402_length:"T3402_LENGTH"
        {        
        };
        last_t3402_plmn:"LAST_T3402_PLMN"
        {        
        };
        t3402_plmn:"T3402_PLMN_ID[10]"
        {
        };    
        t3402_expire_time:"T3402_EXPIRE_TIME[10]"
        {
        };    
    };
