...
typedef enum
{
        NVRAM_EF_VSIM_RSA_KEY_LID                = NVRAM_LID_GRP_VSIM(0),    
		NVRAM_EF_KEYGEN_LID,
        NVRAM_VSIM_CONFIG_LID,
        NVRAM_VSIM_PROFILE_LID,        
        NVRAM_EF_VSIM_SIM_IMSI_LID,
        NVRAM_EF_VSIM_U_IMSI_LID,  
		
        /*Add LID must before NVRAM_EF_VSIM_LAST_LID*/
...
#define NVRAM_VSIM_CONFIG_TOTAL         (1 * NVRAM_DUAL_RECORD)
#define NVRAM_VSIM_CONFIG_SIZE          (2)
#define NVRAM_VSIM_PROFILE_TOTAL        (VSIM_PROFILE_ENTRY)
#define NVRAM_VSIM_PROFILE_SIZE         (521)
