 ...
 * PARAMETERS:
 *  module_type: [IN] module Id
 * RETURNS
 *  Return the parameter moudle is MD1 module, MD2 module, MD3 module, 
 *  pcore module, l1core module, or module not in defined range
 * SEE ALSO
 *
 *************************************************************************/
extern kal_module_core kal_query_module_core(module_type module_id);
...
extern void destroy_int_shared_ilm_r(ilm_struct *ilm_ptr, const kal_char* file_name, kal_uint32 line);
extern void free_int_shared_peer_buff_r(peer_buff_struct *peer_buff_ptr, const kal_char* file, kal_uint32 line);
extern void free_int_shared_local_para_r(local_para_struct *local_para_ptr, const kal_char* file, kal_uint32 line);
...
#define __destroy_shared_ilm_r(ilm_ptr)                    destroy_int_shared_ilm_r((ilm_ptr), (kal_char*)__FILE__, __LINE__ );

#define __free_shared_peer_buff_r(peer_buff, file, line)   free_int_shared_peer_buff_r(peer_buff, (kal_char*)file, line)
#define __free_shared_local_para_r(local_para, file, line) free_int_shared_local_para_r(local_para, (kal_char*)file, line);
...
#define destroy_shared_ilm_r(ilm_ptr)        __destroy_shared_ilm_r(ilm_ptr)

#define free_shared_peer_buff_r(peer_buff)   __free_shared_peer_buff_r(peer_buff, __FILE__, __LINE__)
#define free_shared_local_para_r(local_para) __free_shared_local_para_r(local_para, __FILE__, __LINE__);
 ...
 *******************************************************************************/
extern void* construct_int_cc_cached_peer_buff(kal_uint16 pdu_len, kal_uint16  header_len,
        kal_uint16 tail_len, kal_char* file_name_ptr, kal_uint32 line);
extern void* construct_int_cc_non_cached_peer_buff(kal_uint16 pdu_len, kal_uint16  header_len,
        kal_uint16 tail_len, kal_char* file_name_ptr, kal_uint32 line);
extern void* construct_int_cc_cached_local_para(kal_uint16 local_para_size,
        kal_uint32 auto_reset, kal_char* file_ptr, kal_uint32 line);
extern void* construct_int_cc_non_cached_local_para(kal_uint16 local_para_size,
        kal_uint32 auto_reset, kal_char* file_ptr, kal_uint32 line);

#if defined(DEBUG_KAL) && defined(DEBUG_BUF2)
#define __construct_int_cc_cached_local_para(local_para_size, direction) \
        construct_int_cc_cached_local_para(local_para_size, ((kal_uint32)(direction) & (kal_uint32)TD_RESET)? 1 : 0, __FILE__, __LINE__)
#define __construct_int_cc_non_cached_local_para(local_para_size, direction) \
        construct_int_cc_non_cached_local_para(local_para_size, ((kal_uint32)(direction) & (kal_uint32)TD_RESET)? 1 : 0, __FILE__, __LINE__)

#define __construct_int_cc_cached_peer_buff(pdu_len, header_len, tail_len, direction) \
        construct_int_cc_cached_peer_buff(pdu_len, header_len, tail_len, __FILE__, __LINE__)
#define __construct_int_cc_non_cached_peer_buff(pdu_len, header_len, tail_len, direction) \
        construct_int_cc_non_cached_peer_buff(pdu_len, header_len, tail_len, __FILE__, __LINE__)

#else /* !DEBUG_KAL || !DEBUG_BUF2 */
#define __construct_int_cc_cached_local_para(local_para_size, direction) \
        construct_int_cc_cached_local_para(local_para_size, ((kal_uint32)(direction) & (kal_uint32)TD_RESET)? 1 : 0, NULL, 0)
#define __construct_int_cc_non_cached_local_para(local_para_size, direction) \
        construct_int_cc_non_cached_local_para(local_para_size, ((kal_uint32)(direction) & (kal_uint32)TD_RESET)? 1 : 0, NULL, 0)
...
kal_bool msg_send_cc(ilm_struct *ilm_ptr);


kal_bool msg_send6_cc(module_type _src_mod_id, module_type _dest_mod_id, sap_type _sap_id, msg_type _msg_id,
                   local_para_struct *_local_para_ptr, peer_buff_struct *_peer_buff_ptr);
kal_bool msg_send5_cc(module_type _src_mod_id, module_type _dest_mod_id, sap_type _sap_id, msg_type _msg_id,
                   local_para_struct *_local_para_ptr);
kal_bool msg_send4_cc(module_type _src_mod_id, module_type _dest_mod_id, sap_type _sap_id, msg_type _msg_id);


kal_bool msg_send_to_head_cc(ilm_struct *ilm_ptr);
kal_bool msg_send_to_head6_cc(module_type _src_mod_id, module_type _dest_mod_id,
        sap_type _sap_id, msg_type _msg_id,
        local_para_struct *_local_para_ptr, peer_buff_struct *_peer_buff_ptr);
kal_bool msg_send_to_head5_cc(module_type _src_mod_id, module_type _dest_mod_id,
        sap_type _sap_id, msg_type _msg_id, local_para_struct *_local_para_ptr);
kal_bool msg_send_to_head4_cc(module_type _src_mod_id, module_type _dest_mod_id,
        sap_type _sap_id, msg_type _msg_id);



kal_bool msg_send_inline6_cc(module_type src_mod, module_type dest_mod,
        sap_type sap_id, msg_type msg_id, void *data, kal_uint32 datalen);
kal_bool msg_send_inline_to_head6_cc(module_type src_mod, module_type dest_mod,
        sap_type sap_id, msg_type msg_id, void *data, kal_uint32 datalen);
...
#define msg_send_inline_to_head5_cc(src_mod, dest_mod, sap_id, msg_id, data,datalen) \
	msg_send_inline_to_head6_cc(src_mod, dest_mod, INLINE_ILM_SAP, msg_id, data, datalen)



kal_bool msg_send_8bytes_inline6_cc(module_type src_mod, module_type dest_mod,
        sap_type sap_id, msg_type msg_id, kal_uint32 data1, kal_uint32 data2);

kal_bool msg_send_8bytes_inline_to_head6_cc(module_type src_mod, module_type dest_mod, 
        sap_type sap_id, msg_type msg_id, kal_uint32 data1, kal_uint32 data2);
 ...
 ******************************************************************************/
kal_status kalcc_set_eg_events(cc_eventgrpid *eg_id, kal_uint32 events, kal_uint8 operation);
/*******************************************************************************
 * <GROUP Communication>
 *
 * FUNCTION
 ...
 ******************************************************************************/
kal_status kalcc_retrieve_eg_events(cc_eventgrpid *eg_id, kal_uint32 requested_events,
...
/* 1. creator*/
kalcc_rcuid rcu_create(void *buff_addr, kal_uint32 allocated_buff_size, kal_uint32 buff_size, kal_uint32 reserved);
/* 2. writer */
...
/*******************************************************************************
 * Category 6.5 : Cross Core Memory Management  CC_Ctrl_Buff
 *******************************************************************************/

extern void* kalcc_afm_alloc_nc(kal_uint32 size, kal_char *filename, kal_uint32 line);
extern void* kalcc_afm_alloc_c(kal_uint32 size, kal_char *filename, kal_uint32 line);
extern void kalcc_afm_free(void* user_mem, kal_char *filename, kal_uint32 line);

#define kalcc_get_nc_ctrl_buff(size) kalcc_afm_alloc_nc(size, __FILE__, __LINE__)
#define kalcc_get_c_ctrl_buff(size) kalcc_afm_alloc_c(size, __FILE__, __LINE__)
#define kalcc_free_ctrl_buff(ptr) kalcc_afm_free(ptr, __FILE__, __LINE__)
...
kal_uint32 kal_secs_to_ticks_real(kal_uint32 secs);
/*******************************************************************************
 * <GROUP Functions>
 *
 * FUNCTION
...
kal_uint32 kal_milli_secs_to_ticks_real(kal_uint32 milli_secs);
/*******************************************************************************
 * <GROUP Functions>
 *
 * FUNCTION
...
kal_uint32 kal_ticks_to_secs_real(kal_uint32 ticks);
/*******************************************************************************
 * <GROUP Functions>
 *
 * FUNCTION
...
kal_uint32 kal_ticks_to_milli_secs_real(kal_uint32 ticks);
...
#define ASSERT(expr) do {if(!(expr)) kal_assert_fail_line((kal_char *)#expr, (kal_char *)__FILE__, (kal_uint32)__LINE__); } while (0)
#define EXT_ASSERT(expr, e1, e2, e3) do {if(!(expr)) kal_assert_fail_ext((kal_char *)#expr, (kal_char *)__FILE__, (kal_uint32)__LINE__, (kal_uint32)(e1), (kal_uint32)(e2), (kal_uint32)(e3)); } while (0)
#define EXT_ASSERT_DUMP(expr, e1, e2, e3, param) do {if(!(expr)) kal_assert_fail_dump((kal_char *)#expr, (kal_char *)__FILE__, (kal_uint32)__LINE__, (kal_uint32)(e1), (kal_uint32)(e2), (kal_uint32)(e3), (ASSERT_DUMP_PARAM_T*)(param)); } while (0)
#elif defined(__KAL_ASSERT_LEVEL2__)
#define ASSERT(expr) do {if(!(expr)) kal_assert_fail_line(__LINE__); } while (0)
#define EXT_ASSERT(expr, e1, e2, e3) do {if(!(expr)) kal_assert_fail_ext((kal_uint32)__LINE__, (kal_uint32)(e1), (kal_uint32)(e2), (kal_uint32)(e3)); } while (0)
#define EXT_ASSERT_DUMP(expr, e1, e2, e3, param) do {if(!(expr)) kal_assert_fail_dump((kal_uint32)__LINE__, (kal_uint32)(e1), (kal_uint32)(e2), (kal_uint32)(e3), (ASSERT_DUMP_PARAM_T*)(param)); } while (0)
#elif defined(__KAL_ASSERT_LEVEL1__)
#define ASSERT(expr) do {if(!(expr)) kal_assert_fail_line((kal_uint32)__LINE__); } while (0)
#define EXT_ASSERT(expr, e1, e2, e3) do {if(!(expr)) kal_assert_fail_line((kal_uint32)__LINE__); } while (0)
#define EXT_ASSERT_DUMP(expr, e1, e2, e3, param) do {if(!(expr)) kal_assert_fail_line((kal_uint32)__LINE__); } while (0)
#else
...
#define EXT_ASSERT(expr, e1, e2, e3) do {if(!(expr)) kal_assert_fail((kal_char *)#expr, (kal_char *)__FILE__, (kal_uint32)__LINE__, KAL_TRUE, (kal_uint32)(e1), (kal_uint32)(e2), (kal_uint32)(e3), NULL); } while (0)
#define EXT_ASSERT_DUMP(expr, e1, e2, e3, param) do {if(!(expr)) kal_assert_fail((kal_char *)#expr, (kal_char *)__FILE__, (kal_uint32)__LINE__, KAL_TRUE, (kal_uint32)(e1), (kal_uint32)(e2), (kal_uint32)(e3), (ASSERT_DUMP_PARAM_T*)(param)); } while (0)
...
#define EXT_ASSERT(expr, e1, e2, e3) do {if(!(expr)) MDM_ASSERT((kal_uint32)e1, (kal_uint32)e2, (kal_uint32)e3); } while (0)
#define EXT_ASSERT_DUMP(expr, e1, e2, e3, param) do {if(!(expr)) MDM_ASSERT((kal_uint32)e1, (kal_uint32)e2, (kal_uint32)e3); } while (0)
#endif
