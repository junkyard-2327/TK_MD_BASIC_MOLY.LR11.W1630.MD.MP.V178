...
#if OS_TICK_PERIOD_US==1000
#define MAX_DELAY_RATIO 5
#else /* OS_TICK_PERIOD_US==5000 */
#define MAX_DELAY_RATIO 1
#endif
#define MAX_DELAY_UNLIMITED (255*MAX_DELAY_RATIO)
...
/* for TK6291 V7 FPGA, clock rate will be 26MHz after 20140926_platform */
#ifdef __HAPS_FPGA_CLK_ADJUST__
#define KAL_CLOCK_RATIO_REAL            20   /* us counter's speed is modified to 1/n */
#else
#define KAL_CLOCK_RATIO_REAL            1
#endif
#define KAL_MICROSECS_PER_TICK_REAL     OS_TICK_PERIOD_US*KAL_CLOCK_RATIO_REAL
...
#define MAX_DELAY_UNLIMITED         (255*5)
...
/* need sync from KAL_ON_NUCLEUS */
/* for TK6291 V7 FPGA, clock rate will be 26MHz after 20140926_platform */
#define KAL_CLOCK_RATIO_REAL            1   /* us counter's speed is modified to 1/n */
#define KAL_MICROSECS_PER_TICK_REAL     OS_TICK_PERIOD_US*KAL_CLOCK_RATIO_REAL
#define KAL_MILLISECS_PER_TICK_REAL     ((float)KAL_MICROSECS_PER_TICK_REAL/1000)
...
{
#if defined(KAL_ON_NUCLEUS)
    kal_uint8 unused[32];  /* align to cache line size */
...
#define RCU_MEMORY_SIZE(sz,nr)  ( CPU_CACHE_LINE_SIZE*4 + nr * (CPU_CACHE_LINE_SIZE + ALIGNTOCACHELINE(sz)) )
