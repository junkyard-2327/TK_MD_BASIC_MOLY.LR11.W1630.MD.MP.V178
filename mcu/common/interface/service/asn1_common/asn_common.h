 ...
 * $Log:$
 *
 * 01 07 2015 eric.chuang
 * [MOLY00091447] [Universal Bin] new truncate macro: MTK.Uni_Bin_TRUNCATE
 * .fix build warning: extra tokens at the end of #ifndef directive
 *
...
#ifndef UNIVERSAL_MODEM_MACRO
    #define UNIVERSAL_MODEM_MACRO(x)
#endif
