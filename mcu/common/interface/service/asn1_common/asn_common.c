 ...
 * $Log:$
 *
 * 09 23 2015 eric.chuang
 * [MOLY00142772] [ASN.1] fix build warning for LR11 MP/Trunk
 * .fix implicit declaration of function 'longjmp' build warning
 *
