...
typedef enum {
   NUM_CTRL_BUFF_POOL_SIZE32     = 900,
   NUM_CTRL_BUFF_POOL_SIZE64     = 780,
   NUM_CTRL_BUFF_POOL_SIZE128    = 440,
   NUM_CTRL_BUFF_POOL_SIZE256    = 380,
   NUM_CTRL_BUFF_POOL_SIZE512    = 91,
   NUM_CTRL_BUFF_POOL_SIZE1024   = 65,
   NUM_CTRL_BUFF_POOL_SIZE2048   = 46,
   NUM_CTRL_BUFF_POOL_SIZE4096   = 23,
...
typedef enum {
   ...
   NUM_CTRL_BUFF_POOL_SIZE256    = 190,
   NUM_CTRL_BUFF_POOL_SIZE512    = 91,
   NUM_CTRL_BUFF_POOL_SIZE1024   = 65,
