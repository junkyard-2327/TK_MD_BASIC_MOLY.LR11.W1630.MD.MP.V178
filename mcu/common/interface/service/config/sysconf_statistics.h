...
#if defined(__KAL_CROSS_CORE_SUPPORT__) && defined(__MTK_TARGET__)
    kal_uint16 max_cc_ctrl_buff_num_allocated[RPS_CREATED_CC_CTRL_BUFF_POOLS];	/* Maximum number cross-core control buffers allocated */
...
extern kal_int32 stack_get_L1core_stats_info(kal_uint32 stats, void *buff, kal_uint32 buff_size);
