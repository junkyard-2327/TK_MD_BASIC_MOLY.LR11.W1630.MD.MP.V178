...
#define NVRAM_EF_TST_FILTER_ALLOCATE_SIZE  (8192-NVRAM_CHECKSUM_SIZE-NVRAM_PEER_BUF_HEADER_SIZE)
#define NVRAM_EF_DHL_FILTER_ALLOCATE_SIZE  (8192-NVRAM_CHECKSUM_SIZE-NVRAM_PEER_BUF_HEADER_SIZE)
