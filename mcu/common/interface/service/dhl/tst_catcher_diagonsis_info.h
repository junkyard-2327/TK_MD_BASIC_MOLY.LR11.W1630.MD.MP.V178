...
typedef enum
{
  ...
  CATCHER_EXC_MODULES_UARTUSB,
    ...
    CATCHER_EXC_OWNER_CCCI_Wenbo_Ning=CATCHER_EXC_MODULES_UARTUSB, //owners should be up-to-date
#else
...
#if defined(__DHL_SP_LOGGING_SUPPORT__)
    CATCHER_EXC_OWNER_COMPORT_Marvin_Lin=CATCHER_EXC_MODULES_COMPORT, //owners should be up-to-date
#else
...
typedef enum{
        ...
        bb_reg___Qmei_Yang,
        swla___YenChun_Liu,
        dsp_mem___YiYing_Lin,
        coresonic_dsp_mem___Ruta_Lin ,
        ast_mem___Fanzhi_Meng,
        
        md32_mem___YuanYuan_Wang,
        slave_sys_mem___Qmei_Yang,
        slave_swla___YenChun_Liu,
        //this table is updated by yu-hsiang peng 2015_08_20 for 91 series 
