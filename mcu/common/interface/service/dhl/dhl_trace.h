 ...
 * -------
 *
 * 10 04 2016 jean.tsao
 * [MOLY00172667] [DHL][MDM] L1 EM and L2 PDU service
 * [LR11.MP5][MDM] L1 EM and L2 PDU service
 *
 * 12 09 2015 hk.yang
 * [MOLY00152442] [LR11][DHL] L2 PDU logging
 * [LR11] [DHL] L2 pdu logging API.
 *
 * 10 08 2015 yu-hsiang.peng
 * [MOLY00144383] [DHL] low power request : provide API to set DHL wake up time at SD mode.
 * [LT11.Trunk] DHL SD logging wake up API
 *
 * 10 07 2015 yu-hsiang.peng
 * [MOLY00144383] [DHL] low power request : provide API to set DHL wake up time at SD mode.
 * roll back.
 *
 ...
 * .
 *
 * 08 31 2015 eason.lai
 * [MOLY00139377] [MT6755][Jade-L1][MP1][CSFB DSDS][Local FT][China-SZ][CU][TTLIA] Externel (EE),0,0,99,/data/core/,1,modem,md1:(MCU_PCORE) [ASSERT]file:pcore/service/qmu_bm/src/qmu_bm_l2log.c line:501
 * 	.
 *
