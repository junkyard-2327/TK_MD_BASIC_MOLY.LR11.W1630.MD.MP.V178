 ...
 * 06 29 2016 ap.wang
 * [MOLY00187298] [CCCI] LWA related check in
 * Add ccci sysmsg and ccci misc info for LWA share memory
 *
 * 04 20 2016 cs.huang
 ...
 *
 * 09 07 2015 cs.huang
 * [MOLY00140694] [CCCI] Fix build warnings for CCISM
 * [CCCI] Fix build warnings
 *
 * 09 07 2015 cs.huang
 * [MOLY00140694] [CCCI] Fix build warnings for CCISM
 * [CCCI] Fix build warnings
 ...
 * 09 02 2015 cs.huang
 * [MOLY00139463] [CCISM] add CCISM Core
 * [CCCI] Change code for CCISM
 *
 * 08 28 2015 cs.huang
 * [MOLY00139463] [CCISM] add CCISM Core
 * 	Dummy check-in
 *
 * 08 28 2015 chien-hui.lu
 * [MOLY00139463] [CCISM] add CCISM Core
 * [CCISM] modify CCCI to support CCISM.
 *
 * 08 06 2015 cs.huang
 ...
 *
 * 07 07 2015 cs.huang
 * [MOLY00126508] [CCCI] Add DHL smart logging feature
 * [CCCI] Add DHL smart logging feature
 *
 * 06 09 2015 cs.huang
 * [MOLY00119779] [CCCI] Modidy CCCI runtime data format for DHL & MD1MD3 share memory, and add MD1MD3 share memory query API
 * [CCCI] Modidy CCCI runtime data format for DHL & MD1MD3 share memory, and add MD1MD3 share memory query API
 *
 * 05 20 2015 cs.huang
 * [MOLY00114799] [CCCI] Support L1Core CCCI misc info
 * 	[CCCI] Support L1Core CCCI misc info
 *
 * 05 08 2015 cs.huang
...
#define _CCCI_IF_H
/*****************************************************************************
 * Start define : Common CCCI header file      
 ****************************************************************************/
#include "kal_public_api.h"
#include "ccci_ch_cfg.h"
/*****************************************************************************
 * End define : Common CCCI header file      
 ****************************************************************************/
 
/*****************************************************************************
 * Start define : PCore CCCI header file      
 ****************************************************************************/
...
/*****************************************************************************
 * End define : PCore CCCI header file      
 ****************************************************************************/
 
/*****************************************************************************
 * Start define : L1Core CCCI header file      
 ****************************************************************************/
#if defined(__L1CORE__)
#endif /* #if defined(__L1CORE__) */
/*****************************************************************************
 * End define : L1Core CCCI header file      
 ****************************************************************************/
 
/*****************************************************************************
 * Start define : Common CCCI compile option      
 ****************************************************************************/
#define __OLD_CCCI_HS_FLOW__
#define __NEW_CCCI_HS_FLOW__
/*****************************************************************************
 * End define : Common CCCI compile option      
 ****************************************************************************/

/*****************************************************************************
 * Start define : PCore CCCI compile option       
 ****************************************************************************/
#if defined(__PCORE__)
/*!
...
#endif /* #if defined(__PCORE__) */
/*****************************************************************************
 * End define : PCore CCCI compile option       
 ****************************************************************************/
 
/*****************************************************************************
 * Start define : L1Core CCCI compile option       
 ****************************************************************************/
#if defined(__L1CORE__)
#endif /* #if defined(__L1CORE__) */
/*****************************************************************************
 * End define : L1Core CCCI compile option       
 ****************************************************************************/
 
/*****************************************************************************
 * Start define : Common CCCI structure define       
 ****************************************************************************/
/*!
...
typedef enum{
    AP_CCCI_RUNTIME_BOOT_INFO =0,
    AP_CCCI_RUNTIME_EXCEPTION_SHARE_MEMORY ,
    AP_CCCI_RUNTIME_CCIF_SHARE_MEMORY ,
    AP_CCCI_RUNTIME_DHL_SHARE_MEMORY ,
    AP_CCCI_RUNTIME_MD1MD3_SHARE_MEMORY ,
    // CCCI misc info
    CCMSG_ID_MISCINFO_START, // for misc info back compitable
    CCMSG_ID_MISCINFO_HIF_DMA_REMAP = CCMSG_ID_MISCINFO_START,             //- add for DMA to query HIF-DMA remap address
    CCMSG_ID_MISCINFO_RTC_32K_LESS,              //- add for L1 to query 32K-less information in AP
    CCMSG_ID_MISCINFO_RANDOM_SEED_NUM,           //- add for sram repair function to get random seed number from AP (Owner: SE7/SD3/Cindy)
    CCMSG_ID_MISCINFO_GPS_COCLOCK,               //- add for L1D to query GPS co-clock information from AP
    CCMSG_ID_MISCINFO_SBP_ID,                    //- add for SBP to query SBP related profile (Owner: SE3/PS8/Hong)
    CCMSG_ID_MISCINFO_CCCI,                      //- add for CCCI related feature (Owner: SE7/SD8/CS)
    CCMSG_ID_MISCINFO_CLIB_TIME,                 //- add for KAL to get andriod time (Owner: SE7/SS/Carl)
    CCMSG_ID_MISCINFO_C2K,                       //- add for C2K option  (Owner: SE3/PS5/Ralf)
    AP_CCCI_RUNTIME_MD_IMG_INFO,                 //- add for KAL to get MD image info (Owner: SS/KC.Tsai)
    AP_CCCI_RUNTIME_MD1SCP_SHARE_MEMORY,         //- add for MD1 SCP CCISM share memory
    AP_CCCI_CCB_SHARE_MEMORY,                    //- add for CCCI CCB
    AP_CCCI_DHL_RAW_SHARE_MEMORY,                //- add for DHL RAW
    AP_CCCI_DT_NETD_SHARE_MEMORY,                //- add for DT NETD
    AP_CCCI_DT_USB_SHARE_MEMORY,                 //- add for DT USB
    AP_CCCI_RUNTIME_EE_AFTER_EPOF,               //- add for EPOF flow
    AP_CCCI_RUNTIME_NETWORK_MTU_SIZE,            //- add for querying network MTU size
    CCMSG_ID_MISC_INFO_CUSTOMER_PARM,            //- add for customer
    AP_CCCI_RUNTIME_CCCI_FAST_HEADER,            //- add for querying ccci fast header support
...
/*****************************************************************************
 * End define : Common CCCI structure define       
 ****************************************************************************/

/*****************************************************************************
 * Start define : PCore CCCI structure define       
 ****************************************************************************/
#if defined(__PCORE__) 
/*!
...
typedef enum
{
    CCCI_BOOT_UP_TRACE_START = LABEL_CCCI_START,
	...
	CCCI_BOOT_UP_TRACE_MAX = LABEL_CCCI_LIMIT,
...
#endif /* #if defined(__PCORE__) */
/*****************************************************************************
 * End define : PCore CCCI structure define       
 ****************************************************************************/


/*****************************************************************************
 * Start define : Common CCCI Macro    
 ****************************************************************************/
...
/*****************************************************************************
 * End define : Common CCCI Macro    
 ****************************************************************************/

/*****************************************************************************
 * Start define : PCore CCCI Macro    
 ****************************************************************************/
#if defined(__PCORE__) 
...
#endif /* #if defined(__PCORE__) */
/*****************************************************************************
 * End define : PCore CCCI Macro    
 ****************************************************************************/ 

/*****************************************************************************
 * Start define : L1Core CCCI Macro    
 ****************************************************************************/
#if defined(__L1CORE__) 
#endif /* #if defined(__L1CORE__) */
/*****************************************************************************
 * End define : L1Core CCCI Macro    
 ****************************************************************************/ 

/*****************************************************************************
 * Start define : Common CCCI function pointer    
 ****************************************************************************/
typedef void (*CCCI_SYSMSGSVC_HISR_CALLBACK)(kal_uint32 param);
/*****************************************************************************
 * End define : Common CCCI function pointer    
 ****************************************************************************/

/*****************************************************************************
 * Start define : PCore CCCI function pointer    
 ****************************************************************************/
#if defined(__PCORE__) 
...
#endif /* #if defined(__PCORE__) */
/*****************************************************************************
 * End define : PCore CCCI function pointer    
 ****************************************************************************/

/*****************************************************************************
 * Start define : L1Core CCCI function pointer    
 ****************************************************************************/
#if defined(__L1CORE__) 
#endif /* #if defined(__L1CORE__) */
/*****************************************************************************
 * End define : L1Core CCCI function pointer    
 ****************************************************************************/

/*****************************************************************************
 * Start define : Common CCCI public API    
 ****************************************************************************/
/*!
...
kal_int32 ccci_send_ccilm(ilm_struct* ilm);
...
/*****************************************************************************
 * End define : Common CCCI public API     
 ****************************************************************************/

/*****************************************************************************
 * Start define : PCore CCCI public API    
 ****************************************************************************/
#if defined(__PCORE__) 
...
#endif /* #if defined(__PCORE__) */
/*****************************************************************************
 * End define : PCore CCCI public API     
 ****************************************************************************/

/*****************************************************************************
 * Start define : L1Core CCCI public API    
 ****************************************************************************/
#if defined(__L1CORE__) 
#endif /* #if defined(__L1CORE__) */
/*****************************************************************************
 * End define : L1Core CCCI public API     
 ****************************************************************************/

/*****************************************************************************
 * Start define : Common CCCI MISC    
 ****************************************************************************/
/*****************************************************************************
 * End define : Common CCCI MISC    
 ****************************************************************************/
 
/*****************************************************************************
 * Start define : PCore CCCI MISC    
 ****************************************************************************/
#if defined(__PCORE__) 
...
#endif /* #if defined(__PCORE__) */
/*****************************************************************************
 * End define : PCore CCCI MISC       
 ****************************************************************************/

/*****************************************************************************
 * Start define : L1Core CCCI MISC      
 ****************************************************************************/
#if defined(__L1CORE__) 
#endif /* #if defined(__L1CORE__) */
/*****************************************************************************
 * End define : L1Core CCCI MISC      
 ****************************************************************************/
