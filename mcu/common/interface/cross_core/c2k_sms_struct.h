...
} sdm_val_c2k_sms_send_req_struct;
...
typedef struct {
   ...
   kal_uint16	     length;
   kal_uint8         pdu[MAX_C2K_SMS_PDU_LEN];
} sdm_val_c2k_sms_send_cnf_struct;
...
} imcsms_val_c2k_sms_send_req_struct;
...
typedef struct{
	...
	kal_uint16  length;
	kal_uint8   data[MAX_C2K_SMS_PDU_LEN]; 
} imcsms_val_c2k_sms_send_cnf_struct;
...
typedef struct{
	...
	kal_uint16  length;
	kal_uint8   data[MAX_C2K_SMS_PDU_LEN];
} imcsms_val_c2k_sms_recv_req_struct;
...
} imcsms_val_c2k_sms_recv_cnf_struct;
/**************************************************************/
