...
#define MD1_L1CORE_GLOBAL_MODULE_ID_BEGIN MODULE_TAG_MOD_ID_GLOBAL_MD1_PCORE_TAIL,
...
#define IS_GLOBAL_MD1_PCORE_MOD(global_module) \
((global_module > MOD_ID_GLOBAL_MD1_BEGIN)&&(global_module < MODULE_TAG_MOD_ID_GLOBAL_MD1_PCORE_TAIL))
#define IS_GLOBAL_MD1_L1CORE_MOD(global_module) \
((global_module > MODULE_TAG_MOD_ID_GLOBAL_MD1_PCORE_TAIL)&&(global_module < MODULE_TAG_MOD_ID_GLOBAL_MD1_TAIL))
