...
#define MSG_ID_GLOBAL_END 502

typedef enum {
	
    MSG_ID_GLOBAL_BEGIN = 0, MSG_ID_GLOBAL_NIL_CHECK_TAIL = MSG_ID_GLOBAL_BEGIN,
    MSG_ID_GLOBAL_MD1_BEGIN, MSG_ID_GLOBAL_MD1_TAIL = MSG_ID_GLOBAL_MD1_BEGIN + 199,
    MSG_ID_GLOBAL_MD2_BEGIN, MSG_ID_GLOBAL_MD2_TAIL = MSG_ID_GLOBAL_MD2_BEGIN + 99,
    MSG_ID_GLOBAL_MD3_BEGIN, MSG_ID_GLOBAL_MD3_TAIL = MSG_ID_GLOBAL_MD3_BEGIN + 199,
    MSG_ID_GLOBAL_TAIL,
