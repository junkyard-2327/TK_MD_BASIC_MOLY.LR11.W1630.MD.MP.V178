...
/* DCM lock/unlock interface dedicate for BT use case */
...
/* DCM prerequisite routine executed in boot initialization flow */
...
//void DCM_EMI2AXI_DCM_OFF(kal_uint32 off); //the deprecated API, alias to DCM_MCUBUS_DCM_OFF.
#endif /* __DCM_SW_H__ */
