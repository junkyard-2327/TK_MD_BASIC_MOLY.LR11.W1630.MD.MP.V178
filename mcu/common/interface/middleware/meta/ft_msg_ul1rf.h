...
} URfTestCmdSetPathlossItem;

typedef struct
{
	kal_uint8               band;
	kal_uint8               rxantpath;     // 1 for main   ,  2 for div
} URfTestCmdGetPathlossItem;

typedef struct
{
    kal_int8                temper_offset[CAL_TEMP_SECTION];
	UL1D_RF_LNA_PATHLOSS    loss_of_uarfcn[CAL_UARFCN_SECTION];
} URfTestResultGetPathlossItem;
...
/* WM Switch */
   ...
   URfTestCmdGetPathlossItem   pathloss_get;
