...
typedef struct
{
   const UL1_MIPI_EVENT_TABLE_T         **catA_eventTable_p;
   const UL1_MIPI_DATA_SUBBAND_TABLE_T  **catA_dataTable_p;
   const UL1_MIPI_EVENT_TABLE_T         **catB_eventTable_p;
   const UL1_MIPI_DATA_SUBBAND_TABLE_T  **catB_dataTable_p;
