...
//edch tick1/tick2
DECLARE_SHARED_VAR(TDD_etfc_eval_info_req_T, g_tl1_edch_tick1_req)
DECLARE_SHARED_VAR(TDD_etfc_eval_info_ind_T, g_mac_edch_tick1_ind)
DECLARE_SHARED_VAR(TDD_edch_data_req_T, g_tl1_edch_tick2_req)
DECLARE_SHARED_VAR(TDD_edch_data_ind_T, g_mac_edch_tick2_ind)
//uldch tick
DECLARE_SHARED_VAR(TDD_uldch_data_req_T, g_tl1_uldch_data_req)
DECLARE_SHARED_VAR(TDD_uldch_data_ind_T, g_mac_uldch_data_ind)
//dsch data ind
DECLARE_SHARED_ARRAY(tdd_phy_hsdsch_data_ind_struct, g_tl1_to_mac_dsch_data_ind, 2)
//rx data buf info
DECLARE_SHARED_ARRAY(MAC_TO_TL1_RX_BUF_T, gMacToTl1RxDchBufInfo, DL_DCH_DATA_BUF_NUM)
DECLARE_SHARED_ARRAY(MAC_TO_TL1_RX_BUF_T, gMacToTl1RxDschBufInfo, HSDSCH_DATA_BUF_NUM)
