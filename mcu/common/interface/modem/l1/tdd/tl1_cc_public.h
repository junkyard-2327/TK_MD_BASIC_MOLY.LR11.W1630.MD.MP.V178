...
#elif defined(MT6797)  //Everest: MT6797
#define TDD_HW_EFUSE_REGISTER                             (0xC020604C)  //bit4 = 1, Disable 3G TDD(TDD_FEATURE_OFF)
#define TDD_FEATURE_OFF_BIT                               (4)
#else
//#if defined(MT6755) || defined(MT6750) || defined(MT6757)|| defined(MT6757P) || defined(MT6750S) //Jade: MT6755; Jade Minus: MT6750(MT6755Ò²»ádefine); Olymplus: MT6757; KIBO+: MT6757P; Rosa:MT6750S
...
#if defined(TK6291) && defined(__FPGA__)  //TK6291 V7 FPGA no TDD HW, so return 3G TDD no exist
