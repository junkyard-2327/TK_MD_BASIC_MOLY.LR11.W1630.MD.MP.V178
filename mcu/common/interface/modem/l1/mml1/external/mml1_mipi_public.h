...
#define IS_MML1_ET_FEATURE_SUPPORT                                   ( 1 )   /* The MML1 ET feature is supported or not                                          */
#else
#define IS_MML1_ET_FEATURE_SUPPORT                                   ( 0 )   // Disable ET feature in xL1SIM temporarily.
#endif   // #ifndef __LTE_L1SIM__

#if IS_MML1_ET_FEATURE_SUPPORT
#define ET_MML1_MIPI_MAX_INITIAL_CW_NUM                              ( 32 )
#else
#define ET_MML1_MIPI_MAX_INITIAL_CW_NUM                              (  1 )
#endif   // #if IS_MML1_ET_FEATURE_SUPPORT
...
#define MML1_MIPI_ET                   0x0005
#define MML1_MIPI_READ_ONLY            0xFE00
#define MML1_MIPI_READ_AND_WRITE_BACK  0xFF00
...
#define ETM_MTK_MT6300                         1

#define ETM_MTK_MT6300_E1                      1
#define ETM_MTK_MT6300_E2                      2
