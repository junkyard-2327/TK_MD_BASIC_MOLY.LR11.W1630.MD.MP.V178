...
#define MOD_MPH_RR      MOD_GISE
#define MOD_MPH_L2      MOD_GISE
#define MOD_MPH_CB      MOD_GISE
#define MOD_MPH_MAC     MOD_GISE
#define MOD_MPH_L1      MOD_L1

#if defined(__GL1_GEMINI__)
#define MOD_MPH_RR_2      MOD_GISE_2
#define MOD_MPH_L2_2      MOD_GISE_2
#define MOD_MPH_CB_2      MOD_GISE_2
#define MOD_MPH_MAC_2     MOD_GISE_2
...
#if (GL1_GEMINI_NUM >= 3)
#define MOD_MPH_RR_3      MOD_GISE_3
#define MOD_MPH_L2_3      MOD_GISE_3
#define MOD_MPH_CB_3      MOD_GISE_3
#define MOD_MPH_MAC_3     MOD_GISE_3
#define MOD_MPH_L1_3      MOD_L1_3

#if (GL1_GEMINI_NUM >= 4)
#define MOD_MPH_RR_4      MOD_GISE_4
#define MOD_MPH_L2_4      MOD_GISE_4
#define MOD_MPH_CB_4      MOD_GISE_4
#define MOD_MPH_MAC_4     MOD_GISE_4
...
#define L1_SEND_MSG(src_mod, dest_mod, sap, ilm_ptr) \
	  ...
	  ilm_ptr->sap_id  = sap;  \
      gs_send_message((module_type)dest_mod, (void*)ilm_ptr, KAL_TRUE);
