...
typedef  struct
{
   #if MD_DRV_IS_2G_MIPI_MULTI_PA_DATA_SUPPORT
   ...
   #endif //MD_DRV_IS_2G_MIPI_MULTI_PA_DATA_SUPPORT
} sGGE_MIPIPADATA;
...
typedef enum
{
   ...
   #if defined (__SAR_TX_POWER_BACKOFF_SUPPORT__)&&(defined(__TAS_SUPPORT__)||defined(__TAS_FOR_C2K_ONOFF_SUPPORT__))
#define SAR_TPO_ANT_NUM   2 //For TAS1.0, ANT0 or ANT1
...
typedef  struct
{
   ...
   #endif /*defined (__SAR_TX_POWER_BACKOFF_SUPPORT__)&&(defined(__TAS_SUPPORT__)||defined(__TAS_FOR_C2K_ONOFF_SUPPORT__))*/
