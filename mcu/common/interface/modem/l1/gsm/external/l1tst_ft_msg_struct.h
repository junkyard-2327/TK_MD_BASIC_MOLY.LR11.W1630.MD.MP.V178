...
typedef enum
{
    ...
    ,RF_TEST_CMD_START_FDT_DL_NOT_WAIT_RESULT_EX = 76   //32k Less, Check func is False, open if need
    ,RF_TEST_CMD_GET_FDT_RESULT_EX = 77                 //32k Less, Check func is False, open if need
    ...
    ,RF_TEST_CMD_START_FDT_DL_NOT_WAIT_RESULT_EX_BIG = 84   //32k Less, Check func is False, open if need
    ,RF_TEST_CMD_GET_FDT_RESULT_EX_BIG = 85                 //32k Less, Check func is False, open if need
