...
/* 2G support three PA data for GMSK/8PSK mode control and bias setting */
#if defined(__2G_MIPI_MULTI_PA_DATA_SUPPORT__)
#define MD_DRV_IS_2G_MIPI_MULTI_PA_DATA_SUPPORT           1
#else
#define MD_DRV_IS_2G_MIPI_MULTI_PA_DATA_SUPPORT           0
#endif
