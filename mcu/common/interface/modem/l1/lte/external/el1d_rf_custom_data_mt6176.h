...
#define FDD_RX_BURST_SETTLE_TIME              (  5 + 5 + 2)              //us, margin=5us, CW needs 2us -> use 7us
#define FDD_TX_WARMUP_SETTLE_TIME             (102 + 12)                 //us, RX1/RX2 CW needs 0.2*2*13=5.2us, Tx: 3.4us, margin=3.4 -> use 12us
#if IS_TX_TXDFE_CHECK_TIMING
#define FDD_TX_BURST_SETTLE_TIME              (13 + 0 + 4)               //us, margin=4us
#else
#define FDD_TX_BURST_SETTLE_TIME              (13 + 0 + 4)               //us, margin=4us
#endif
#define TDD_TRX_WARMUP_SETTLE_TIME            (102 + 10*2)               //us, as TxWarmup settle time, acctually, RxWarmup needs 70us, 15us*2: RX1 and RX2
...
#define RF_RD0_DELAY_TIME                   MICROSECOND_TO_26M(30+ 5) //The temp dac delay time +  5us
#define RF_RD1_DELAY_TIME                   MICROSECOND_TO_26M(30+10) //The temp dac delay time + 10us
#define RF_RD2_DELAY_TIME                   MICROSECOND_TO_26M(30+15) //The temp dac delay time + 15us
#define RF_RD3_DELAY_TIME                   MICROSECOND_TO_26M(30+20) //The temp dac delay time + 20us
#define RF_RD4_DELAY_TIME                   MICROSECOND_TO_26M(30+25) //The temp dac delay time + 25us
#define RF_RD5_DELAY_TIME                   MICROSECOND_TO_26M(30+30) //The temp dac delay time + 30us
