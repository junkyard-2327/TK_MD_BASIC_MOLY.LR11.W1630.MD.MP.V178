...
DECLARE_SHARED_VAR(gmss_duplex_mode_type_struct, gmss_mode_shared)
#endif
...
****************************/
kal_bool gmss_is_wcdma_mode_activated(void);
kal_bool gmss_is_tdscdma_mode_activated(void);
