...
sub checkDBGInfoFileExistence {
	...
	my $error_msg = "";
	$error_msg.="ERROR: Cannot determine the PCORE DBGINFO DBGINFO_P file: @pcoreDbgInfoFileList\n" if $#pcoreDbgInfoFileList ne 0;
	$error_msg.="ERROR: Cannot determine the L1CORE DBGINFO DBGINFO_L file: @l1coreDbgInfoFileList\n" if $#l1coreDbgInfoFileList ne 0;
