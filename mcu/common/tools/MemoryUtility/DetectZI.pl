...
my @aSection = (
    "INTSRAM_DATA",
    "INTSRAM_DATA_B1",
    "SHARED_DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW",
    "SHARED_EXTSRAM",
    "SHARED_DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_MCURO_HWRW",
    "SHARED_EXTSRAM_MCURO_HWRW",
    "SHARED_DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_MCURW_HWRW",
    "SHARED_EXTSRAM_MCURW_HWRW",
    "CACHED_EXTSRAM",
