...
my %symbol_info; #{$InputSectionName} => [strSymbolName, strAddress, strObjName, strLibName, strOutputSectionName, strInputSectionName, nInputSectionSize]
#****************************************************************************
# oo >>>  Finished
#****************************************************************************
return 1;
...
sub _ParseContent
{
    ...
    { #  C$$code        0x00000000      0x210 ./build/MT6572_DEMO_TDD128HSPA/DEFAULT/bin/lib/libsys_drv.a(bootarm_gcc.obj)
        ...
        # 0x00000000        0x8 ./build/TK6291_FPGA/BASIC/bin/lib/libdevdrv.a(cc_irq_sys_comm.obj)  <-- skip such case in parse symbol
        if($base =~ /0x00000000/)
        {
            $bSkipParseSymbol = 1;
    ...
    #parse symbol
    if($strInputSectionName !~ /^\.(\w+)/ and !$bSkipParseSymbol)
    {
...
#              [[$strSymbolName, $nSymbolAddr, $strObjName, $strLibName, $strOutputSectionName, $strInputSectionName, $nSize], ...] 
#****************************************************************************
