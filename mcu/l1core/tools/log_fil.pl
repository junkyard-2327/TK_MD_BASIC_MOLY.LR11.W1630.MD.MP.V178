...
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * 
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * 09 07 2012 po.hu
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * [MOLY00001807] [custom release] remove MOLY log
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * .
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * 
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * 08 13 2012 young.yang
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * [MOLY00001807] [custom release] remove MOLY log
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * .
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * 
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * 08 03 2012 young.yang
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * [MOLY00001531] Request for removing check-in log in *.inc files for customer release
# 2. match " * $Revision: ... $", " * $Modtime: ... $" or " * .
...
if ($is_exist == 1)
{
    ...
    open SRC_FILE_RW, ">$TMP_FILE" or die "cannot open $TMP_FILE\n";
}
else
{
    exit(0);
