...
#define TASK_PRIORITY_DRVTEST_PPC          (KAL_PRIORITY_CLASS5 + 5)
...
/*************************Task PCC Begin****************/
#ifdef ATEST_DRV_PCC
task_index(INDX_DT_PCC) 
task_multi_core_module_map(INDX_DT_PCC, MOD_DT_PCC)
task_name("DTPCC")
task_queue_name("DTPCC_Q")
task_priority(TASK_PRIORITY_DRVTEST_PCC, KAL_TASK_INITIAL_PRIORITY)
task_stack_size(4096)
task_create_function(drvtest_pcc_task_create)
task_stack_internalRAM(KAL_FALSE)
task_external_queue_size(10)
task_internal_queue_size(0)
task_boot_mode(NORMAL_M)
...
/*************************Task PPC Begin****************/
#ifdef ATEST_DRV_PPC
task_index(INDX_DT_PPC) 
task_multi_core_module_map(INDX_DT_PPC, MOD_DT_PPC)
task_name("DTPPC")
task_queue_name("DTPPC_Q")
task_priority(TASK_PRIORITY_DRVTEST_PPC, KAL_TASK_INITIAL_PRIORITY)
task_stack_size(4096)
task_create_function(drvtest_ppc_task_create)
task_stack_internalRAM(KAL_FALSE)
task_external_queue_size(10)
task_internal_queue_size(0)
task_boot_mode(NORMAL_M)
#endif /* end of ATEST_DRV_PPC */
/*************************Task CFG END******************/
