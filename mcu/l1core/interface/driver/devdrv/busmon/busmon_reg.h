 ...
 * MT6797 L1core busmon call for bring up .
 *
 ...
 * L1core Busmonitor driver update.
 *
...
/* Default Vaule */
#define AXIMON_COD_VERSION_DEFAULT              (0x20140808)
...
#define AXIMON_CTL_LATCH_MASK                  	(0x1)          /* [2] */
#define AXIMON_CTL_LATCH_SHIFT                 	(4)            /* [2] */


#define AXIMON_TST_SEQ_TRG_MODE_MASK            (0x1)          /* [0] */
#define AXIMON_TST_SEQ_TRG_MODE_SHIFT           (0)            /* [0] */
#define AXIMON_TST_DIS_LATCH_MODE_MASK          (0x1)          /* [1] */
#define AXIMON_TST_DIS_LATCH_MODE_SHIFT         (1)            /* [1] */
#define AXIMON_TST_DIS_CG_MODE_MASK            	(0x1)          /* [2] */
#define AXIMON_TST_DIS_CG_MODE_SHIFT          	(2)            /* [2] */
...
#define AXIMON_TST_CTL_ACTIVE_SHIFT             (19)           /* [18] */
...
#define AXIMON_SNAP_INFO0_QID_MASK              (0xFF)          /* [7:0] */
#define AXIMON_SNAP_INFO0_QID_SHIFT             (0)             /* [7:0] */
 ...
 *  MDINFRA BusMon
 */
#if ((defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)) && defined(__PCORE__))
#define MDPERIMISC_BUSMON_BASE                     (BASE_MADDR_MDPERIMISC)

#define BUSMON_CODA_VERSION                     (MDPERIMISC_BUSMON_BASE + 0x00)
#define BUSMON_INT_EN                           (MDPERIMISC_BUSMON_BASE + 0x20)
#define BUSMON_INT_STS                          (MDPERIMISC_BUSMON_BASE + 0x24)


/* Default Value */
#define BUSMON_CODA_VERSION_DEFAULT             (0x00000000)

/* Bit Field & Mask */
#define BUSMON_CODA_VERSION_MASK                (0xFFFFFFFF)    /* [31:0] */
#define BUSMON_CODA_VERSION_SHIFT               (0)             /* [31:0] */

#define BUSMON_INT_EN_MASK                      (0x1F)         /* [8:0] */
#define BUSMON_INT_EN_SHIFT                     (0)             /* [8:0] */

#define BUSMON_INT_STS_MASK                     (0x1F)         /* [8:0] */
#define BUSMON_INT_MDINFRA_AXI_MASK             (0x1)           /* [0] */
#define BUSMON_INT_MDINFRA_AXI_SHIFT            (0)             /* [0] */
#define BUSMON_INT_PSMCU_AXI_MASK            	(0x1)           /* [1] */
#define BUSMON_INT_PSMCU_AXI_SHIFT           	(1)             /* [1] */

#define BUSMON_INT_BITS                         (2)
#endif
