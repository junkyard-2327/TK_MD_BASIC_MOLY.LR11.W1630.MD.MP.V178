...
#if defined(MT6755)
#if defined(__CR4__)
   #include "intrCtrl_MT6755.h"
#elif defined(__ARM7EJ_S__)
   #include "intrCtrl_MT6755_ARM7.h"
#else
   #error "No CPU version select. Need to specify CPU version in project MT6755 MDSYS."
#endif
#endif

#if defined(MT6797)
#if defined(__CR4__)
   #include "intrCtrl_MT6797.h"
#elif defined(__ARM7EJ_S__)
   #include "intrCtrl_MT6797_ARM7.h"
#else
   #error "No CPU version select. Need to specify CPU version in project MT6797 MDSYS."
#endif
#endif

#if defined(MT6757)
#if defined(__CR4__)
   #include "intrCtrl_MT6757.h"
#elif defined(__ARM7EJ_S__)
   #include "intrCtrl_MT6757_ARM7.h"
#else
   #error "No CPU version select. Need to specify CPU version in project MT6757 MDSYS."
#endif
#endif

#if defined(MT6750S)
#if defined(__CR4__)
   #include "intrCtrl_MT6750S.h"
#elif defined(__ARM7EJ_S__)
   #include "intrCtrl_MT6750S_ARM7.h"
#else
   #error "No CPU version select. Need to specify CPU version in project MT6750S MDSYS."
#endif
#endif
...
#if defined(__IRQ_LOCK_WITHOUT_CHECK__) && defined(__CR4__)
