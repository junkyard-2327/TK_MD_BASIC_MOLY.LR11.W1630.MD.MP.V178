...
#define __CATEGORY_MODEM__
#endif

#ifdef __CATEGORY_MODEM__  // doesn't need to include these module


#define NONE_MODEM_GPIO
//#define NONE_MODEM_UART
#define NONE_MODEM_ADC
#define NONE_MODEM_BMT
#define NONE_MODEM_PFC
#define NONE_MODEM_RTC
#define NONE_MODEM_I2C
#define NONE_MODEM_AUX
#define NONE_MODEM_KBDH
#define NONE_MODEM_KBD
#define NONE_MODEM_STS
#define NONE_MODEM_MSDC
#define NONE_MODEM_USB
#define NONE_MODEM_USBD
#define NONE_MODEM_OTG
#define NONE_MODEM_IRDA
#define NONE_MODEM_SIM
#define NONE_MODEM_PW
#define NONE_MODEM_CHR_USB_DET
#define NONE_MODEM_PXS
#define NONE_MODEM_SIM_GPIO
#define NONE_MODEM_F32K_CLK
//#define NONE_MODEM_IDC
#define NONE_MODEM_PWM
#define NONE_MODEM_ALERTER
//#define NONE_MODEM_WDT
//#define NONE_MODEM_PMU
#define NONE_MODEM_SIM_GPI
#define NONE_MODEM_SD
#define NONE_MODEM_SDIO
#define NONE_MODEM_MS
#define NONE_MODEM_TS
#define NONE_MODEM_HDQ
#define NONE_MODEM_ONEW
...
/* under construction !*/
   ...
   IDC_CONFIGS   
#endif
	DCL_DUMMY_CONFIG_T st_m_dummy1;//cgen error if structure member empty.
