...
typedef enum {
   ...
   DRV_IDC_PM_HISR_ID		= IRQ_IDC_PM_CODE,
   DRV_IDC_UART_HISR_ID		= IRQ_IDC_UART_CODE,
   DRV_BUSMON_HISR_ID           = IRQ_BUSMON_CODE,
   DRV_DEM_HISR_ID              = IRQ_DEM_TRIG_CODE,
   DRV_PCC_HISR_ID              = IRQ_DFE_PCC_FULL_CODE,
   DRV_PPC_HISR_ID              = IRQ_PPC_CODE,
