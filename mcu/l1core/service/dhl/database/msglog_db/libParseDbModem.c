 ...
 *
 * 12 30 2015 shao-kai.hsu
 * [MOLY00155392] [MT6291][LPP] Add lpp interface in l1core dhl database
 * .
 *
 ...
 * (LR11) include c2k_irat_msg_struct.h to display MD1-MD3 cross_core strut in ELT..
 *
 * 07 06 2015 tsung-wei.tu
 * [MOLY00125023] Fix L1core Database for ELT
 * .
 *
 * 07 06 2015 yunqi.wang
 * [MOLY00115335] [UMOLY]Messages inside LAS sub-modules can not be showed.
 * .
 *
 * 06 21 2015 arkadeep.sett
 * [MOLY00122720] Correction for RTB Timer enums to appear in log file
 * .
 *
 ...
 * .
 *
 * 05 22 2015 zhiguang.han
 * [MOLY00115335] [UMOLY]Messages inside LAS sub-modules can not be showed.
 * LAS sub-modules message printing.
 *
 * 05 21 2015 yunqi.wang
 * [MOLY00115335] [UMOLY]Messages inside LAS sub-modules can not be showed.
 * Rollback //UMOLY/TRUNK/UMOLY/mcu/l1core/service/dhl/database/msglog_db/libParseDbModem.c to revision 8
 *
 * 04 16 2015 yen-chun.liu
 * [MOLY00107829] [SYSTEM SERVICE][TASK CONFIG] Porting global module/message/sap config to UMOLY
 * .
 *
 ...
 *
 * 12 26 2014 peng-an.chen
 * [MOLY00089125] [UMOLY] Universal Bin SW integration
 * Remove tl1hisr_ast_msgid.h for TL1
 *
 * 12 11 2014 victor.chan
 * [MOLY00087351] Enabled Global Enum for msg and sap id
 * 	.
 *
 * 09 05 2014 victor.chan
 * [MOLY00063930] [Cgen] UMOLY DEV Check-in
 * 	Fixed LWG full load codegen build error (Ryan confirm)
 *
 ...
 *
 * 04 28 2014 yk.liu
 * [MOLY00063929] Check in for TK6291 L1S build enviroment
 * 	.
 *
 * 04 23 2014 tafang.chen
 * [MOLY00062786] [UMOLY][SM]
 * Merge l1core Codegen.mak with pcore Codegen.mak and reset trace files.
 *
...
//[21050727 Ali] for SRLTE, MD1-MD3 cross core struct.
...
#include "uas_eas_inter_core_enum.h"
