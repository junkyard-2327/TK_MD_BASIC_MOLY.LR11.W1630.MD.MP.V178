...
void AM_Update_AudioManagerInfo(uint16 speech_mode, int8 sub_channel)
{
   ...
   ASSERT( CC_IRQ_SUCCESS == cc_irq_trigger_interrupt(CC_IRQ_L2P_DSP, IRQ_L2P_2G_AUDIOMANAGER_INFO, (kal_uint32)speech_mode, (kal_uint32)sub_channel) );    
...
kal_bool AM_AudioManager( kal_bool handover, kal_uint16 speech_mode, kal_int8 sub_channel )
{
   ...
   if( !RB_EMPTY( am_L.qfunc_L ) ) {
      ...
      L1Audio_Msg_GetQ_L( func_code_L, func.data1_L, func.data2_L, func.data3_L, func.data4_L, func.data5_L, func.data6_L );
...
{
#if defined(_MODEM_RESYNC_3G_)	
		L1Audio_Msg_AM_3G_Reset_Time_Drift_L();
...
#endif	    
#endif
   kal_set_timer(am_L.sp3g_timer_L, (kal_timer_func_ptr)(sp3g_updateL1DSync), NULL, AUD_1TICK(4), AUD_1TICK(0));	
}
...
void cc_3G_Call_Close_L(kal_uint32 dsp_end)
{
   ...
   kal_cancel_timer(am_L.sp3g_timer_L);
...
void cc_4G_Call_Open_temp_L(kal_uint32 enc_mod, kal_uint32 dec_mod, kal_uint32 dtx, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 u32CurTime64us)
{
   ...
   kal_trace( TRACE_FUNC, AM_L_CC_4G_CALLOPEN_LEAVE, delR, delW, u32delay);
}
...
#if 1
void cc_DSP_4G_G_Codec_Call_Open_temp_L(kal_uint32 band_mod, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 dummy4, kal_uint32 dummy5)
{
   ASSERT( CC_DUMMY_PARAM == dummy4 && CC_DUMMY_PARAM == dummy5 );
...
void cc_4G_G_Codec_Call_Open_temp_L(kal_uint32 band_mod, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 u32CurTime64us)
{
   ...
   kal_trace( TRACE_FUNC,AM_L_CC_4G_GCALLOPEN_ENTER);
   ...
   AM_Enqueue_L( cc_DSP_4G_G_Codec_Call_Open_temp_L, band_mod, delR, delW, delM, CC_DUMMY_PARAM, CC_DUMMY_PARAM,
                                                 false );
   AM_FlushQFunction_L(); 
   am_L.state_L = AM_STATE_4G_L; 
   kal_trace( TRACE_FUNC, AM_L_CC_4G_GCALLOPEN_LEAVE, delR, delW, u32delay);
}
...
{
   kal_trace( TRACE_FUNC,AM_L_CC_4G_GCALLCLOSE_ENTER);
   AM_Enqueue_L( cc_DSP_4G_G_Codec_Call_Close_temp_L, dsp_end, 
                                          CC_DUMMY_PARAM, CC_DUMMY_PARAM, CC_DUMMY_PARAM, CC_DUMMY_PARAM, CC_DUMMY_PARAM,
                                          false );
   AM_FlushQFunction_L(); 
   am_L.state_L = AM_STATE_IDLE_L; 
   kal_trace( TRACE_FUNC,AM_L_CC_4G_GCALLCLOSE_LEAVE);
}
#endif

void cc_DSP_4G_EVS_Codec_Call_Open_temp_L(kal_uint32 band_mod, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 dummy4, kal_uint32 dummy5)
{
   ASSERT( CC_DUMMY_PARAM == dummy4 && CC_DUMMY_PARAM == dummy5 );
   SAL_4G_ExtCod_Call_Open(band_mod, 1, delR, delW, delM);
}

void cc_4G_EVS_Codec_Call_Open_temp_L(kal_uint32 band_mod, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 u32CurTime64us)
{
   kal_uint32 u32CurTime64usLocal, u32delay, u32delaySample;
   ...
   AM_Enqueue_L( cc_DSP_4G_EVS_Codec_Call_Open_temp_L, band_mod, delR, delW, delM, CC_DUMMY_PARAM, CC_DUMMY_PARAM,
                                                 false );
   AM_FlushQFunction_L(); 
   am_L.state_L = AM_STATE_4G_L; 
   //kal_prompt_trace(MOD_L1SP, "cc_4G_EVS_Codec_Call_Open_temp_L Leave delR=%d delW=%d P_to_L1_delay=%dms", delR, delW, u32delay);
   kal_trace( TRACE_FUNC, AM_L_CC_4G_EVSCALLOPEN_LEAVE, delR, delW, u32delay );
}

void cc_DSP_4G_EVS_Codec_Call_Close_temp_L(kal_uint32 dsp_end, kal_uint32 dummy1, kal_uint32 dummy2, kal_uint32 dummy3, kal_uint32 dummy4, kal_uint32 dummy5)
{   
   ASSERT( CC_DUMMY_PARAM == dummy1 && CC_DUMMY_PARAM == dummy2 && CC_DUMMY_PARAM == dummy3 && CC_DUMMY_PARAM == dummy4 && CC_DUMMY_PARAM == dummy5 );
   SAL_4G_ExtCod_Call_Close(dsp_end);
}
...
void L1Audio_Task_L(unsigned argc, void *argv)
{
   ...
   am_L.sp3g_timer_L = kal_create_timer("sp3g_timer_L");
...
void L1Aud_Handler_L( kal_uint32 P2LBuf[CC_BUFFER_SIZE], kal_uint32 L2PBuf[CC_BUFFER_SIZE] )
{
   ...
   case MSG_P2L_4G_EVS_Codec_CALL_ON:
      ASSERT( 5 == P2LBuf[1]);
      cc_4G_EVS_Codec_Call_Open_temp_L(P2LBuf[2], P2LBuf[3], P2LBuf[4], P2LBuf[5], P2LBuf[6]);
