...
#ifndef _DPRAM_6797_H_
#define _DPRAM_6797_H_
...
#define ENH_DYNAMIC_STATE_MACHINE                 DP_SPEECH_EXPAND_BASE + 0x003 /* 0x3f60 */
#define ENH_FLAG_PARAMETER                        DP_SPEECH_EXPAND_BASE + 0x004 /* 0x3f61 */
#define SPH_ST_ADAPTIVE_GAIN                      DP_SPEECH_EXPAND_BASE + 0x005 /* 0x3f62 */
#define SPH_PM_ADDR_SRC_PLUS_FLT_COEF             DP_SPEECH_EXPAND_BASE + 0x006 /* 0x3f63 */
#define SPH_OD_CTRL                               DP_SPEECH_EXPAND_BASE + 0x007 /* 0x3f64 */
#define SPH_OD_HANDSHAKE_OD                       DP_SPEECH_EXPAND_BASE + 0x008 /* 0x3f65 */
#define SPH_OD_HANDSHAKE_MD                       DP_SPEECH_EXPAND_BASE + 0x009 /* 0x3f66 */
#define SPH_OD_POLL_THRES_DL                      DP_SPEECH_EXPAND_BASE + 0x00a /* 0x3f67 */
#define SPH_OD_POLL_THRES_UL                      DP_SPEECH_EXPAND_BASE + 0x00b /* 0x3f68 */
#define SPH_OD_TCM_ADDR_H                         DP_SPEECH_EXPAND_BASE + 0x00c /* 0x3f69 */
#define SPH_OD_TCM_ADDR_L                         DP_SPEECH_EXPAND_BASE + 0x00d /* 0x3f6a */
#define SPH_OD_INT_CTRL1                          DP_SPEECH_EXPAND_BASE + 0x00e /* 0x3f6b */
#define SPH_OD_INT_CTRL2                          DP_SPEECH_EXPAND_BASE + 0x00f /* 0x3f6c */
#define SPH_OD_ECHO_REF_DELAY                     DP_SPEECH_EXPAND_BASE + 0x010 /* 0x3f6d */
#define SPH_OD_DL_CNTR                            DP_SPEECH_EXPAND_BASE + 0x011 /* 0x3f6e */
#define SPH_OD_UL_CNTR                            DP_SPEECH_EXPAND_BASE + 0x012 /* 0x3f6f */
#define SPH_OD_UL_PRC_TIME                        DP_SPEECH_EXPAND_BASE + 0x013 /* 0x3f70 */
#define SPH_OD_DL_PRC_TIME                        DP_SPEECH_EXPAND_BASE + 0x014 /* 0x3f71 */
#define SPH_OD_CALL_INFO                          DP_SPEECH_EXPAND_BASE + 0x015 /* 0x3f72 */
#define Sph_DL_Cur_Vol                            DP_SPEECH_EXPAND_BASE + 0x016 /* 0x3f73 */
#define SPH_ATTACK_GAIN_DL_NB                     DP_SPEECH_EXPAND_BASE + 0x017 /* 0x3f74 */
#define SPH_RELEASE_GAIN_DL_NB                    DP_SPEECH_EXPAND_BASE + 0x018 /* 0x3f75 */
#define SPH_ATTACK_GAIN_DL_WB                     DP_SPEECH_EXPAND_BASE + 0x019 /* 0x3f76 */
#define SPH_RELEASE_GAIN_DL_WB                    DP_SPEECH_EXPAND_BASE + 0x01a /* 0x3f77 */
#define SPH_FRC_TIME_UP                           DP_SPEECH_EXPAND_BASE + 0x01b /* 0x3f78 */
#define SPH_FRC_TIME_DOWN                         DP_SPEECH_EXPAND_BASE + 0x01c /* 0x3f79 */
#define SPH_VOLTE_JBM_OUT_SN                      DP_SPEECH_EXPAND_BASE + 0x01d /* 0x3f7a */
#define SPH_OD_NXP_STATUS                         DP_SPEECH_EXPAND_BASE + 0x01e /* 0x3f7b */

#define DP2_UNDEFINEDD_BASE                       DP_SPEECH_EXPAND_BASE + 0x020 /* 0x3f7d */


#define SHERIF_SIZE                               1405


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6797_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6797_SHERIF_SIZE)
    #error "SHERIF SIZE exceeds limitation !! This line makes assembler stop"
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6797_SHERIF_SIZE)
