...
#define IsWBLink(speech_codec) (SP4G_CODEC_G722 == speech_codec ) || ((speech_codec >= 0x20) && (speech_codec <= 0x28)) || ( (SP4G_CODEC_EVS_16K_005_9 <= speech_codec) && (SP4G_CODEC_EVS_16K_128_0 >= speech_codec) ) || ( (SP4G_CODEC_EVS_AWB_06_60 <= speech_codec) && (SP4G_CODEC_EVS_AWB_23_85 >= speech_codec) )
#else
