...
#ifndef _DPRAM_6755_H_
#define _DPRAM_6755_H_
...
#define SPH_HW_ISSUE_PROTECT_LOG1                 DP_SPEECH_EXPAND_BASE + 0x005 /* 0x3f62 */
#define SPH_HW_ISSUE_PROTECT_LOG2                 DP_SPEECH_EXPAND_BASE + 0x006 /* 0x3f63 */
#define SPH_HW_ISSUE_PROTECT_LOG3                 DP_SPEECH_EXPAND_BASE + 0x007 /* 0x3f64 */
#define SPH_ST_ADAPTIVE_GAIN                      DP_SPEECH_EXPAND_BASE + 0x008 /* 0x3f65 */
#define SPH_VOLTE_JBM_OUT_SN                      DP_SPEECH_EXPAND_BASE + 0x009 /* 0x3f66 */
#define Sph_DL_Cur_Vol                            DP_SPEECH_EXPAND_BASE + 0x00a /* 0x3f67 */
#define SPH_ATTACK_GAIN_DL_NB                     DP_SPEECH_EXPAND_BASE + 0x00b /* 0x3f68 */
#define SPH_RELEASE_GAIN_DL_NB                    DP_SPEECH_EXPAND_BASE + 0x00c /* 0x3f69 */
#define SPH_ATTACK_GAIN_DL_WB                     DP_SPEECH_EXPAND_BASE + 0x00d /* 0x3f6a */
#define SPH_RELEASE_GAIN_DL_WB                    DP_SPEECH_EXPAND_BASE + 0x00e /* 0x3f6b */

#define DP2_UNDEFINEDD_BASE                       DP_SPEECH_EXPAND_BASE + 0x014 /* 0x3f71 */


#define SHERIF_SIZE                               1393


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6755_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6755_SHERIF_SIZE)
    #error "SHERIF SIZE exceeds limitation !! This line makes assembler stop"
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6755_SHERIF_SIZE)
