...
#ifndef _DPRAM_6757_H_
#define _DPRAM_6757_H_
...
#define SPH_VOLTE_JBM_CTRL                        DP_SPEECH_RESERVED_BASE + 0x00e /* 0x3ef2 */
...
#define MT6757_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6757_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6757_SHERIF_SIZE)
