...
#define R_DCM_SHR_SET_CTL		(PLL_TYPE(MD_CLKSW_BASE+0x0004))
#define R_LTEL2_BUS_DCM_CTL		(PLL_TYPE(MD_CLKSW_BASE+0x0010))
#define R_MDDMA_BUS_DCM_CTL		(PLL_TYPE(MD_CLKSW_BASE+0x0014))
#define R_MDREG_BUS_DCM_CTL		(PLL_TYPE(MD_CLKSW_BASE+0x0018))
#define R_MODULE_BUS2X_DCM_CTL	(PLL_TYPE(MD_CLKSW_BASE+0x001C))
#define R_MODULE_BUS1X_DCM_CTL	(PLL_TYPE(MD_CLKSW_BASE+0x0020))
#define R_MDINFRA_CKEN			(PLL_TYPE(MD_CLKSW_BASE+0x0044))		
#define R_MDPERI_CKEN			(PLL_TYPE(MD_CLKSW_BASE+0x0048))
#define R_MDPERI_DCM_MASK		(PLL_TYPE(MD_CLKSW_BASE+0x0064))
