...
#ifndef __INTRCTRL_MT6290_H__
#define __INTRCTRL_MT6290_H__
...
#define IRQ_NIC_CODE                MD_IRQID_NIC
...
#define IRQ_BUSMON_CODE             MD_IRQID_BUSMON
#define IRQ_PCMON_CODE              MD_IRQID_PCMON
#define IRQ_I2C_CODE                MD_IRQID_I2C
...
#define IRQ_PERFCNT_CODE            MD_IRQID_PERFCNT
...
#define KAL_INTID_2_CODE_MAPPNG \
    ...
    /* 56 ~ 59 */ IRQ_ALC1_CODE,      IRQ_PFC_CODE,               IRQ_IDC2ARM_CODE,        IRQ_MSDC0_CODE, \
    ...
    /* 68 ~ 71 */ INVALID_ISR_ID,     INVALID_ISR_ID,             INVALID_ISR_ID,          INVALID_ISR_ID, \
    /* 72 ~ 75 */ INVALID_ISR_ID,     INVALID_ISR_ID,             CHANGE_MAPPING_BY_FEATURE_74, IRQ_SDIO_CODE, \
    /* 76 ~ 79 */ IRQ_CLDMA_CODE,     INVALID_ISR_ID,             INVALID_ISR_ID,          IRQ_CCIF_VLD_CODE, \
    /* 80 ~ 83 */ IRQ_CCIF_ACK_CODE,  IRQ_DEM_TRIG_CODE,             IRQ_RAMC_CODE,          INVALID_ISR_ID, \
    ...
    /*100 ~103 */ IRQ_GPTM1_CODE,     IRQ_GPTM2_CODE,             IRQ_NFI_CODE,            IRQ_UART1_CODE, \
    /*104 ~107 */ IRQ_UART2_CODE,     IRQ_BUSMON_CODE,            IRQ_GPTM3_CODE,          INVALID_ISR_ID, \
    /*108 ~111 */ INVALID_ISR_ID,     INVALID_ISR_ID,             INVALID_ISR_ID,          IRQ_MDGDMA0_CODE, \
...
enum Irq_Code_Def_Enum
{
    ...
    Enum_IRQ_AP_WDT_CODE             = IRQ_AP_WDT_CODE,
    Enum_IRQ_CCIF_ACK_CODE           = IRQ_CCIF_ACK_CODE,
    Enum_IRQ_CCIF_VLD_CODE           = IRQ_CCIF_VLD_CODE,
    Enum_IRQ_CLDMA_CODE              = IRQ_CLDMA_CODE,
    Enum_IRQ_RAMC_CODE               = IRQ_RAMC_CODE,
    Enum_IRQ_SPI_ERROR_CODE          = IRQ_SPI_ERROR_CODE,
    Enum_IRQ_NFI_CODE                = IRQ_NFI_CODE,
    Enum_IRQ_USB2_CODE               = IRQ_USB2_CODE,
    Enum_IRQ_USB3_CODE               = IRQ_USB3_CODE,
    Enum_IRQ_SDIO_CODE               = IRQ_SDIO_CODE,
    Enum_IRQ_MSDC0_CODE              = IRQ_MSDC0_CODE,
    Enum_IRQ_MSDC1_CODE              = IRQ_MSDC1_CODE,
    Enum_IRQ_EHPI0_CODE              = IRQ_EHPI0_CODE,
    Enum_IRQ_NIC_CODE                = IRQ_NIC_CODE,
    ...
    Enum_IRQ_BUSMON_CODE             = IRQ_BUSMON_CODE,
    Enum_IRQ_PCMON_CODE              = IRQ_PCMON_CODE,
    Enum_IRQ_I2C_CODE                = IRQ_I2C_CODE,
    Enum_IRQ_SIM_CODE                = IRQ_SIM_CODE,
    Enum_IRQ_SIM2_CODE               = IRQ_SIM2_CODE,
    Enum_IRQ_LED_CODE                = IRQ_LED_CODE,
    Enum_IRQ_RTC_CODE                = IRQ_RTC_CODE,
    Enum_IRQ_SOE_CODE                = IRQ_SOE_CODE,
    Enum_IRQ_BUS_ERR_CODE            = IRQ_BUS_ERR_CODE,
    Enum_IRQ_DEM_TRIG_CODE           = IRQ_DEM_TRIG_CODE,
    Enum_IRQ_CA_DL_LMAC_RAR_CODE     = IRQ_CA_DL_LMAC_RAR_CODE,
    Enum_IRQ_CA_DL_LMAC_EAR_CODE     = IRQ_CA_DL_LMAC_EAR_CODE,
    Enum_IRQ_PFC_CODE                = IRQ_PFC_CODE,
    ...
    Enum_IRQ_PERFCNT_CODE            = IRQ_PERFCNT_CODE,
