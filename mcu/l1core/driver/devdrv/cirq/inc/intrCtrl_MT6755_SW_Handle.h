 ...
 * [MOLY00151722] add SW trigger interrupt for TDD
 * Add SW trigger interrupt for TDD.
 *
 * 12 03 2015 i-chun.liu
 * [MOLY00151722] add SW trigger interrupt for TDD
 * add L1 mcu sw trigger interrupt .
 *
...
/* Add SW handler mapping: 
   ...
   __CR4__ User:
      ...
      SW_TRIGGER_CODE9 = TDD (Chuansheng Zhang)
   __ARM7EJ_S__ User:
 ...
 */
    ...
    X_SW_HANDLE_CONST(SW_TRIGGER_CODE3, IRQ_SW_LISR3_CODE, IRQ_SW_LISR3_CODE)
#else
    #error "No CPU version select. Need to specify CPU version in project MT6755 for MDSYS."
#endif
