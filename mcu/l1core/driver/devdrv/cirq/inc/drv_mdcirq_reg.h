...
#else
#define MDCIRQ_PRLV(n)     (MDCIRQ_PRLV_BASE + ((n>>2)<<2) )
#define MDCIRQ_VEC_BASE    (MDCIRQ_BASE+0x0290)
#define MDCIRQ_VEC_OFFSET   (MDCIRQ_BASE+0x0294)
#define MDCIRQ_DEFAULT_VEC_ADR (MDCIRQ_BASE+0x0490)
#define MDCIRQ_DUMMY   (MDCIRQ_BASE+0x0498)
#endif//of 6291
