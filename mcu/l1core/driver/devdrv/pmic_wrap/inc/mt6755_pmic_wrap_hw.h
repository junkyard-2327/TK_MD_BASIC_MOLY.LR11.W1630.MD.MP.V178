 ...
 * Description:
 * ------------
 *	This is mt6755 pmic wrapper h/w register
 *
 * Author:
 * -------
 * -------
...
#ifndef __MT6755_PMIC_WRAP_HW_H__
#define __MT6755_PMIC_WRAP_HW_H__

#if !defined(__FPGA__)
#include "reg_base.h"

#define PERIBUS_DBG_BASE			(0xC0003500)
#define PERIBUS_DBG0				(0xC0003500)
#define PERIBUS_DBG1				(0xC0003504)
#define PERIBUS_DBG2				(0xC0003508)
#define PERIBUS_DBG3				(0xC000350C)
#define PERIBUS_DBG4				(0xC0003510)
#define PERIBUS_DBG5				(0xC0003514)
#define PERIBUS_DBG6				(0xC0003518)

#define TOPCKGEN_BASE           	(BASE_MADDR_TOP_LEVEL_CLOCK_GENERATOR)
#define SLEEP_BASE              	(BASE_MADDR_TOP_LEVEL_SLP_MANAGER)
#define GPIO_BASE               	(BASE_MADDR_GPIO)
#define INFRACFG_AO_BASE        	(BASE_MADDR_INFRASYS_CONFIG_REGS)
#define PMIC_WRAP_BASE						(BASE_MADDR_PMIC_WRAP)
#else                                       
...
[0]: MDINF
*/
#define HARB_HPRIO_WACSP2P      (1 << 13) // (RESERVED)
#define HARB_HPRIO_WACS1        (1 << 12) // (MD SW1)
#define HARB_HPRIO_WACS2        (1 << 11) // (AP SW)
#define HARB_HPRIO_GPSINF       (1 << 10)
#define HARB_HPRIO_STAUPD       (1 << 9)
#define HARB_HPRIO_MD_ADCINF	(1 << 8)
#define HARB_HPRIO_DCXO_NFCINF	(1 << 7)
#define HARB_HPRIO_DCXO_CONNINF	(1 << 6)
#define HARB_HPRIO_WACS3        (1 << 5)  // (C2K SW)
#define HARB_HPRIO_DVFSINF      (1 << 4)  // (SPMINF)
#define HARB_HPRIO_WACS0        (1 << 3)  // (MD SW0)
#define HARB_HPRIO_MD_DVFSINF   (1 << 2)
...
#define OP_ODNID (0x1A)
 ...
 #endif // __MT6755_PMIC_WRAP_HW_H__                   
