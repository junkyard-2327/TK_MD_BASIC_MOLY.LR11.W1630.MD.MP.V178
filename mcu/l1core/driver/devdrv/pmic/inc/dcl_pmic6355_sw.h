...
#ifndef __DCL_PMIC6355_SW_H_STRUCT__
#define __DCL_PMIC6355_SW_H_STRUCT__
...
extern void pmic6355_customization_init(void);
...
typedef enum
{
    ...
    PMIC_ENUM_RG_VSRAM_MD_SLEEP_VOLTAGE,
    ...
    PMIC_ENUM_RG_LDO_VMIPI_EN,
    PMIC_ENUM_RG_LDO_VMIPI_LP,
    PMIC_ENUM_RG_LDO_VMIPI_SW_OP_EN,
    PMIC_ENUM_RG_LDO_VMIPI_HW0_OP_EN,
    PMIC_ENUM_RG_LDO_VMIPI_HW1_OP_EN,
    PMIC_ENUM_RG_LDO_VMIPI_HW2_OP_EN,
    PMIC_ENUM_RG_LDO_VMIPI_OP_EN_SET,
    PMIC_ENUM_RG_LDO_VMIPI_OP_EN_CLR,
    PMIC_ENUM_RG_LDO_VMIPI_HW0_OP_CFG,
    PMIC_ENUM_RG_LDO_VMIPI_HW1_OP_CFG,
    PMIC_ENUM_RG_LDO_VMIPI_HW2_OP_CFG,
    PMIC_ENUM_RG_LDO_VMIPI_ON_OP,
    PMIC_ENUM_RG_LDO_VMIPI_LP_OP,
    PMIC_ENUM_RG_LDO_VMIPI_OP_CFG_SET,
    PMIC_ENUM_RG_LDO_VMIPI_OP_CFG_CLR,
    PMIC_ENUM_DA_QI_VMIPI_MODE,
    PMIC_ENUM_DA_QI_VMIPI_EN,
    PMIC_ENUM_RG_LDO_VMIPI_OCFB_EN,
    PMIC_ENUM_DA_QI_VMIPI_OCFB_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_LP,
    PMIC_ENUM_RG_LDO_VTCXO24_SW_OP_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_HW0_OP_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_HW1_OP_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_HW2_OP_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_OP_EN_SET,
    PMIC_ENUM_RG_LDO_VTCXO24_OP_EN_CLR,
    PMIC_ENUM_RG_LDO_VTCXO24_HW0_OP_CFG,
    PMIC_ENUM_RG_LDO_VTCXO24_HW1_OP_CFG,
    PMIC_ENUM_RG_LDO_VTCXO24_HW2_OP_CFG,
    PMIC_ENUM_RG_LDO_VTCXO24_ON_OP,
    PMIC_ENUM_RG_LDO_VTCXO24_LP_OP,
    PMIC_ENUM_RG_LDO_VTCXO24_OP_CFG_SET,
    PMIC_ENUM_RG_LDO_VTCXO24_OP_CFG_CLR,
    PMIC_ENUM_DA_QI_VTCXO24_MODE,
    PMIC_ENUM_DA_QI_VTCXO24_EN,
    PMIC_ENUM_RG_LDO_VTCXO24_OCFB_EN,
    PMIC_ENUM_DA_QI_VTCXO24_OCFB_EN,
    ...
    PMIC_ENUM_RG_LDO_VRF18_1_EN,
    PMIC_ENUM_RG_LDO_VRF18_1_LP,
    PMIC_ENUM_RG_LDO_VRF18_1_SW_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_1_HW0_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_1_HW1_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_1_HW2_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_1_OP_EN_SET,
    PMIC_ENUM_RG_LDO_VRF18_1_OP_EN_CLR,
    PMIC_ENUM_RG_LDO_VRF18_1_HW0_OP_CFG,
    PMIC_ENUM_RG_LDO_VRF18_1_HW1_OP_CFG,
    PMIC_ENUM_RG_LDO_VRF18_1_HW2_OP_CFG,
    PMIC_ENUM_RG_LDO_VRF18_1_ON_OP,
    PMIC_ENUM_RG_LDO_VRF18_1_LP_OP,
    PMIC_ENUM_RG_LDO_VRF18_1_OP_CFG_SET,
    PMIC_ENUM_RG_LDO_VRF18_1_OP_CFG_CLR,
    PMIC_ENUM_DA_QI_VRF18_1_MODE,
    PMIC_ENUM_DA_QI_VRF18_1_EN,
    PMIC_ENUM_RG_LDO_VRF18_1_OCFB_EN,
    PMIC_ENUM_DA_QI_VRF18_1_OCFB_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_LP,
    PMIC_ENUM_RG_LDO_VRF18_2_SW_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_HW0_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_HW1_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_HW2_OP_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_OP_EN_SET,
    PMIC_ENUM_RG_LDO_VRF18_2_OP_EN_CLR,
    PMIC_ENUM_RG_LDO_VRF18_2_HW0_OP_CFG,
    PMIC_ENUM_RG_LDO_VRF18_2_HW1_OP_CFG,
    PMIC_ENUM_RG_LDO_VRF18_2_HW2_OP_CFG,
    PMIC_ENUM_RG_LDO_VRF18_2_ON_OP,
    PMIC_ENUM_RG_LDO_VRF18_2_LP_OP,
    PMIC_ENUM_RG_LDO_VRF18_2_OP_CFG_SET,
    PMIC_ENUM_RG_LDO_VRF18_2_OP_CFG_CLR,
    PMIC_ENUM_DA_QI_VRF18_2_MODE,
    PMIC_ENUM_DA_QI_VRF18_2_EN,
    PMIC_ENUM_RG_LDO_VRF18_2_OCFB_EN,
    PMIC_ENUM_DA_QI_VRF18_2_OCFB_EN,
    ...
    PMIC_ENUM_RG_LDO_VSRAM_MD_EN,
    PMIC_ENUM_RG_LDO_VSRAM_MD_LP,
    PMIC_ENUM_RG_LDO_VSRAM_MD_VOSEL,
    PMIC_ENUM_RG_LDO_VSRAM_MD_VOSEL_SLEEP,
    PMIC_ENUM_RG_LDO_VSRAM_MD_SW_OP_EN,
    PMIC_ENUM_RG_LDO_VSRAM_MD_HW0_OP_EN,
    PMIC_ENUM_RG_LDO_VSRAM_MD_HW1_OP_EN,
    PMIC_ENUM_RG_LDO_VSRAM_MD_HW2_OP_EN,
    PMIC_ENUM_RG_LDO_VSRAM_MD_OP_EN_SET,
    PMIC_ENUM_RG_LDO_VSRAM_MD_OP_EN_CLR,
    PMIC_ENUM_RG_LDO_VSRAM_MD_HW0_OP_CFG,
    PMIC_ENUM_RG_LDO_VSRAM_MD_HW1_OP_CFG,
    PMIC_ENUM_RG_LDO_VSRAM_MD_HW2_OP_CFG,
    PMIC_ENUM_RG_LDO_VSRAM_MD_ON_OP,
    PMIC_ENUM_RG_LDO_VSRAM_MD_LP_OP,
    PMIC_ENUM_RG_LDO_VSRAM_MD_OP_CFG_SET,
    PMIC_ENUM_RG_LDO_VSRAM_MD_OP_CFG_CLR,
    PMIC_ENUM_DA_QI_VSRAM_MD_MODE,
    PMIC_ENUM_DA_QI_VSRAM_MD_VOSEL_GRAY,
    PMIC_ENUM_DA_QI_VSRAM_MD_VOSEL,
    PMIC_ENUM_DA_QI_VSRAM_MD_EN,
    PMIC_ENUM_DA_QI_VSRAM_MD_STB,
    PMIC_ENUM_DA_NI_VSRAM_MD_VSLEEP_SEL,
...
}PMIC6355_FLAGS_LIST_ENUM;

#endif // #ifdef PMIC_6355_REG_API
#endif // #ifndef __DCL_PMIC6355_SW_H_STRUCT__
