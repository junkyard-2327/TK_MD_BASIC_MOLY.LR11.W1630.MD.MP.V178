 ...
 *******************************************************************************/
  ...
  #define BOOTTRACE_BKBUF_SIZE		1024
  kal_uint8 boot_trace_log[BOOTTRACE_BKBUF_SIZE];   // ccci reserves 1k currently
#endif
...
void INT_backupBootLogs(void)
{
	...
	if ((EMM_GetBufInfo(&log_addr, &log_size, EMM_DBG_INFO)) && log_addr && log_size)
	{
