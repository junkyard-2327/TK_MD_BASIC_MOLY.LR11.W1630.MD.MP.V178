...
/*******************************************************************************
 * L1Core Boot slave register base
 *******************************************************************************/

#define MCU_BOOTSLV_JUMP_ADDR         (L1_BASE_MADDR_MDL1_CONF + 0x100)
#define MCU_BOOTSLV_JUMP_ADDR_UPDATE  (L1_BASE_MADDR_MDL1_CONF + 0x104)
#define MCU_BOOTSLV_JUMP_KEY_ADDR     (L1_BASE_MADDR_MDL1_CONF + 0x104)
#define MCU_BOOTSLV_JUMP_KEY_VALUE    (0x6291F8EE)
#define MCU_BOOTSLV_JUMP_NONKEY_VALUE (0x629110C4)
