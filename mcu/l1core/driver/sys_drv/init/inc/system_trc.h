...
BEGIN_TRACE_MAP(MOD_SYSTEM)
    ...
    TRC_MSG(SST_INIT_SYSSTACK_PROT_ENTER, "Enter system stack protect init")
    TRC_MSG(SST_INIT_SYSSTACK_PROT_EXIT, "Exit system stack protect init")
    TRC_MSG(SST_INIT_CLIB1_ENTER, "Enter C library basic init")
    TRC_MSG(SST_INIT_CLIB1_EXIT, "Exit C library basic init")
    TRC_MSG(SST_INIT_INIT_NU_WDT_BASE_ENTER, "Enter NU WDT base init")
    TRC_MSG(SST_INIT_INIT_NU_WDT_BASE_EXIT, "Exit NU WDT base init")
    ...
    TRC_MSG(SST_INIT_ECT_ENTER, "Enter ECT init")
    TRC_MSG(SST_INIT_ECT_EXIT, "Exit ECT init")
    TRC_MSG(SST_INIT_MD32_ENTER, "Enter MD32 init")
    TRC_MSG(SST_INIT_MD32_EXIT, "Exit MD32 init")
    TRC_MSG(SST_INIT_MAINP_ENTER, "Enter MAINP init")
    TRC_MSG(SST_INIT_MAINP_EXIT, "Exit MAINP init")
    TRC_MSG(SST_INIT_SLA_ENTER, "Enter SWLA init")
    TRC_MSG(SST_INIT_SLA_EXIT, "Exit SWLA init")
