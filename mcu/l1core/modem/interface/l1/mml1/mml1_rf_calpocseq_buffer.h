...
/** Set TX forward gain table */
MMPOC_BUFFER_DEF (RF_TX_GAIN_TABLE_BUFFER_TYPE,           RF_TX_GAIN_TABLE_BUFFER_T,          MML1_RF_RFIC1, MML1_MIPI_SUPPORT_RW_CNT)

/** Set DET forward gain table */
MMPOC_BUFFER_DEF (RF_DET_GAIN_TABLE_BUFFER_TYPE,          RF_DET_GAIN_TABLE_BUFFER_T,         MML1_RF_RFIC1, MML1_MIPI_SUPPORT_RW_CNT)
