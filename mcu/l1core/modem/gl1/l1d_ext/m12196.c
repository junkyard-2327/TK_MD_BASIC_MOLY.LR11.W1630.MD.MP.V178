...
/*MT6280RF*/
/*MT6280RF*/ #if defined(__UMTS_RAT__) && defined ( __UMTS_FDD_MODE__ )
/*MT6280RF*/    #if L1D_WT_COBIN_ARCHITECTURE_SUPPORT
/*MT6280RF*/          if( (L1D_WT_Query_FDD_Enable(KAL_TRUE) == KAL_TRUE) && UL1D_RF_CheckDMPower() ) /* 3G is already ON, so 2G does not do the power-on reset */
/*MT6280RF*/    #else
...
/*MT6280RF*/ #if defined(__UMTS_RAT__) && defined ( __UMTS_FDD_MODE__ )
/*MT6280RF*/    #if L1D_WT_COBIN_ARCHITECTURE_SUPPORT
/*MT6280RF*/       if( (L1D_WT_Query_FDD_Enable(KAL_TRUE) == KAL_TRUE) && UL1D_RF_CheckDMPower() ) /* 3G is still ON, so 2G can not do the power-off sequence */
/*MT6280RF*/    #else
...
/*MT6169*/       if( l1d_rf.is_init )
/*MT6169*/       {  /* Keep AFC DAC & CAP ID as MT6165 default setting, since we currently don't have calibrated AFC data. */ }
/*MT6169*/       else
/*MT6169*/       {
...
/*MT6169*//*TDD*/   #if L1D_WT_COBIN_ARCHITECTURE_SUPPORT
/*MT6169*//*TDD*/   if( L1D_WT_Query_TDD_Enable() == KAL_TRUE )
/*MT6169*//*TDD*/   {  L1D_RF_SET_2G_POWER_STATUS( 1 );  }
/*MT6169*//*TDD*/   #else
/*MT6169*//*TDD*/   L1D_RF_SET_2G_POWER_STATUS( 1 );
/*MT6169*//*TDD*/   #endif
/*MT6169*/    #endif
...
/*MT6169*/       else
/*MT6169*/       {
/*MT6169*/    #if L1D_WT_COBIN_ARCHITECTURE_SUPPORT
/*MT6169*/       #if (defined(__UMTS_RAT__) && defined(__UMTS_FDD_MODE__)) || IS_AST3002_SUPPORT
/*MT6169*/          if( ( L1D_WT_Query_FDD_Enable(KAL_TRUE) == KAL_TRUE ) )
/*MT6169*/          {
...
/*MT6169*/             }
/*MT6169*/          }
/*MT6169*/          else if( ( L1D_WT_Query_TDD_Enable() == KAL_TRUE ) && L1D_RF_CHECK_TDD_POWER( 1 ) ) /* 3G is already ON, so 2G does not do the power-on reset */
/*MT6169*/          {
/*MT6169*/             l1d_rf2.is_2g_on = 1;                                     /* set 2G flag to notify 2G is ON */
/*MT6169*/             L1D_DM_Power_Control_Trace( 1, 1 );                       /* indicate 2G is ON and 3G is ON */
/*MT6169*/          }
/*MT6169*/          else
/*MT6169*/       #endif
/*MT6169*/    #else /* L1D_WT_COBIN_ARCHITECTURE_SUPPORT */
/*MT6169*/       #if defined(__UMTS_RAT__) && defined(__UMTS_FDD_MODE__)
/*MT6169*/          extern char UL1D_RF_CheckDMPower( void );                    /* check 3g RF flag */
/*MT6169*/          _savedMask = SaveAndSetIRQMask();                            /* disable interrupt */
/*MT6169*/
...
/*MT6169*/          else
/*MT6169*/       #endif
/*MT6169*/    #endif /* L1D_WT_COBIN_ARCHITECTURE_SUPPORT */
/*MT6169*/          {
/*MT6169*/             l1d_rf2.is_2g_on = 1;                                     /* set 2G flag to notify 2G is ON */
/*MT6169*/             L1D_DM_Power_Control_Trace( 1, 0 );                       /* indicate 2G is ON and 3G is OFF */
/*MT6169*/       #if defined(__UMTS_RAT__) && defined(__UMTS_FDD_MODE__)
/*MT6169*//*FDD*/   #if L1D_WT_COBIN_ARCHITECTURE_SUPPORT
/*MT6169*//*FDD*/      if( L1D_WT_Query_FDD_Enable(KAL_TRUE) == KAL_TRUE )
/*MT6169*//*FDD*/      {  RestoreIRQMask(_savedMask);  }                         /* enable interrupt */
/*MT6169*//*FDD*/   #else
/*MT6169*//*FDD*/      RestoreIRQMask(_savedMask);                               /* enable interrupt */
/*MT6169*//*FDD*/   #endif
/*MT6169*/       #endif
...
/*MT6169*/       }
/*MT6169*/    }
/*MT6169*/    else if( ( L1D_WT_Query_TDD_Enable() == KAL_TRUE ) && L1D_RF_CHECK_TDD_POWER( 0 ) ) /* 3G is already ON, so 2G does not do the power-on reset */
/*MT6169*/    {
...
#if IS_RF_MT6176
/*MT6176*/
/*MT6176*/ #include "intrCtrl.h"
/*MT6176*/
/*MT6176*/ /***********************************************************************************/
/*MT6176*/ /*  Local Variables                                                                */
/*MT6176*/ /***********************************************************************************/
/*MT6176*/ 
/*MT6176*/
/*MT6176*/ extern void L1D_DM_Power_Control_Trace( char is_2g, char is_3g );
/*MT6176*/ #if IS_RF_CENTRAL_CONTROL_ENABLE
/*MT6176*/ void  L1D_RF_PowerOn( void )
/*MT6176*/ {
/*MT6176*/    if( l1d_rf.is_init || l1d_rf2.is_wakeup )
/*MT6176*/    {
/*MT6176*/       /* RF Power On by MML1 RF central control */
/*MT6176*/       MML1_RF_POWER_ON( l1d_rf2.is_wakeup, MML1_RF_2G );
/*MT6176*/       /* Set the 2G force PWM mode */
/*MT6176*/       L1D_PMIC_ADPT2_PWM_ENABLE( 1 );  // to be checked PMIC control
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    if( !l1d_rf2.is_wakeup )
/*MT6176*/    {  L1D_RF_Set_FixAFC_Status();
/*MT6176*/    }
/*MT6176*/
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_PowerOff( void )
/*MT6176*/ {  // Sleep to Phone Standby
/*MT6176*/    /* RF Power Off by RF central control, SW need not send any BSI CW */
/*MT6176*/
/*MT6176*/    HW_WRITE( DIG_CON4, 0x0 );
/*MT6176*/    extern void L1D_RF_Info_Trace( unsigned short idx, long v1, long v2 );
/*MT6176*/    L1D_RF_Info_Trace( 12196, HW_READ(DIG_CON4), 0);
/*MT6176*/    /* Clear the 2G force PWM mode */
/*MT6176*/    L1D_PMIC_ADPT2_PWM_ENABLE( 0 );
/*MT6176*/    MML1_RF_POWER_OFF( MML1_RF_2G );
/*MT6176*/
/*MT6176*/ #if IS_RF_TOOL_CUSTOMIZATION_SUPPORT_V2 && IS_2G_DRDI_SUPPORT
/*MT6176*/    L1D_CustomDynamicDebug();
/*MT6176*/ #endif
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_WindowOn( void )
/*MT6176*/ {
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_WindowOff( void )
/*MT6176*/ {
/*MT6176*/ }
/*MT6176*/
/*MT6176*/
