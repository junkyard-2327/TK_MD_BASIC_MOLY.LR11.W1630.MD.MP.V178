 ...
 *
 * 11 26 2015 wiley.li
 * [MOLY00150656] [L1D][Modify] Include "l1d_loc_def.h" to improve FHC pathloss calibration
 * 	
 * 	.
 *
 * 09 10 2015 wiley.li
 ...
 *
 * 05 12 2015 wiley.li
 * [MOLY00113091] [L1D][Modify] Update RX gain table and W coefficient gain idx
 * 	.
 *
 ...
 * 	.
 *
 * 08 30 2013 yi-ying.lin
 * [MOLY00035947] [L1D][Modify] Change LB RX gain table for MT6166
 * 	.
 *
...
/*MT6176*/ /* GSM850....................................................................*/
/*MT6176*/
/*MT6176*/ const  sL1DAGCDATA  AGC_TABLE_GSM850[7] =
...
/*MT6176*/    {  GBOUND(( 26.6-PVOFSL ),( 23.6-PVOFSL ) ), GC_A( 0,(  26.6-PVOFSL ) ), BSI_CW(0x14E, 0x0001D) },
...
/*MT6176*/    {  GBOUND((  2.6-PVOFSL ),(  2.6-PVOFSL ) ), GC_A( 0,(   2.6-PVOFSL ) ), BSI_CW(0x14E, 0x00019) },
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ /* GSM900....................................................................*/
/*MT6176*/
/*MT6176*/ const  sL1DAGCDATA  AGC_TABLE_GSM900[7] =
/*MT6176*/ {  {  GBOUND(( 44.6-PVOFSL ),( 41.6-PVOFSL ) ), GC_A( 4,(  44.6-PVOFSL ) ), BSI_CW(0x14E, 0x0000E) },  // Orion+ has PRX1 & DRX1 (CW334 & CW336), use CW334 as defualt setting
/*MT6176*/    {  GBOUND(( 41.6-PVOFSL ),( 38.6-PVOFSL ) ), GC_A( 5,(  41.6-PVOFSL ) ), BSI_CW(0x14E, 0x0001E) },
/*MT6176*/    {  GBOUND(( 29.6-PVOFSL ),( 26.6-PVOFSL ) ), GC_A( 3,(  29.6-PVOFSL ) ), BSI_CW(0x14E, 0x0001D) },
/*MT6176*/    {  GBOUND(( 26.6-PVOFSL ),( 23.6-PVOFSL ) ), GC_A( 0,(  26.6-PVOFSL ) ), BSI_CW(0x14E, 0x0001D) },
...
/*MT6176*/ /* DCS1800...................................................................*/
/*MT6176*/
/*MT6176*/ const  sL1DAGCDATA  AGC_TABLE_DCS1800[7] =
...
/*MT6176*/    {  GBOUND(( 26.6-PVOFSH ),( 23.6-PVOFSH ) ), GC_A( 0,(  26.6-PVOFSH ) ), BSI_CW(0x14E, 0x0001D) },
...
/*MT6176*/    {  GBOUND((  2.6-PVOFSH ),(  2.6-PVOFSH ) ), GC_A( 0,(   2.6-PVOFSH ) ), BSI_CW(0x14E, 0x00019) },
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ /* PCS1900...................................................................*/
/*MT6176*/
/*MT6176*/ const  sL1DAGCDATA  AGC_TABLE_PCS1900[7] =
/*MT6176*/ {  {  GBOUND(( 44.6-PVOFSH ),( 41.6-PVOFSH ) ), GC_A( 4,(  44.6-PVOFSH ) ), BSI_CW(0x14E, 0x0000E) },  // Orion+ has PRX1 & DRX1 (CW334 & CW336), use CW334 as defualt setting
/*MT6176*/    {  GBOUND(( 41.6-PVOFSH ),( 38.6-PVOFSH ) ), GC_A( 5,(  41.6-PVOFSH ) ), BSI_CW(0x14E, 0x0001E) },
/*MT6176*/    {  GBOUND(( 29.6-PVOFSH ),( 26.6-PVOFSH ) ), GC_A( 3,(  29.6-PVOFSH ) ), BSI_CW(0x14E, 0x0001D) },
/*MT6176*/    {  GBOUND(( 26.6-PVOFSH ),( 23.6-PVOFSH ) ), GC_A( 0,(  26.6-PVOFSH ) ), BSI_CW(0x14E, 0x0001D) },
...
/*MT6176*/    unsigned short   eLNA       = L1D_RF_Check_If_ExternalLNA(rf_band);   // check if using eLNA
/*MT6176*/    #endif
/*MT6176*/
...
/*MT6176*/    #if IS_2G_EXTERNAL_LNA_SUPPORT
/*MT6176*/    if( eLNA&&(!L1D_CheckIfMetaMode())) // Voltage_Gain to Power_Gain under normal mode for eLNA GainSearchTable (m11303.c)
...
/*MT6176*/    {
/*MT6176*/    #if IS_2G_EXTERNAL_LNA_SUPPORT
/*MT6176*/       if( eLNA && (L1D_CheckIfMetaMode()) )
...
/*MT6176*/              {
/*MT6176*/                 case 1:
/*MT6176*/                    setting   = (agcptr->setting&0x3FFFFFC0)|(0x6<<6)|(0x7<<3)|0x4;  // reduce LNA/TIA, increase LPF2 Gain
/*MT6176*/                    real_gain-= (LNA_DROP_GAIN+TIA_DROP_GAIN+(bit_no-6)*LPF2_DROP_GAIN);
/*MT6176*/                    break;
/*MT6176*/                 default:
/*MT6176*/                    setting   = agcptr->setting | ((bit_no&0xF)<<6);  
/*MT6176*/                    break;
/*MT6176*/              }
/*MT6176*/           }
/*MT6176*/           else
...
/*MT6176*/              {
/*MT6176*/                 case 1:
/*MT6176*/                    setting   = (agcptr->setting&0x3FFFFFC0)|((bit_no&0xF)<<6)|(0x1<<3)|0x5;  // reduce LNA Gain
/*MT6176*/                    real_gain-= (LNA_DROP_GAIN);
/*MT6176*/                    break;
/*MT6176*/                 case 2:
/*MT6176*/                    setting   = (agcptr->setting&0x3FFFFFC0)|(0x6<<6)|(0x3<<3)|0x5;  // reduce LNA/TIA/LPF2 Gain
/*MT6176*/                    real_gain-= (LNA_DROP_GAIN+TIA_DROP_GAIN+(bit_no-6)*LPF2_DROP_GAIN);
/*MT6176*/                    break;
/*MT6176*/                 case 3:
/*MT6176*/                    setting   = (agcptr->setting&0x3FFFFFC0)|(0x6<<6)|(0x3<<3)|0x6;  // reduce TIA Gain, increase LPF2 Gain
/*MT6176*/                    real_gain-= (TIA_DROP_GAIN+(bit_no-6)*LPF2_DROP_GAIN);
/*MT6176*/                    break;
/*MT6176*/                 case 4:
/*MT6176*/                    setting   = (agcptr->setting&0x3FFFFFC0)|(((bit_no-1)&0xF)<<6)|(0x7<<3)|0x5;  // reduce LNA/TIA/LPF2 Gain
/*MT6176*/                    real_gain-= (LNA_DROP_GAIN+TIA_DROP_GAIN+LPF2_DROP_GAIN);
/*MT6176*/                    break;
/*MT6176*/                 case 5:
/*MT6176*/                    setting   = (agcptr->setting&0x3FFFFFC0)|(((bit_no-1)&0xF)<<6)|(0x3<<3)|0x5;  // reduce LNA/LPF2 Gain
...
/*MT6176*/       {  setting |= 0x800;  }  // if  freq.>1400MHz and LNA gain is maximum(3b'110), bit11 sets to 1(RX_LNA_FBRO_PATH1=1).
/*MT6176*/
