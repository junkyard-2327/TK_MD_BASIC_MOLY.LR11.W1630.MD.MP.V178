...
#define IS_DCXO_ENABLE                             0
   #endif
#elif IS_SOC_CHIP || IS_MT6162_6163_DCXO_SUPPORT || IS_CHIP_MT6572 || IS_CHIP_MT6290 || IS_CHIP_MT6595 || IS_CHIP_MT6752_MD1 || IS_CHIP_MT6752_MD2 || IS_CHIP_TK6291 || IS_CHIP_MT6755
#define IS_AFC_EVENT_ENABLE                        0
#define IS_DCXO_ENABLE                             1
#else
#define IS_AFC_EVENT_ENABLE                        1
...
#if IS_DCXO_ENABLE
   #if IS_SOC_CHIP || IS_MT6162_6163_DCXO_SUPPORT || IS_CHIP_MT6572 || IS_CHIP_MT6290 || IS_CHIP_MT6595 || IS_CHIP_MT6752_MD1 || IS_CHIP_MT6752_MD2 || IS_CHIP_TK6291 || IS_CHIP_MT6755
