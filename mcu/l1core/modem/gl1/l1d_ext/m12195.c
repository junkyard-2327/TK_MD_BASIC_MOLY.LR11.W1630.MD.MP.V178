...
extern uintBPI DATBPITable[FrequencyBandCount][L1D_DAT_STATE_NUM][2];
#endif
...
void  L1D_RF_SetPData_PR( void )
{
   ...
   {         
      tas_mask = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][0];
      tas_bpi  = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][1];  
   }
   else
   {
      // Do nothing
...
/*EGPRS*/  #endif
/*EGPRS*/
/*EGPRS*/ #if IS_2G_DAT_SUPPORT
/*EGPRS*/    if( l1d_rf.dat_ant_state >= L1D_DAT_STATE0 )
/*EGPRS*/    {         
/*EGPRS*/       tas_mask = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][0];
/*EGPRS*/       tas_bpi  = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][1];  
/*EGPRS*/    }
/*EGPRS*/    else
/*EGPRS*/    {
/*EGPRS*/       // do nothing
...
/*MT6218~*/
   #if IS_2G_DAT_SUPPORT
/*MT6218~*/ if( l1d_rf.dat_ant_state >= L1D_DAT_STATE0 )
/*MT6218~*/ {         
/*MT6218~*/    tas_mask = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][0];
/*MT6218~*/    tas_bpi  = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][1];  
/*MT6218~*/ }
/*MT6218~*/ else
/*MT6218~*/ {
/*MT6218~*/    // do nothing
...
/*MT6229~*/
/*MT6229~*/#if IS_2G_DAT_SUPPORT
/*MT6229~*/ if( l1d_rf.dat_ant_state >= L1D_DAT_STATE0 )
/*MT6229~*/ {         
/*MT6229~*/    tas_mask = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][0];
/*MT6229~*/    tas_bpi  = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][1];  
/*MT6229~*/ }
/*MT6229~*/ else
/*MT6229~*/ {
/*MT6229~*/    // do nothing
...
/*MT6229~*//*EGPRS*/    long         tas_bpi = GET_TAS_BPI;
      #if IS_2G_DAT_SUPPORT
/*MT6229~*//*EGPRS*/    if( l1d_rf.dat_ant_state >= L1D_DAT_STATE0 )
/*MT6229~*//*EGPRS*/    {         
/*MT6229~*//*EGPRS*/       tas_mask = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][0];
/*MT6229~*//*EGPRS*/       tas_bpi  = DATBPITable[l1d_rf.band][l1d_rf.dat_ant_state][1];  
/*MT6229~*//*EGPRS*/    }
/*MT6229~*//*EGPRS*/    else
/*MT6229~*//*EGPRS*/    {
/*MT6229~*//*EGPRS*/       // do nothing
/*MT6229~*//*EGPRS*/    }
      #endif
      #if IS_DSDA_DCS_TX_NOTCH_SWITCH_SUPPORT
