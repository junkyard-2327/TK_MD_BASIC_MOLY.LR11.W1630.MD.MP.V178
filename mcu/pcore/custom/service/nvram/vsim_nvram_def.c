...
#ifdef __MDVSIM__
static kal_uint8 const NVRAM_VSIM_EF_IMSI_DEFAULT[] = {         // nvram_vsim_ef_file_struct
...
static kal_uint8 const NVRAM_VSIM_EF_U_IMSI_DEFAULT[] = {       // nvram_vsim_ef_file_struct
    /* The first 96 is meta data : start*/
...
static kal_uint8 const NVRAM_VSIM_CONFIG_DEFAULT[] = {          // nvram_vsim_config_struct
...
static kal_uint8 const NVRAM_VSIM_PROFILE_DEFAULT[] = {          // nvram_vsim_profile_struct
...
ltable_entry_struct logical_data_item_table_vsim[] =
{
#ifdef __MDVSIM__
		{
			...
			NVRAM_VSIM_CONFIG_TOTAL,
			NVRAM_VSIM_CONFIG_SIZE,
			NVRAM_NORMAL(NVRAM_VSIM_CONFIG_DEFAULT),
			NVRAM_CATEGORY_USER,
			NVRAM_ATTR_AVERAGE | NVRAM_ATTR_FACTORY_RESET,
			"MT8A",
			VER(NVRAM_VSIM_CONFIG_LID)
		},
		
		{
			NVRAM_VSIM_PROFILE_LID,
			NVRAM_VSIM_PROFILE_TOTAL,
			NVRAM_VSIM_PROFILE_SIZE,
			NVRAM_NORMAL(NVRAM_VSIM_PROFILE_DEFAULT),
			NVRAM_CATEGORY_USER,
			NVRAM_ATTR_AVERAGE | NVRAM_ATTR_FACTORY_RESET,
			"MT8B",
			VER(NVRAM_VSIM_PROFILE_LID)
		},
		
		{
			NVRAM_EF_VSIM_SIM_IMSI_LID,
			NVRAM_VSIM_SIM_EF_TOTAL,
			NVRAM_VSIM_EF_DEFUALT_SIZE,
			NVRAM_NORMAL(NVRAM_VSIM_EF_IMSI_DEFAULT),
			NVRAM_CATEGORY_USER,
			NVRAM_ATTR_AVERAGE | NVRAM_ATTR_CONFIDENTIAL | NVRAM_ATTR_FACTORY_RESET,
			"MT8C",
		...
		
		{
			...
			NVRAM_VSIM_USIM_EF_TOTAL,
			NVRAM_VSIM_EF_U_DEFUALT_SIZE,
			NVRAM_NORMAL(NVRAM_VSIM_EF_U_IMSI_DEFAULT),
			NVRAM_CATEGORY_USER,
			NVRAM_ATTR_AVERAGE | NVRAM_ATTR_CONFIDENTIAL | NVRAM_ATTR_FACTORY_RESET,
			"MT8D",
