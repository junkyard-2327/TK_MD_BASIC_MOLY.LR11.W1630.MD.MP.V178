...
//ANT RX
LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_ANTRX_EVENT_Set1[] =
{
...
LTE_MIPI_EVENT_TABLE_T LTE_Band1_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 5    , 7    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_RX_OFF0_Set1 },  
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band2_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band3_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band4_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band5_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band7_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 4    , 5    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_RX_OFF0_Set1 },  
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band8_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band12_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band13_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band17_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band20_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band26_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band28_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band29_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band30_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band40_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band41_MIPI_ANTRX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_Set1  },  
...
//ANT TX
LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band1_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 5    , 7    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_TX_OFF0_Set1 },  
   { /* 3  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band2_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band3_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band4_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band5_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band7_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 3    , 3    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_TX_OFF0_Set1 },  
     { /* 3  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band8_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 4    , 5    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_TX_OFF0_Set1 },  
   { /* 3  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band12_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band13_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band17_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band20_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band26_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band28_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band30_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band40_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_Set1  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band41_MIPI_ANTTX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_Set1  },  
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
kal_uint32  LTE_MIPI_ANTRX_EVENT_SIZE_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_ANTRX_EVENT_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
kal_uint32  LTE_MIPI_ANTTX_EVENT_SIZE_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_ANTTX_EVENT_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_ANTRX_DATA_Set1[] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band1_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band2_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band4_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band5_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band7_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band8_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band12_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band13_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band17_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band20_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band26_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band28_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band29_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band30_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band39_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_ANTRX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
//ANT TX start
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   },} },
};

LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band1_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band2_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band4_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band5_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band6_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band7_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band8_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band12_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band13_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band17_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band20_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band26_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band28_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band30_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band39_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_ANTTX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
//ANT RX
kal_uint32  LTE_MIPI_ANTRX_DATA_SIZE_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_ANTRX_DATA_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
//ANT TX
kal_uint32  LTE_MIPI_ANTTX_DATA_SIZE_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_ANTTX_DATA_TABLE_Set1[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
