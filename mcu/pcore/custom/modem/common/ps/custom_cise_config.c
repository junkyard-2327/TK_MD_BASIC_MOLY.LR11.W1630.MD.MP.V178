...
#ifdef __WCDMA_IMPROVED_IRAT_RESELECTION_THRES_CUSTOM__
kal_bool uas_custom_is_delta_rsrp_enabled = KAL_TRUE;
#endif
...
/*****************************************************************************
* FUNCTION
*  uas_custom_is_delta_rsrp_enabled
* DESCRIPTION
*   use this function to get delta RSRP is enable or disable
*
* PARAMETERS
*  Void
* RETURNS
...
*   None
*****************************************************************************/
extern kal_bool uas_custom_get_delta_rsrp_enabled(void)
{
    return uas_custom_is_delta_rsrp_enabled;
}
#endif
