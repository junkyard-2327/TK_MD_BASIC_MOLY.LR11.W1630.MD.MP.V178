...
#define IS_3G_ET_ENABLE_Set0    0

#if (IS_3G_ET_ENABLE_Set0)
   #if (IS_3G_MIPI_ENABLE_Set0)
   #else
...
extern UL1_MIPI_DATA_TABLE_T*         UMTS_MIPI_ASM_ISOLATION_DATA_TABLE_Set0[];

extern UL1_UMTS_MIPI_TPC_T*           UMTS_MIPI_TPC_TABLE_Set0[];

#if (IS_3G_ET_SUPPORT)
extern UL1_MIPI_DATA_TABLE_T          UMTS_MIPI_ET_ON_STATIC_CW_Set0[];
extern UL1_MIPI_DATA_TABLE_T          UMTS_MIPI_ET_OFF_STATIC_CW_Set0[];
extern UL1_MIPI_EVENT_TABLE_T*        UMTS_MIPI_ET_EVENT_TABLE_Set0[];
extern UL1_MIPI_DATA_SUBBAND_TABLE_T* UMTS_MIPI_ET_DATA_TABLE_Set0[];
extern UL1_UMTS_MIPI_ET_T*            UMTS_MIPI_ET_TABLE_Set0[];
extern UL1_UMTS_MIPI_ET_PARAM_T       UL1_ET_PARAM_Set0;

#if (IS_3G_VPA_SEL_BY_BAND_SUPPORT)
extern UMTS_VPA_SOURCE_TYPE*          UMTS_VPA_SRC_SEL_TABLE_Set0[];
