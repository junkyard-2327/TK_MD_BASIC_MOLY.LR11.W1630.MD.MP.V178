...
Ul1CustomDynamicDatRoute ul1CustomDatRoute[UL1CUSTOM_TOTAL_REAL_SET_NUMS] =
{
#if !(UL1CUSTOM_DRDI_ENABLE)
...
Ul1CustomDynamicDatDb ul1CustomDatDb[UL1CUSTOM_TOTAL_REAL_SET_NUMS] =
{
#if !(UL1CUSTOM_DRDI_ENABLE)
...
Ul1CustomDynamicDatFeatureByRat ul1CustomDatByRat[UL1CUSTOM_TOTAL_REAL_SET_NUMS] =
{
#if !(UL1CUSTOM_DRDI_ENABLE)
...
#if (IS_3G_MIPI_SUPPORT)
Ul1CustomDynamicDatMipiData ul1CustomDatMipiData[UL1CUSTOM_TOTAL_REAL_SET_NUMS] = 
{
#if !(UL1CUSTOM_DRDI_ENABLE)
