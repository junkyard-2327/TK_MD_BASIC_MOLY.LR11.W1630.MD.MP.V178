...
const sL1_TAS_CUSTOM_PARAMS L1_TAS_Custom_Params_Set1=
{
   L1D_FORCE_TX_ANTENNA_ENABLE_Set1,             /* 0: off 1: Don't change antenna                                             */
   L1D_FORCE_TX_ANTENNA_IDX_Set1,                /* The antenna which user forces to stay                                      */
   L1D_EN_TAS_Set1,                              /* 0: off   1: enable TS feature                                              */
   L1D_EN_TAS_WITH_TEST_SIM_Set1,                /* 0: off   1: enable TS feature with Test SIM                                */
   L1D_EN_BAND_Set1,                             /* b0:band 850,b1:band 900,b2:band 1800,b3:band 1900                          */
   L1D_ANT_SEL_INIT_Set1,                        /* Default antenna                                                            */
   L1D_EN_TAS_FOR_C2K_Set1,                      /* 0: off   1: enable TAS for C2K feature*/
};
   #if IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM
const sL1_TAS_INIT_ANT_PARAMS L1_TAS_Init_Ant_Params_Set1=
{
   0,
   L1D_TAS_INIT_ANT_GSM850_Set1,
   L1D_TAS_INIT_ANT_GSM900_Set1,
   L1D_TAS_INIT_ANT_DCS1800_Set1,
   L1D_TAS_INIT_ANT_PCS1900_Set1,
};
   #endif

const sL1_TAS_CUSTOM_PDATA L1_TAS_Custom_PData_Set1=
{
   PDATA_L1D_TAS_MASK_Set1,
   {
      //GSM400 // Not support
      {  0, 0, 0, 0, 0, 0, 0  },
      //GSM850
      {  PDATA_L1D_GSM850_TAS1_Set1,
         PDATA_L1D_GSM850_TAS2_Set1,
         PDATA_L1D_GSM850_TAS3_Set1,
         PDATA_L1D_GSM850_TAS4_Set1,
         PDATA_L1D_GSM850_TAS5_Set1,
         PDATA_L1D_GSM850_TAS6_Set1,
         PDATA_L1D_GSM850_TAS7_Set1
      },
      //GSM900
      {  PDATA_L1D_GSM900_TAS1_Set1,
         PDATA_L1D_GSM900_TAS2_Set1,
         PDATA_L1D_GSM900_TAS3_Set1,
         PDATA_L1D_GSM900_TAS4_Set1,
         PDATA_L1D_GSM900_TAS5_Set1,
         PDATA_L1D_GSM900_TAS6_Set1,
         PDATA_L1D_GSM900_TAS7_Set1
      },      
      //DCS1800
      {  PDATA_L1D_DCS1800_TAS1_Set1,
         PDATA_L1D_DCS1800_TAS2_Set1,
         PDATA_L1D_DCS1800_TAS3_Set1,
         PDATA_L1D_DCS1800_TAS4_Set1,
         PDATA_L1D_DCS1800_TAS5_Set1,
         PDATA_L1D_DCS1800_TAS6_Set1,
         PDATA_L1D_DCS1800_TAS7_Set1
      },
      //PCS1900
      {  PDATA_L1D_PCS1900_TAS1_Set1,
         PDATA_L1D_PCS1900_TAS2_Set1,
         PDATA_L1D_PCS1900_TAS3_Set1,
         PDATA_L1D_PCS1900_TAS4_Set1,
         PDATA_L1D_PCS1900_TAS5_Set1,
         PDATA_L1D_PCS1900_TAS6_Set1,
         PDATA_L1D_PCS1900_TAS7_Set1
      }
   }
};
#endif
