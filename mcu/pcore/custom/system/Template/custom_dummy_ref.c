...
*/
   extern void EL1D_SHAREBUF_DUMMY_REF( void );
   extern void UL1D_SHAREBUF_DUMMY_REF( void );
   extern void MD2G_DRV_SHAREBUF_DUMMY_REF( void );
   extern void CTM_SHAREBUF_DUMMY_REF(void);

   EL1D_SHAREBUF_DUMMY_REF();
   UL1D_SHAREBUF_DUMMY_REF();
   MD2G_DRV_SHAREBUF_DUMMY_REF();
   CTM_SHAREBUF_DUMMY_REF();
}
