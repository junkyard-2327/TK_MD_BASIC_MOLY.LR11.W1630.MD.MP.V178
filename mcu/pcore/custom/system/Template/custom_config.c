...
void remap_mod_task_g(void)
{
   ...
   kal_uint32 module_id;
    ...
    mod_task_g[remap_module_id(MOD_ERRC)] = mod_task_g[remap_module_id(MOD_L1)];//INDX_EL1IT;
#else /* __EL1_EMAC_IT__ */
#ifndef __ESL_COSIM_LTE_L2__
    mod_task_g[remap_module_id(MOD_EMAC)] = mod_task_g[remap_module_id(MOD_L1)];//INDX_EL1IT;
    mod_task_g[remap_module_id(MOD_EL1TX)] = mod_task_g[remap_module_id(MOD_L1)];//INDX_EL1IT;
    mod_task_g[remap_module_id(MOD_ERRC)] = mod_task_g[remap_module_id(MOD_L1)];//INDX_EL1IT;
#endif
#if defined(__UMTS_RAT__)
    mod_task_g[remap_module_id(MOD_UL1)] = mod_task_g[remap_module_id(MOD_L1)];//INDX_EL1IT;
#endif
    ...
    mod_task_g[remap_module_id(MOD_RATDM)]  = mod_task_g[remap_module_id(MOD_EL2IT)];//INDX_EL2_IT;
    ...
    mod_task_g[remap_module_id(MOD_ERRC)]   = mod_task_g[remap_module_id(MOD_EL2IT)];//INDX_EL2_IT;
    mod_task_g[remap_module_id(MOD_RATDM)]    = mod_task_g[remap_module_id(MOD_EL2IT)];//INDX_EL2_IT;
    /* Katie 20150305: to control the whole test flow on target, we decide to remap ERLCDL to EL2IT 
       task for controling the timing of issue EL2 polling */
