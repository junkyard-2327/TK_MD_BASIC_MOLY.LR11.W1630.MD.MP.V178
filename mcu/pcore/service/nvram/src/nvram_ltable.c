...
extern nvram_ltable_entry_struct logical_data_item_table_el1_custom[];
#endif
extern nvram_ltable_entry_struct logical_data_item_table_erac[];
extern nvram_ltable_entry_struct logical_data_item_table_errc[];
extern nvram_ltable_entry_struct logical_data_item_table_ims[];
extern nvram_ltable_entry_struct logical_data_item_table_l4[];
extern nvram_ltable_entry_struct logical_data_item_table_nwsel[];
extern nvram_ltable_entry_struct logical_data_item_table_sbp[];
extern nvram_ltable_entry_struct logical_data_item_table_td[];
extern nvram_ltable_entry_struct logical_data_item_table_umts[];
extern nvram_ltable_entry_struct logical_data_item_table_vsim[];
...
void nvram_pre_init(void)
{
...
#if IS_MIPI_ANT_TUNER_SUPPORT
    nvram_ltable_register(logical_data_item_table_el1_custom);
#endif
	...
	nvram_ltable_register(logical_data_item_table_nwsel);
