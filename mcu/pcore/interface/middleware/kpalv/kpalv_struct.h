...
/*
 * Local parameter structure for MSG_ID_IMSP_KPALV_KEEPALIVE_REQ.
 */
typedef struct _imsp_kpalv_keepalive_enable_req_struct_t {
    LOCAL_PARA_HDR
...
} imsp_kpalv_keepalive_req_struct_t;

/*
 * Local parameter structure for MSG_ID_IMSP_KPALV_KEEPALIVE_CNF.
 */
typedef struct _imsp_kpalv_keepalive_cnf_struct_t {
    LOCAL_PARA_HDR
    kal_bool        result;
    kal_bool        is_ap_disable_rsp; /**< ap requested to disable keep-alive */
    kal_uint8       conn_id;
    kal_uint8       status;
} imsp_kpalv_keepalive_cnf_struct_t;

/*
 * Local parameter structure for MSG_ID_IMSP_KPALV_CONNECTION_STATUS_IND.
 */
typedef struct _imsp_kpalv_connection_status_ind_struct_t {
    LOCAL_PARA_HDR
    kal_uint8       conn_id;
    kal_uint8       status;
} imsp_kpalv_connection_status_ind_struct_t;


typedef imsp_kpalv_keepalive_req_struct_t imsp_kpalv_keepalive_req_struct;
typedef imsp_kpalv_connection_status_ind_struct_t imsp_kpalv_connection_status_ind_struct;
typedef imsp_kpalv_keepalive_cnf_struct_t imsp_kpalv_keepalive_cnf_struct;
