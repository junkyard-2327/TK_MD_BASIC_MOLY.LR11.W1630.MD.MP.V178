 ...
 * $Log$
 *
 * 09 22 2017 wynne.chu
 * [MOLY00278774] LPPe feature development - GPS part
 * 	
 * 	.
 *
 * 06 28 2017 wynne.chu
 * [MOLY00260182] [GNSS] compile option rewrap for LPPe part
 * 	
 * 	.
 *
 * 06 05 2017 jie-yu.wang
 * [MOLY00249699] [Interface] MDT feature change: location time validity
 * [LR11 MP5][Interface] MDT Change.
 *
...
#if defined(__ABDS_SUPPORT__)        
        gnss_bds_clock_model_struct       bdsClockModel;           /* Model-6: for BDS */
#endif /* defined(__ABDS_SUPPORT__) */
   } data;
...
#endif /* defined(__LPP_EXT_SUPPORT__) */     
