...
#define IPC_MAX_SESSION_CNT             256 /* 2011/12/16: SD1/Moja guarantees pdn_id falls in [0,15]. */
#define IPC_MAX_NETIF_CNT               32 /**< Maximal number of host network interfaces supported. Note that, it must <= 32. */
