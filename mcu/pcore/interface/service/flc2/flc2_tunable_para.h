...
#define FLC2_NPDU_UL_CHUNK_SIZE    \
     (FLC2_MEM_SIZE_ALIGN_32( 1704 + 32 + QBM_FLC_UL_HEAD_SPACE + 64))
#else
#define FLC2_NPDU_UL_CHUNK_SIZE    \
     (FLC2_MEM_SIZE_ALIGN_32(QBM_SIZE_HIF_UL_TYPE + QBM_FLC_UL_HEAD_SPACE + 64))
#endif
...
#define _FLC2_NPDU_UL_MAX_GROW  (FLC2_NPDU_UL_CHUNK_SIZE * 470)
...
/******************************************************************************/
// NPDU UL LR: Dual PS Non-main PS (CCMNI Others (MMS, ADMIN, AKA))

#ifdef __MULTIPLE_PS__
#define FLC2_NPDU_UL_LR_POOL_SIZE           (FLC2_NPDU_UL_CHUNK_SIZE * 15)
#else
#define FLC2_NPDU_UL_LR_POOL_SIZE           0
#endif

#define FLC2_MM_BLOCK_NPDU_UL_LR_SIZE       (FLC2_NPDU_UL_LR_POOL_SIZE + \
...
#define FLC2_INTERNAL_UL_POOL_SIZE          (2048 * 21)
#endif
...
// 4G or 3G project
#define FLC2_HIF_UL_02_POOL_SIZE            (FLC2_NPDU_UL_CHUNK_SIZE * 100)
#else
// 2G project
...
#ifdef __MULTIPLE_PS__
// NPDU_UL_LR
#define FLC2_FOR_MULTIPLE_PS_POOL_NUMBER    (1)
#else
#define FLC2_FOR_MULTIPLE_PS_POOL_NUMBER    (0)
#endif
...
#define FLC2_ACT_POOL_ENTITY_TOTAL      (FLC2_APPDU_POOL_NUMBER + \
                                         ...
                                         FLC2_FOR_MULTIPLE_PS_POOL_NUMBER + \
