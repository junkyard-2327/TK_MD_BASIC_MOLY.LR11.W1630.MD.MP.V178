...
typedef enum {
    ...
    FLC2_POOL_ID_HIF_UL_02,             /* 70 */ 
                                        // For LTE HIF_UL_02 pool
#ifdef __MULTIPLE_PS__
    FLC2_POOL_ID_NPDU_UL_LR,            // Dual PS Non-main PS, CCMNI Others (MMS, ADMIN, AKA)
#endif
...
#ifdef __MULTIPLE_PS__
    FLC2_MB_NPDU_UL_LR, /* for NPDU_UL_LR pool */
#endif
