 ...
 * QBM IMS_UL pool check-in for LR11.
 *
...
/*************************BM Pool CFG Begin****************/
/*BM Buffer type*/
bmcfg_type(QBM_TYPE_HIF_DL_SPD) 
/*The buffer number*/
bmcfg_num(QBM_NUM_HIF_DL_SPD) 
/*The size of one buffer*/
bmcfg_one_size(QBM_SIZE_HIF_DL_SPD) 
/*Config do cache invalid for the data part when do de-q-rx*/
bmcfg_cache_invalid(KAL_FALSE) 
/*Config do cache flush the data part when do en-q-tx*/
bmcfg_cache_flush(KAL_FALSE) 
...
/*************************BM Pool CFG Begin****************/
/*BM Buffer type*/
bmcfg_type_flc(QBM_TYPE_HIF_UL_SPD_HR)
/*The buffer number*/
bmcfg_num_flc(QBM_NUM_HIF_UL_SPD_HR) 
/*The size of one buffer*/
bmcfg_one_size_flc(QBM_SIZE_HIF_UL_SPD_HR) 
/*Config do cache invalid for the data part when do de-q-rx*/
...
/*************************BM Pool CFG Begin****************/
/*BM Buffer type*/
bmcfg_type_flc(QBM_TYPE_HIF_UL_SPD_LR)
/*The buffer number*/
bmcfg_num_flc(QBM_NUM_HIF_UL_SPD_LR) 
/*The size of one buffer*/
bmcfg_one_size_flc(QBM_SIZE_HIF_UL_SPD_LR) 
/*Config do cache invalid for the data part when do de-q-rx*/
bmcfg_cache_invalid_flc(KAL_FALSE) 
/*Config do cache flush the data part when do en-q-tx*/
bmcfg_cache_flush_flc(KAL_FALSE) 
