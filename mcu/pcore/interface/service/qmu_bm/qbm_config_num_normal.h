 ...
 * $Log$
 *
 * 10 24 2016 eric.hsieh
 * [MOLY00208954] [91LWA][MP5][QBM] Sercomm/ITRI NVIOT bug fix
 * LWA QBM phase-2 check-in.
 *
...
/****************************************************************************/
    ...
    !defined(__MASE__) && !defined(__ESL_COSIM_LTE__)
...
#define QBM_NUM_HIF_DL_IN_MCCH_Q    8
#define QBM_NUM_HIF_DL_IN_MTCH_Q    60

#endif /* __FPGA__ && __MTK_TARGET__ */
...
#define QBM_NUM_HIF_UL_SPD_HR_IN_HIF    QBM_NUM_HIF_UL_TYPE_IN_HIF
#define QBM_NUM_HIF_UL_SPD_LR_IN_HIF	QBM_NUM_HIF_UL_TYPE_02_IN_HIF
#define QBM_NUM_HIF_UL_SPD_HR			40
#define QBM_NUM_HIF_UL_SPD_LR			2
...
#define QBM_NUM_HIF_DL  (520 + QBM_NUM_HIF_DL_IN_MTCH_Q)

/*! @brief define the number of SPDs.
    
    @since UMOLY    
*/
#ifdef __LWA_SUPPORT__
#define QBM_NUM_HIF_DL_SPD (256)
#else
#define QBM_NUM_HIF_DL_SPD 120
#endif

/****************************************************************************/
#endif  /* QMU_BM_CONFIG_NUM_NORMAL_INC */
