...
typedef void (*IMS_RECONFIG_CUSTOM_FUNC)(kal_uint32 sbp_id, kal_bool is_in_dynamic_sbp, kal_uint8 *imsi, protocol_id_enum ps_id);
...
typedef struct {
    ...
    IMS_RECONFIG_CUSTOM_FUNC             custom_func_ptr;     /* IMS customized  */            
