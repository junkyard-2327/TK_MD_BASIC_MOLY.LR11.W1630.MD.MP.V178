...
typedef struct
{
   ...
   kal_uint16   usid[MML1_MIPI_MAX_HW_CHECK_NUM];
   kal_uint16   pid[MML1_MIPI_MAX_HW_CHECK_NUM];
   kal_uint16   mid[MML1_MIPI_MAX_HW_CHECK_NUM];
}MML1_MIPI_CHECK_REPORT_T;
...
#if defined(__SAR_TX_POWER_BACKOFF_SUPPORT__)
extern MML1_SENSOR_INFO_T mml1_sar_sensor_info_localparam[MAX_SAR_SENSOR_NUM];
