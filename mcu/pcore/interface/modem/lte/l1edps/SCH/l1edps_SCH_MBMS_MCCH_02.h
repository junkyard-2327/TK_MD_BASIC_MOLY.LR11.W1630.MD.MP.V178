 ...
 * $Log$
 *
 * 11 30 2015 david.tang
 * [MOLY00151044] [MT6755][E1EVB][EL1S][LTE-SCH_MBMS_MCCH_02] why UE only gets 2 ul grant
 * . [l1edps] update mbms-02 to nonCCS
 *
...
#undef MCCH_MSG_MBSFN_AREA_CONFIGURATION_CSA_MBSFN_SUBFRAME_CONFIG_LIST_BTS1
...
#define MCCH_MSG_MBSFN_AREA_CONFIGURATION_CSA_MBSFN_SUBFRAME_CONFIG_LIST_BTS1 L1S_SETUP
