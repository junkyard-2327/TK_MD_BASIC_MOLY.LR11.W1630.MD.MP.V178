 ...
 * $Log$
 *
 * 11 30 2016 liang.yan
 * [MOLY00215867] [Change Feature][ROSA]busmon build error fix
 *
 * 02 16 2016 i-chun.liu
 * [MOLY00164979] MT6757 Call for check-in
 * MT6757 call for check-in: Busmon.
 *
 * 02 16 2016 i-chun.liu
 * [MOLY00164979] MT6757 Call for check-in
 * MT6757 call for check-in: busmon.
 *
 * 08 04 2015 i-chun.liu
 * [MOLY00135138] MT6797 bring up call for check in
 * MT6797 Pcore busmon call for check in .
 *
 ...
 */
/* MD_AXImon_1 */
#define BUSMON_BASE_ADDR_CR4              BASE_MADDR_PSMCU_BUSMON

/* MDINFRA_AXImon */
#define BUSMON_BASE_ADDR_L2DMA2MD	  BASE_MADDR_MDINFRABUSMON 
#define BUSMON_BASE_ADDR_PSPERI2MD        BASE_MADDR_MDINFRABUSMON
#define BUSMON_BASE_ADDR_ARM7             BASE_MADDR_MDINFRABUSMON
#define BUSMON_BASE_ADDR_L1SYS2MD         BASE_MADDR_MDINFRABUSMON
#define BUSMON_BASE_ADDR_HSPAL22MD        BASE_MADDR_MDINFRABUSMON
#define BUSMON_BASE_ADDR_MDGDMA           BASE_MADDR_MDINFRABUSMON


/*
 * Busmon interrupt ID
 */
#define BUSMON_IRQID                      PS_IRQID_BUSMON

/*
 * Busmon interrupt mask
 */
/* MD_AXImon_1 */
#define BUSMON_INTMASK_CR4                (1 << BUSMON_INT_PSMCU_AXI_SHIFT)

/* MDINFRA_AXImon */
#define BUSMON_INTMASK_L2DMA2MD           (1 << BUSMON_INT_MDINFRA_AXI_SHIFT)
#define BUSMON_INTMASK_PSPERI2MD          (1 << BUSMON_INT_MDINFRA_AXI_SHIFT)
#define BUSMON_INTMASK_ARM7               (1 << BUSMON_INT_MDINFRA_AXI_SHIFT)
#define BUSMON_INTMASK_L1SYS2MD           (1 << BUSMON_INT_MDINFRA_AXI_SHIFT)
#define BUSMON_INTMASK_HSPAL22MD          (1 << BUSMON_INT_MDINFRA_AXI_SHIFT)
#define BUSMON_INTMASK_MDGDMA             (1 << BUSMON_INT_MDINFRA_AXI_SHIFT)
...
typedef enum {
   ...
   /* MDINFRA_AXImon */
   BUSMON_BUSID_L2DMA2MD=0,
   BUSMON_BUSID_PSPERI2MD=1,
   BUSMON_BUSID_ARM7=2,
   BUSMON_BUSID_L1SYS2MD=3,
   BUSMON_BUSID_HSPAL22MD=4,
   BUSMON_BUSID_MDGDMA=5,
} busmon_busid_t;
...
typedef enum {
   ...
   /* MDINFRA_AXImon */
   BUSMON_BUSTYPE_L2DMA2MD=BUSMON_BUSTYPE_AXI,
   BUSMON_BUSTYPE_PSPERI2MD=BUSMON_BUSTYPE_AXI,
   BUSMON_BUSTYPE_ARM7=BUSMON_BUSTYPE_AXI,
   BUSMON_BUSTYPE_L1SYS2MD=BUSMON_BUSTYPE_AXI,
   BUSMON_BUSTYPE_HSPAL22MD=BUSMON_BUSTYPE_AXI,
   BUSMON_BUSTYPE_MDGDMA=BUSMON_BUSTYPE_AXI,
...
typedef enum {
   ...
   BUSMON_TGSEL_READ_L2DMA2MD=0,
   BUSMON_TGSEL_WRITE_L2DMA2MD=0,

   BUSMON_TGSEL_READ_PSPERI2MD=0,
   BUSMON_TGSEL_WRITE_PSPERI2MD=0,

   BUSMON_TGSEL_READ_ARM7=0,
   BUSMON_TGSEL_WRITE_ARM7=0,

   BUSMON_TGSEL_READ_L1SYS2MD=0,
   BUSMON_TGSEL_WRITE_L1SYS2MD=0,

   BUSMON_TGSEL_READ_HSPAL22MD=0,
   BUSMON_TGSEL_WRITE_HSPAL22MD=0,
...
/* Pcore MDINFRA target id */
typedef enum {

   BUSMON_TGID_L2DMA2MD_READ0=0,
   BUSMON_TGID_L2DMA2MD_WRITE0=0,
   BUSMON_TGID_L2DMA2MD_READ1=1,
   BUSMON_TGID_L2DMA2MD_WRITE1=1,
   
   BUSMON_TGID_PSPERI2MD_READ=0,
   BUSMON_TGID_PSPERI2MD_WRITE=0,
   
   BUSMON_TGID_ARM7_READ=0,
   BUSMON_TGID_ARM7_WRITE=0,

  
   BUSMON_TGID_L1SYS2MD_RAKEMD2G_READ=	192,//0b11000000,
   BUSMON_TGID_L1SYS2MD_RAKEMD2G_WRITE=	192, //0b11000000,

   BUSMON_TGID_L1SYS2MD_DFEB4_READ=		64, //0b01000000,
   BUSMON_TGID_L1SYS2MD_DFEB4_WRITE=	64, //0b01000000,
   BUSMON_TGID_L1SYS2MD_DFEDBG_READ=	65, //0b01000001,
   BUSMON_TGID_L1SYS2MD_DFEDBG_WRITE=	65, //0b01000001,
   BUSMON_TGID_L1SYS2MD_DFEDBG1_READ=	66, //0b01000010,
   BUSMON_TGID_L1SYS2MD_DFEDBG1_WRITE=	66, //0b01000010,
   BUSMON_TGID_L1SYS2MD_DFESHM_READ=	67, //0b01000011,
   BUSMON_TGID_L1SYS2MD_DFESHM_WRITE= 	67, //0b01000011,

   BUSMON_TGID_L1SYS2MD_RXBRPHRQ_WRITE0= 	128, //0b10000000,
   BUSMON_TGID_L1SYS2MD_RXBRPHRQ_WRITE1= 	132, //0b10000100,
   BUSMON_TGID_L1SYS2MD_RXBRPHRQ_READ0= 	129, //0b10000001,
   BUSMON_TGID_L1SYS2MD_RXBRPHRQ_READ1= 	133, //0b10000101,
   BUSMON_TGID_L1SYS2MD_RXBRPHRQ_DBG= 		130, //0b10000010,
   BUSMON_TGID_L1SYS2MD_RXBRPHRQ_OTH=		134, //0b10000110,
   
   BUSMON_TGID_L1SYS2MD_CR4_READ_INSTR=			8, //0b00001000,
   BUSMON_TGID_L1SYS2MD_CR4_NONCACHE_READ_DATA=	0, //0b00000000,
   BUSMON_TGID_L1SYS2MD_CR4_CACHE_READ_DATA0= 	24, //0b00011000,
   BUSMON_TGID_L1SYS2MD_CR4_CACHE_READ_DATA1= 	32, //0b00100000,
   BUSMON_TGID_L1SYS2MD_CR4_CACHE_READ_DATA2=	40, //0b00101000,
   BUSMON_TGID_L1SYS2MD_CR4_CACHE_READ_DATA3=	48, //0b00110000,
   BUSMON_TGID_L1SYS2MD_CR4_CACHE_READ_DATA4=	56, //0b00111000,
   BUSMON_TGID_L1SYS2MD_CR4_NONCACHE_WRITE_DATA=0 , //0b00000000,
   BUSMON_TGID_L1SYS2MD_CR4_CACHE_WRITE_DATA= 	8, //0b00001000,
   
   BUSMON_TGID_L1SYS2MD_MDL1GDMA_READ0=		1, //0b00000001,
   BUSMON_TGID_L1SYS2MD_MDL1GDMA_WRITE0=	1, //0b00000001,
   BUSMON_TGID_L1SYS2MD_MDL1GDMA_READ1= 	5, //0b00000101,
   BUSMON_TGID_L1SYS2MD_MDL1GDMA_WRITE1=	5, //0b00000101,

   BUSMON_TGID_L1SYS2MD_ABM_READ= 	2, //0b00000010,
   BUSMON_TGID_L1SYS2MD_ABM_WRITE=	2, //0b00000010,


   BUSMON_TGID_HSPAL22MD_READ0=		0, //0b00000000,
   BUSMON_TGID_HSPAL22MD_WRITE0=	0, //0b00000000,
   BUSMON_TGID_HSPAL22MD_READ1=		1, //0b00000001,
   BUSMON_TGID_HSPAL22MD_WRITE1=	1, //0b00000001,
   
   BUSMON_TGID_MDGDMA_READ=			0, //0b00000000,
   BUSMON_TGID_MDGDMA_WRITE=		0, //0b00000000,

   
} busmon_pcore_mdinfra_tg_id_t;
...
#define AXIMON_LATCH(_busmon_id) \
{ \
   DRV_WriteReg32_NPW(BUSMON_BASE_ADDR_##_busmon_id + AXIMON_CTL, 0x10); \
}
...
#define BUSMON_SET_TRG_CALLBCK(_busmon_id, _callback) { \
   ...
   DRV_WriteReg32((BUSMON_BASE_ADDR_##_busmon_id + AXIMON_INT), 0); \
