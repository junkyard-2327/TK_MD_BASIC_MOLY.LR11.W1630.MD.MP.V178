 ...
 * $Log$
 *
 * 06 24 2014 alvin.chen
 * [MOLY00061859] [TK6291] Fix 6291 FPGA DEV branch build error
 * <saved by Perforce>
 *
 * 12 06 2013 alvin.chen
 * [MOLY00046578] [ROME] Driver porting for MDTOPSM/MDOST/MALMO
 * Patch back MT6595 modification
 *
 * 11 28 2013 alvin.chen
 * [MOLY00047096] [MT6290][DNT] Update driver for E2
 * [MOLY] DNT driver update for 6290 E2
 *
 * 10 01 2013 alvin.chen
 * [MOLY00039514] [MT6290][Capture Card] related code check in
 * Update DNT driver for HK field trial
 *
 * 08 28 2013 alvin.chen
 * [MOLY00035670] [MT6290] DNT Driver Update for new capture card
 * [MOLY] Coresight Driver Update for ADC Capture
 *
 * 06 07 2013 alvin.chen
 * [MOLY00025125] DNT Driver Update
 * [MOLY] DNT Driver Update
 *
 * 06 06 2013 chi-yen.yu
 * [MOLY00013412] [MT6290 Bring-up] MT6290(m) Layer 2 verification
 ...
 *
 * 05 31 2013 alvin.chen
 * [MOLY00013400] [MT6290 Bring-up] DNT Modification for 6290E1
 * [MOLY] DNT Modification
 *
 * 05 14 2013 alvin.chen
 * [MOLY00013400] [MT6290 Bring-up] DNT Modification for 6290E1
 * [MOLY] DNT Modification for 6290E1, sync back to MOLY TRUNK from FIRSTCALL BRANCH
 *
 * 04 03 2013 alvin.chen
 * [MOLY00013400] [MT6290 Bring-up] DNT Modification for 6290E1
 * [MOLY Trunk] DNT Modification for ASIC
 *
 * 11 20 2012 alvin.chen
 * [MOLY00006416] Update Driver for MT7208 FPGA 20121105_MD_a4_b12_cx
...
//  ATID settings
//*********************************************************************************
#if defined(MT6290) || defined(MT6595) || defined(MT6276) || defined(BB_MT6276) || defined(MT6573) || defined(BB_MT6573) || defined(TK6280) || defined(BB_TK6280) || defined(MT6280) || defined(BB_MT6280)
...
#else //#if defined(MT6290) || defined(MT6595) || defined(MT6276) || defined(BB_MT6276) || defined(MT6573) || defined(BB_MT6573) || defined(TK6280) || defined(BB_TK6280) || defined(MT6280) || defined(BB_MT6280)
  //#error "Please define proper ATID for this platforms"
#endif  //#if defined(MT6290) || defined(MT6595) || defined(MT6276) || defined(BB_MT6276) || defined(MT6573) || defined(BB_MT6573) || defined(TK6280) || defined(BB_TK6280) || defined(MT6280) || defined(BB_MT6280)
