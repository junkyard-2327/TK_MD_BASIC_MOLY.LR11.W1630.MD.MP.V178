 ...
 *
 * 09 25 2017 kun.niu
 * [MOLY00280096] [Everest][O0][SRLTE][om_c2k6m][LTE IOT][FT][SH][CAT]External (EE) Exception Type: modem  Current Executing Process:  md1:(MCU_PCORE) [ASSERT] file:pcore/driver/sleep_drv/internal/src/ostd.c line:2559
 * When MD need get into flight mode, if DHL has pending GPDs CLDMA will ignore.
 *
 * 09 25 2017 kun.niu
 * [MOLY00280096] [Everest][O0][SRLTE][om_c2k6m][LTE IOT][FT][SH][CAT]External (EE) Exception Type: modem  Current Executing Process:  md1:(MCU_PCORE) [ASSERT] file:pcore/driver/sleep_drv/internal/src/ostd.c line:2559
 * When MD need get into flight mode, if DHL has pending GPDs CLDMA will ignore.
 *
 * 05 08 2017 kun.niu
 * [MOLY00247772] [MT6750S][ROSA][MP5][PHONE][Overnight][HQ][MTBF][Lab][Ericsson][Gemini]Externel (EE),0,0,99,/data/core/,1,modem,md1:[Others] MD long time no response
 * When enter into flight mode, CLDMA bak list has GPDs not send.
 *
 * 05 08 2017 kun.niu
 * [MOLY00247772] [MT6750S][ROSA][MP5][PHONE][Overnight][HQ][MTBF][Lab][Ericsson][Gemini]Externel (EE),0,0,99,/data/core/,1,modem,md1:[Others] MD long time no response
 * When enter into flight mode, CLDMA bak list has GPDs not send.
