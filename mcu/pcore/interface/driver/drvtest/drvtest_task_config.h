...
#define TASK_PRIORITY_DRVTEST_MDL_EBC      (KAL_PRIORITY_CLASS5 + 5)
...
MODULE_ID_MULTI_CORE_FOR_PRINT_TRACE(MOD_DRVTEST)
//Do not add setting before this line !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

/*************************Task CFG Begin****************/
#ifdef ATEST_DRV_BWL
task_index(INDX_DT_BWL) 
task_multi_core_module_map(INDX_DT_BWL, MOD_DT_BWL)
task_name("DTBWL")
...
task_multi_core_module_map(INDX_DT_GPT, MOD_DT_GPT)
task_name("DTGPT")
...
task_multi_core_module_map(INDX_DT_GPT2, MOD_DT_GPT_TWO)
task_name("DTGPT2")
...
task_multi_core_module_map(INDX_MSDC, MOD_MSDC)
task_name("MSDC")
...
task_multi_core_module_map(INDX_DT_USIM, MOD_DT_USIM)
task_name("DTUSIM")
...
task_multi_core_module_map(INDX_DT_USIM2, MOD_DT_USIM2)
task_name("DTUSIM2")
...
task_multi_core_module_map(INDX_LMAC_AT, MOD_LMAC_AT)
...
task_multi_core_module_map(INDX_DT_SPIC_1, MOD_DT_SPIC_ONE)
task_name("DTSPIC_1")
...
task_multi_core_module_map(INDX_DT_SPIC_2, MOD_DT_SPIC_TWO)
task_name("DTSPIC_2")
...
task_multi_core_module_map(INDX_DT_NFI_PRIMARY, MOD_DT_NFI_PRIMARY)
...
task_multi_core_module_map(INDX_DT_NFI_MINOR, MOD_DT_NFI_MINOR)
...
/*module_type and mod_task_g*/
task_multi_core_module_map(INDX_L2_COPRO_AT, MOD_L2_COPRO_AT)
...
/*module_type and mod_task_g*/
task_multi_core_module_map(INDX_SSTESTA, MOD_SSTESTA_A)
task_multi_core_module_map(INDX_SSTESTA, MOD_SSTESTA_B)
task_multi_core_module_map(INDX_SSTESTA, MOD_SSTESTA_C)
...
task_multi_core_module_map(INDX_SS_T2, MOD_SSTESTB)
task_name("SST2")
...
task_multi_core_module_map(INDX_DT_GDMA, MOD_DT_GDMA)
task_name("DTGDMA")
...
task_multi_core_module_map(INDX_DT_PCMON, MOD_DT_PCMON)
task_name("DTPCMON")
task_queue_name("DTPCMON Q")
task_priority(TASK_PRIORITY_DRVTEST_PCMON, KAL_TASK_INITIAL_PRIORITY)
task_stack_size(4096)
task_create_function(drvtest_pcmon_task_create)
task_stack_internalRAM(KAL_FALSE)
task_external_queue_size(10)
task_internal_queue_size(0)
task_boot_mode(NORMAL_M)
...
task_multi_core_module_map(INDX_DT_EMI, MOD_DT_EMI)
task_name("DTEMI")
...
task_multi_core_module_map(INDX_DT_RSTCTL, MOD_DT_RSTCTL)
task_name("DTRSTCTL")
...
task_multi_core_module_map(INDX_DT_CPU, MOD_DT_CPU)
task_name("DTCPU")
...
/*module_type and mod_task_g*/
task_multi_core_module_map(INDX_ATHIF_TASK0, MOD_ATHIFT0)
...
/*module_type and mod_task_g*/
task_multi_core_module_map(INDX_ATHIF_TASK1, MOD_ATHIFT1)
...
task_multi_core_module_map(INDX_DT_GPIO, MOD_DT_GPIO)
task_name("DTGPIO")
...
task_multi_core_module_map(INDX_DT_EINT, MOD_DT_EINT)
task_name("DTEINT")
...
task_multi_core_module_map(INDX_DT_CORESIGHT, MOD_DT_CORESIGHT)
...
/*module_type and mod_task_g*/
task_multi_core_module_map(INDX_MAC_PHY_COSIM, MOD_MAC_PHY_COSIM)
...
/*module_type and mod_task_g*/
task_multi_core_module_map(INDX_l2_HW_LOGGING_AT, MOD_L2_HW_LOGGING_AT)
...
task_multi_core_module_map(INDX_DT_DEM, MOD_DT_DEM)
task_name("DTDEM")
...
task_multi_core_module_map(INDX_DT_PFC, MOD_DT_PFC)
task_name("DTPFC")
...
task_multi_core_module_map(INDX_DT_UART, MOD_DT_UART)
task_name("DTUART")
...
task_multi_core_module_map(INDX_DT_IDC, MOD_DT_IDC)
task_name("DTIDC")
...
task_multi_core_module_map(INDX_DT_BUSMON, MOD_DT_BUSMON)
task_name("BUSMON")
...
task_multi_core_module_map(INDX_DT_DORMANT, MOD_DT_DORMANT)
task_name("DORMANT")
...
task_multi_core_module_map(INDX_ST_HIF_CTL, MOD_ST_HIF_CTL)
...
task_multi_core_module_map(INDX_ST_HIF_DATA, MOD_ST_HIF_DATA)
...
task_multi_core_module_map(INDX_ST_MAIN, MOD_ST_MAIN)
task_name("ST_MAIN")
...
task_multi_core_module_map(INDX_ST_ZERO, MOD_ST_ZERO)
task_name("ST_ZERO")
...
task_multi_core_module_map(INDX_ST_ONE, MOD_ST_ONE)
task_name("ST_ONE")
...
task_multi_core_module_map(INDX_ST_TWO, MOD_ST_TWO)
task_name("ST_TWO")
...
task_multi_core_module_map(INDX_ST_THREE, MOD_ST_THREE)
task_name("ST_THREE")
...
task_multi_core_module_map(INDX_ST_FOUR, MOD_ST_FOUR)
task_name("ST_FOUR")
...
task_multi_core_module_map(INDX_ST_FIVE, MOD_ST_FIVE)
task_name("ST_FIVE")
...
task_multi_core_module_map(INDX_ST_SIX, MOD_ST_SIX)
task_name("ST_SIX")
...
task_multi_core_module_map(INDX_ST_SEVEN, MOD_ST_SEVEN)
task_name("ST_SEVEN")
...
task_multi_core_module_map(INDX_ST_EIGHT, MOD_ST_EIGHT)
task_name("ST_EIGHT")
...
task_multi_core_module_map(INDX_SLT_00, MOD_ST_00)
task_name("SLT_00")
...
task_multi_core_module_map(INDX_DT_DSPFM, MOD_DT_DSPFM)
task_name("DTDSPFM")
...
task_multi_core_module_map(INDX_DT_BSI, MOD_DT_BSI)
task_name("DTBSI")
...
/*************************Task CFG Begin****************/
#ifdef ATEST_DRV_MDL_EBC
task_index(INDX_DT_MDL_EBC)
task_multi_core_module_map(INDX_DT_MDL_EBC, MOD_DT_MDL_EBC)
task_name("DT_MDL_EBC")
task_queue_name("DT_MDL_EBC_Q")
task_priority(TASK_PRIORITY_DRVTEST_MDL_EBC, KAL_TASK_INITIAL_PRIORITY)
task_stack_size(4096)
task_create_function(drvtest_mdl_ebc_task_create)
task_stack_internalRAM(KAL_FALSE)
task_external_queue_size(10)
task_internal_queue_size(0)
task_boot_mode(NORMAL_M)
...
task_multi_core_module_map(INDX_DT_STP, MOD_DT_STP)
task_name("DT_STP")
...
task_multi_core_module_map(INDX_DT_MTAD, MOD_DT_MTAD)
task_name("DT_MTAD")
...
task_multi_core_module_map(INDX_DT_LP, MOD_DT_LP)
task_name("DT_LP")
...
task_multi_core_module_map(INDX_DT_SCC, MOD_DT_SCC)
task_name("DT_SCC")
