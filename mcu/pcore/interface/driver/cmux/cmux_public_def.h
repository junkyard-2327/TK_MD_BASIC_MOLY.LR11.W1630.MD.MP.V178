...
#define CMUX_URC_2_CHANNEL      0x40    // indication channel (unsolicited code), for customer special usuage
#define CMUX_URC_3_CHANNEL      0x60    // indication channel (unsolicited code), for customer special usuage
