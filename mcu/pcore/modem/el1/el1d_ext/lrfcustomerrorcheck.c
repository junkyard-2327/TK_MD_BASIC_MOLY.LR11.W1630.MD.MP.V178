...
/***********************************//**
 * @brief     Error check for CA Cfg not in SA released list
 * @param[in] void
 * @return    void
***************************************/
void EL1D_RF_PCore_Error_Check_CA_Cfg_Is_Not_Support(kal_uint32 ca_cfg_ind)
{
   EXT_ASSERT(0, ca_cfg_ind, 0, 0);
}
