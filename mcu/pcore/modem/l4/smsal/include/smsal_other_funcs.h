...
void smsal_send_sms_from_storage_cnf(kal_uint8 result, kal_uint8 src_id, kal_uint8 msg_ref, smsal_domain_enum domain, sms_addr_struct *sc_addr_ptr, peer_buff_struct *peer_buff_ptr);
