...
extern void smsal_ims_update_msgbox_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void smsal_me_reconfigure_req_handler(ilm_struct* ilm_ptr);

extern kal_uint32 smsal_get_hplmn_id();
extern void smsal_reg_state_ind_hdlr(local_para_struct *local_para_ptr);
