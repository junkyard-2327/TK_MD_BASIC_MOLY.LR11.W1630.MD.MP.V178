...
#if defined(__GEMINI__) &&  defined(__CB_CONFLICT_IN_AS_FOR_GEMINI__) 
void smsal_cb_update_lower_layers();
extern void smsal_update_cb_fsm();
kal_bool smsal_is_cb_fsm_state_transition_required(smsal_cb_fsm_state_enum curr_fsm_state, smsal_cb_fsm_state_enum *new_fsm_state);

#endif/*            #if defined(__GEMINI__) &&  defined(__CB_CONFLICT_IN_AS_FOR_GEMINI__) */
