...
extern void rmmi_send_ilm_to_dhl(kal_uint16 msg_id, void *local_param_ptr, void *peer_buf_ptr);
...
extern void rmmi_scp_write_to_uart(kal_uint8 *buffer, kal_uint16 length);
#endif
