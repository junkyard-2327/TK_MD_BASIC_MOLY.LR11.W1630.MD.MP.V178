...
TRC_MSG(RAC_DEFAULT_USER_RAT_MODE, "[RAC] default user RAT mode = %Mrat_enum")
#endif
...
TRC_MSG(RAC_TRC_OP12_REG_LOCK_PROTECT, "[RAC] op12 reg lock protect effective, should ignore all reg req ")
...
TRC_MSG(RAC_TRC_INVALID_ATTACH_REQ_DOMAIN,"[RAC] Invalid attach request domain")
