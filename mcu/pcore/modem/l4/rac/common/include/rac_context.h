...
//   kal_uint8                           ber;
   ...
   kal_bool                            is_supporting_roaming;
    ...
    rat_enum                            user_rat_mode;
#endif
#ifdef __REMOTE_SIM__
    kal_bool                            is_rsim_enable;
#endif
	/*[ALPS04139224] This flag is to record whether the nw feature is reset by RAC due to oos or not*/
	kal_bool                            is_clean_nw_feature_before;
	/*[ALPS04139224] This ponter is to record the nw feature which is updated by xMM*/
    l4crac_nw_feature_ind_struct        *nw_feature_ind_ptr;
} rac_context_struct;
