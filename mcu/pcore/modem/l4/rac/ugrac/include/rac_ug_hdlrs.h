...
void rac_ug_rsim_auth_abort_cnf_msg_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
domain_id_enum rac_ug_get_service_domain(mm_user_search_type_enum search_type);
#ifdef __GEMINI_WCDMA_WORLD_PHONE__
void rac_ug_send_detach_req(kal_bool is_poweroff, l4c_rac_detach_cause_enum detach_cause);
#else
