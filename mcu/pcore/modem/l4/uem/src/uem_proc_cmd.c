...
void l4cuem_em_rf_test_gsm_req(kal_uint8 src_id, kal_uint8 request_type, rf_test_gsm_param_struct request)
{
    ...
    switch(request_type)
    {
        case RF_TEST_GSM_STOP:
        {
            ...
            kal_sleep_task( 13 );        //Requested by L1 to avoid Race condition
        ...
        case RF_TEST_GSM_TX_TEST:
        {
            ...
            if( g_uem_cntx_p->is_rf_test_running == UEM_RF_TEST_RUNNING)
            {
                local_data_ptr = NULL;
                uem_send_msg_to_l1(MSG_ID_L4CL1_EM_RF_TEST_GSM_STOP_REQ, local_data_ptr);
                kal_sleep_task( 13 );        //Requested by L1 to avoid Race condition
            ...
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->pcl[0] = req->pcl[0];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->pcl[1] = req->pcl[1];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->pcl[2] = req->pcl[2];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->pcl[3] = req->pcl[3];

            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->afc = req->afc;
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->pattern = req->pattern;
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->timeSlotmask = req->timeSlotmask;
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->cs[0] = req->cs[0];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->cs[1] = req->cs[1];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->cs[2] = req->cs[2];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->cs[3] = req->cs[3];
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->isEgprs = req->isEgprs;

            uem_send_msg_to_l1(MSG_ID_L4CL1_EM_RF_TEST_GSM_TX_TEST_REQ, local_data_ptr);  

            g_uem_cntx_p->is_rf_test_running = UEM_RF_TEST_RUNNING;
