...
extern void l4c_audio_l4c_erttstr_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void sim_auth_finish_res_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
#endif
