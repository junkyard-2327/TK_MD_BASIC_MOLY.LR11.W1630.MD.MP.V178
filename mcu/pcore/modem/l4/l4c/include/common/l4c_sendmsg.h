...
extern void l4c_send_msg_to_esm(msg_type msg_name, void *param_ptr);
#endif
...
extern void l4c_send_csg_auto_search_req(module_type dest, kal_bool is_enable);
extern void l4c_send_plmn_list_preference_req(module_type dest, plmn_list_preference_enum preference);
extern void l4c_send_msg_to_ltecsr(msg_type msg_name, void *param_ptr);
