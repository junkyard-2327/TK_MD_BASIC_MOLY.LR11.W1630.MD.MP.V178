...
extern kal_bool l4c_gprs_activation_tried_on_pdp_type(l4c_gprs_ipv4v6_act_struct* act_ptr, pdp_addr_type_enum pdp_type);
...
extern void l4c_ps_check_pdn_specific_cause_hdlr(kal_uint8 cid, ps_cause_enum cause);
