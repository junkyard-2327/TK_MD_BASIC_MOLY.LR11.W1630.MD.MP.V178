...
typedef struct rat_tcm_deact_triggered_flag_struct {
    ...
    kal_bool is_deact_by_inactivity_timer;
...
typedef struct rat_tcm_context_struct {
    ...
    /** Usage: Event scheduler for RAT_TCM Timer*/
	event_scheduler           *rat_tcm_event_scheduler_ptr;
    /** Usage: RAT_TCM IRAT Timer queue event */
    rat_tcm_event_info_struct  queuedtimer_event[RAT_TCM_TOT_CONTEXT];
