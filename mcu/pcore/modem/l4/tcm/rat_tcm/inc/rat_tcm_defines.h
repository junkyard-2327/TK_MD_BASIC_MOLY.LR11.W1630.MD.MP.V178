...
#define VALUE_OF_RAT_TCM_IRAT_QUEUE_TIMER_CONTEXT(context_num, X)  ((rat_tcm_ptr_g)->queuedtimer_event[context_num].X)
#define RAT_TCM_IRAT_QUEUE_TIMER_CONTEXT(context_num)  ((rat_tcm_ptr_g)->queuedtimer_event[context_num])
