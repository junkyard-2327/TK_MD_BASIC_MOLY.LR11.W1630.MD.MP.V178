...
extern void rat_tcm_send_pdp_deactivate_cnf_with_error(kal_uint8 context_num, ps_cause_enum cause);
extern void rat_tcm_send_pdp_activate_rej(kal_uint8 context_num, ps_cause_enum cause);
extern void rat_tcm_send_pdp_modify_rej(kal_uint8 context_num, ps_cause_enum cause);
extern kal_bool rat_tcm_time_is_api_available(void);
extern kal_uint32 rat_tcm_time_get_current_time(void);
extern kal_uint32 rat_tcm_determine_processing_time_limit_in_secs(kal_uint8 context_num);
extern void rat_tcm_update_processing_time_limit_in_timestamp(kal_uint8 context_num, kal_uint32 processing_time_limit_in_secs);
extern kal_uint32 rat_tcm_get_remaining_processing_time_limit_in_secs(kal_uint8 context_num);
extern kal_uint32 rat_tcm_calculate_processing_time_limit_in_secs (kal_uint8 context_num);
...
extern local_para_struct * rat_tcm_compose_tcm_pdp_modify_rej(kal_uint8 context_num, ps_cause_enum cause);
