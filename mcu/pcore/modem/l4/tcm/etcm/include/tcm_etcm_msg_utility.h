...
/* for lte-a project change MSG_ID_EVAL_EMM_SET_RAT_MODE_CNF to MSG_ID_TCM_ETCM_MSG_END */
#define ETCM_XTRAK_BEARER_RSC_ALLOC_IND (MSG_ID_TCM_ETCM_MSG_END + 1)
#define ETCM_XTRAK_BEARER_RSC_MOD_IND   (MSG_ID_TCM_ETCM_MSG_END + 2)
#define ETCM_XTRAK_EPSB_DEACT_PREEMPT   (MSG_ID_TCM_ETCM_MSG_END + 3)
...
l4ctcm_ecc_rej_by_nw_in_attach_ind_struct       *etcm_cidGenEccRejByNwInAttachInd       (etcm_cid_struct cid, ps_cause_enum cause);
sat_msisdn_info_ind_struct          *etcm_cidGenSatMsisdnInd        (etcm_cid_struct cid);
