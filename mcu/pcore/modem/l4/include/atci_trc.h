...
BEGIN_TRACE_MAP(MOD_ATCI)
   ...
   TRC_MSG(FUNC_RMMI_ECAINFO_HDLR_ENTRY, "rmmi_ecainfo_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_EIMSEVENT_HDLR_ENTRY, "rmmi_eimsevent_hdlr()")
   ...
   TRC_MSG(RMMI_PLMN_INFO_FOR_TVOLTEHYS, "saved_plmn_for_volte_hys.rat=%Mrat_enum, plmn_id=%d%d%d%d%d%d; cur_plmn.rat=%Mrat_enum, plmn_id=%d%d%d%d%d%d")
   ...
   TRC_MSG(WARNING_EPOF_WAIT_AKA_AUTH_ABORT_PWROFF, "Warning: wait AKA AUTH Abort, pending EPOF! auth_aka_state = %d")
