...
#define TCM_DEFAULT_PROCESSING_TIME_LIMIT	1200                    /* Default processing time limit for PDP/PDN command is 20 mins */
#define TCM_MIN_NEEDED_PROCESSING_TIME_LIMIT_FOR_IRAT	480     /* When IRAT is ongoing, minimum processing time needed for processing PDP/PDN command is 8 mins */
#define TCM_MIN_NEEDED_RESERVED_PROCESSING_TIME_LIMIT	720     /* Minimum reserved processing time needed for processing PDP/PDN command is 12 mins */
