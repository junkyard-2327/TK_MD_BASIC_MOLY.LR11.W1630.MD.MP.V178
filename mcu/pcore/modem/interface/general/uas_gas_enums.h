 ...
 * $Log:$
 *
 * 08 30 2017 richa.gupta
 * [MOLY00273568] [GIONEE][P25 internal phone][FT??] 127872?demo?????1???3G/2G(AUTO)??2??3G,??????????????????1??????3G 1/10
 * Prefer high prio 3G cell in 23G mode for reselection.
 *
...
#define UCELL_HIGH_PRIO_RSCP_REWARD (10) /* 10 dBm */
