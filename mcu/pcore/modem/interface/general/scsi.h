 ...
 * $Log$
 *
 * 12 19 2017 vend_mtb_aritha001
 * [MOLY00296423] [CODE SYNC] [OPPO_FT][1151630] DUT fail to show own ( Vodafone 3G) RAT during MPLMN search for Vodafone operator.
 *
 * 12 18 2017 vend_mtb_aritha001
 * [MOLY00296423] [CODE SYNC] [OPPO_FT][1151630] DUT fail to show own ( Vodafone 3G) RAT during MPLMN search for Vodafone operator.
 * 	
 * 	MOLY00296423: [CODE SYNC] [OPPO_FT][1151630] DUT fail to show own ( Vodafone 3G) RAT during MPLMN search for Vodafone operator.
 *
...
extern kal_bool Scsi_isUarfcnSharedInCurrentMcc(plmn_id_struct const* const plmn_found ,kal_uint16  uarfn_to_be_checked );
