...
/* ratdm_autogen_sim_idx(), L+W DSDS shall always use SHAQ on PS active SIM */
/* ratdm_autogen_sim_idx(), CS will use autogen, TDD 3G only on SIM 1, FDD can calculate via active module id */
#define SHAQ_psFillCidNsapiMapping(...) RATDM_EXPAND(_SHAQ_psFillCidNsapiMapping(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_psFillCidNsapiMapping(CID, nsapi, sim_interface, ...) SHAQ_psFillCidNsapiMapping(CID, nsapi, sim_interface)

#define SHAQ_psEraseCidNsapiMapping(...) RATDM_EXPAND(_SHAQ_psEraseCidNsapiMapping(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_psEraseCidNsapiMapping(nsapi, sim_interface, ...) SHAQ_psEraseCidNsapiMapping(nsapi, sim_interface)

#define SHAQ_psFillRBIdNsapiMapping(...) RATDM_EXPAND(_SHAQ_psFillRBIdNsapiMapping(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_psFillRBIdNsapiMapping(RBId, nsapi, sim_interface, ...) SHAQ_psFillRBIdNsapiMapping(RBId, nsapi, sim_interface)

#define SHAQ_psEraseRBIdNsapiMapping(...) RATDM_EXPAND(_SHAQ_psEraseRBIdNsapiMapping(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_psEraseRBIdNsapiMapping(RBId, sim_interface, ...) SHAQ_psEraseRBIdNsapiMapping(RBId, sim_interface)

#define SHAQ_change_turn_off_priority_queue_setting(...) RATDM_EXPAND(_SHAQ_change_turn_off_priority_queue_setting(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_change_turn_off_priority_queue_setting(new_setting, sim_interface, ...) SHAQ_change_turn_off_priority_queue_setting(new_setting, sim_interface)

#ifdef __UMTS_RAT__
#define SHAQ_mountFreeFunc(...) RATDM_EXPAND(_SHAQ_mountFreeFunc(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_mountFreeFunc(a_cid, apf_free, sim_interface, ...) SHAQ_mountFreeFunc(a_cid, apf_free, sim_interface)

#define SHAQ_queryFreeFunc(...) RATDM_EXPAND(_SHAQ_queryFreeFunc(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_queryFreeFunc(RbId, sim_interface, ...) SHAQ_queryFreeFunc(RbId, sim_interface)

#define SHAQ_rlcGetCidFromRbid(...) RATDM_EXPAND(_SHAQ_rlcGetCidFromRbid(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_rlcGetCidFromRbid(RbId, sim_interface, ...) SHAQ_rlcGetCidFromRbid(RbId, sim_interface)

#define SHAQ_rlcQueryNormalQueueLeftBits(...) RATDM_EXPAND(_SHAQ_rlcQueryNormalQueueLeftBits(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_rlcQueryNormalQueueLeftBits(RbId, sim_interface, ...) SHAQ_rlcQueryNormalQueueLeftBits(RbId, sim_interface)

#define SHAQ_rlcFindQFromCid(...) RATDM_EXPAND(_SHAQ_rlcFindQFromCid(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_rlcFindQFromCid(cid, sim_interface, ...) SHAQ_rlcFindQFromCid(cid, sim_interface)

#define SHAQ_dequeue_diff_priority_queue(...) RATDM_EXPAND(_SHAQ_dequeue_diff_priority_queue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_dequeue_diff_priority_queue(a_txRBId, queue_left_bits, priority, sim_interface, ...) SHAQ_dequeue_diff_priority_queue(a_txRBId, queue_left_bits, priority, sim_interface)

#define SHAQ_dequeue_normal_queue(...) RATDM_EXPAND(_SHAQ_dequeue_normal_queue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_dequeue_normal_queue(RB, LEFT_BITS, sim_interface, ...) SHAQ_dequeue_diff_priority_queue(RB, LEFT_BITS, SHAQ_NORMAL_QUEUE, sim_interface)

#define SHAQ_psPdcpEnqueue(...) RATDM_EXPAND(_SHAQ_psPdcpEnqueue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_psPdcpEnqueue(RbId, pPeer, taskid, sim_interface, ...) SHAQ_psPdcpEnqueue(RbId, pPeer, taskid, sim_interface)

#define SHAQ_csCsrEnqueue(...) RATDM_EXPAND(_SHAQ_csCsrEnqueue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_csCsrEnqueue(a_cid, ap_data, sim_interface, ...) SHAQ_csCsrEnqueue(a_cid, ap_data, sim_interface)

#define SHAQ_csRBestablished(...) RATDM_EXPAND(_SHAQ_csRBestablished(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_csRBestablished(CID, RBId, sim_interface, ...) SHAQ_csRBestablished(CID, RBId, sim_interface)

#define SHAQ_csRBreleased(...) RATDM_EXPAND(_SHAQ_csRBreleased(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_csRBreleased(RBId, sim_interface, ...) SHAQ_csRBreleased(RBId, sim_interface)

#define SHAQ_LBM_CreateRB(...) RATDM_EXPAND(_SHAQ_LBM_CreateRB(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_LBM_CreateRB(RBId, sim_interface, ...) SHAQ_LBM_CreateRB(RBId, sim_interface)

#define SHAQ_LBM_ReleaseRB(...) RATDM_EXPAND(_SHAQ_LBM_ReleaseRB(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_LBM_ReleaseRB(RBId, sim_interface, ...) SHAQ_LBM_ReleaseRB(RBId, sim_interface)

#define SHAQ_csKickUL2(...) RATDM_EXPAND(_SHAQ_csKickUL2(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_csKickUL2(source_module, sim_interface, ...) SHAQ_csKickUL2(source_module, sim_interface)

#define SHAQ_psKickUL2(...) RATDM_EXPAND(_SHAQ_psKickUL2(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_psKickUL2(source_module, RbId, sim_interface, ...) SHAQ_psKickUL2(source_module, RbId, sim_interface)

#ifdef __RATDM_SHAQ_HAS_PRIORITY_QUEUE__
#define SHAQ_rlcQueryPriorityQueueLeftBits(...) RATDM_EXPAND(_SHAQ_rlcQueryPriorityQueueLeftBits(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_rlcQueryPriorityQueueLeftBits(RbId, sim_interface, ...) SHAQ_rlcQueryPriorityQueueLeftBits(RbId, sim_interface)

#define SHAQ_dequeue_priority_queue(...) RATDM_EXPAND(_SHAQ_dequeue_priority_queue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_dequeue_priority_queue(RB, LEFT_BITS, sim_interface, ...) SHAQ_dequeue_diff_priority_queue(RB, LEFT_BITS, SHAQ_PRIORITY_QUEUE, sim_interface)
#endif // ~ #ifdef __RATDM_SHAQ_HAS_PRIORITY_QUEUE__

#ifdef UNIT_TEST
#define SHAQ_RLC_UT_dequeue_normal_queue(...) RATDM_EXPAND(_SHAQ_RLC_UT_dequeue_normal_queue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_RLC_UT_dequeue_normal_queue(RbId, queue_left_bits, sim_interface, ...) SHAQ_RLC_UT_dequeue_normal_queue(RbId, queue_left_bits, sim_interface)

#define SHAQ_csr_ut_check_queue_context(...) RATDM_EXPAND(_SHAQ_csr_ut_check_queue_context(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_csr_ut_check_queue_context(a_cid, ut_module, sim_interface, ...) SHAQ_csr_ut_check_queue_context(a_cid, ut_module, sim_interface)

#define SHAQ_pdcp_ut_check_queue_context_with_priority_info(...) RATDM_EXPAND(_SHAQ_pdcp_ut_check_queue_context_with_priority_info(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_pdcp_ut_check_queue_context_with_priority_info(RbId, ut_module, priority, sim_interface, ...) SHAQ_pdcp_ut_check_queue_context_with_priority_info(RbId, ut_module, priority, sim_interface)

#define SHAQ_pdcp_ut_check_queue_context(...) RATDM_EXPAND(_SHAQ_pdcp_ut_check_queue_context(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_pdcp_ut_check_queue_context(RBId, ut_module, sim_interface, ...) SHAQ_pdcp_ut_check_queue_context_with_priority_info(RBId, ut_module, SHAQ_NORMAL_QUEUE, sim_interface)

#ifdef __RATDM_SHAQ_HAS_PRIORITY_QUEUE__
#define SHAQ_RLC_UT_dequeue_priority_queue(...) RATDM_EXPAND(_SHAQ_RLC_UT_dequeue_priority_queue(__VA_ARGS__, ratdm_autogen_sim_idx(), NULL))
#define _SHAQ_RLC_UT_dequeue_priority_queue(RbId, queue_left_bits, sim_interface, ...) SHAQ_RLC_UT_dequeue_priority_queue(RbId, queue_left_bits, sim_interface)
#endif
#endif // ~ #ifdef UNIT_TEST
#endif // ~ #ifdef __UMTS_RAT__

#else // ~ #ifndef __MULTIPLE_PS__
