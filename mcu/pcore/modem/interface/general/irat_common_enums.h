 ...
 * $Log:$
 *
 * 03 30 2017 raphael.tsai
 * [MOLY00238764] [WW FT][MT6755][VzW][TK][Irvine][FT][VoLTE Performance][Week7][Day7]DUT MT VoLTE call performance(Delta VoLTE vs. CDMA) fails by -26.00% at Marginal Coverage Area during Cycle1.
 *
...
typedef enum
{
    ...
    IR_RESULT_FAILURE_MD1_NO_CS_PS_DOMAIN = 5, //Inter-RAT change is failed because no MD1 CS_PS_DOMAIN
} irat_result_enum;
