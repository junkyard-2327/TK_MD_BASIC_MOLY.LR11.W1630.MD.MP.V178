...
/*****************************************************************************/
#if defined(__SYNC_HDLC_CSD__) || defined(__CSD_NT__)
typedef void (*fp_ratcm_csr_activate_req)(CSD_MODE_ENUM, CSD_USER_RATE_ENUM);
typedef void (*fp_ratcm_csr_deactivate_req)(void);
typedef void (*fp_ratcm_csr_csd_put_uplinkdata)(kal_uint8*, kal_uint16, CSD_V24_STATUS_STRUCT);
typedef kal_uint16 (*fp_ratcm_csr_csd_get_downlinkdata)(kal_uint16, kal_uint8*, CSD_V24_STATUS_STRUCT*);

extern fp_ratcm_csr_activate_req pfn_ratcm_csr_activate_req;
extern fp_ratcm_csr_deactivate_req pfn_ratcm_csr_deactivate_req;
extern fp_ratcm_csr_csd_put_uplinkdata pfn_ratcm_csr_csd_put_uplinkdata;
extern fp_ratcm_csr_csd_get_downlinkdata pfn_ratcm_csr_csd_get_downlinkdata;

INLINE_MODIFIER INLINE
fp_ratcm_csr_activate_req csr_get_fp_ratcm_csr_activate_req(void)
{
    return pfn_ratcm_csr_activate_req;
}

INLINE_MODIFIER INLINE
fp_ratcm_csr_deactivate_req csr_get_fp_ratcm_csr_deactivate_req(void)
{
    return pfn_ratcm_csr_deactivate_req;
}

INLINE_MODIFIER INLINE
fp_ratcm_csr_csd_put_uplinkdata csr_get_fp_ratcm_csr_csd_put_uplinkdata(void)
{
    return pfn_ratcm_csr_csd_put_uplinkdata;
}

INLINE_MODIFIER INLINE
fp_ratcm_csr_csd_get_downlinkdata csr_get_fp_ratcm_csr_csd_get_downlinkdata(void)
{
    return pfn_ratcm_csr_csd_get_downlinkdata;
}
#endif
