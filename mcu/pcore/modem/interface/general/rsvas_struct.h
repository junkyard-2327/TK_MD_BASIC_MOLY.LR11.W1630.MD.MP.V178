 ...
 * $Log:$
 *
 * 03 14 2017 yuhhwang.yu
 * [MOLY00234136] [SRLTE Enhancement][LR11][MP5] development - interface
 * . rsvas interface
 *
 * 04 28 2016 yuhhwang.yu
 * [MOLY00175408] Multiple-PS/Remote-SIM interfaces phase2
 * . RSIM RSVAS msg structure
 *
 ...
 * .
 *
 * 12 11 2014 yuhhwang.yu
 * [MOLY00086990] [MT6291 Gemini] Check in to build load
 * . Fix gemini error
 *
 * 10 13 2014 yuhhwang.yu
 * [MOLY00080441] RSVA LAS interface
 * .
 *
...
}rac_rsvas_md_sim_config_req_struct;
...
typedef struct {
   LOCAL_PARA_HDR   
   rsvas_service_type_enum peer_service_type;
} rsvas_gas_virtual_suspend_status_ind_struct;
#endif /* __GSM_RAT__ */
...
typedef struct {
   LOCAL_PARA_HDR   
   rsvas_service_type_enum peer_service_type;
} rsvas_uas_virtual_suspend_status_ind_struct;
#endif /* __UMTS_RAT__ */
...
typedef struct {
   LOCAL_PARA_HDR   
   rsvas_service_type_enum peer_service_type;
} rsvas_eas_virtual_suspend_status_ind_struct;
#endif /* __LTE_RAT__ */
