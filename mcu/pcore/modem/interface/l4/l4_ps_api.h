...
extern void l4c_cross_core_update_ps_conf_info(kal_bool xta_mode, ps_conf_test_mode_enum mode, kal_uint32 profile);
#else
...
extern kal_bool l4c_is_hvolte_enable_for_roaming(void);
extern hvolte_mode_enum l4c_query_hvolte_mode(void);
