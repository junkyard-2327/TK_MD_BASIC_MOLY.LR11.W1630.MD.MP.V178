 ...
 *
 * 01 08 2016 head.hsu
 * [MOLY00154212] [ViLTE][TMO][US FT] When RSRP decrease and recover, the UL is broken and can not resume
 * 	[EPDCP] HFN desync avoidance enhancement
 *
...
#define ULSDU_INFO_HEAD_FLAG_HFN_SYNC_PDU 0x08
	kal_uint8  flag_bmp;
	kal_uint8  rsv1;
...
#define GET_DRB_ULSDU_HFN_SYNC_PDU(_p) \
           (GET_ULSDU_INFO_HEAD(_p)->flag_bmp & ULSDU_INFO_HEAD_FLAG_HFN_SYNC_PDU) 
...
#define SET_DRB_ULSDU_RETX(_p) \
           (GET_ULSDU_INFO_HEAD(_p)->flag_bmp |= ULSDU_INFO_HEAD_FLAG_RETX_WI_SN) 
#define SET_DRB_ULSDU_HFN_SYNC_PDU(_p) \
           (GET_ULSDU_INFO_HEAD(_p)->flag_bmp |= ULSDU_INFO_HEAD_FLAG_HFN_SYNC_PDU) 
...
#define CLR_DRB_ULSDU_RETX(_p) \
           (GET_ULSDU_INFO_HEAD(_p)->flag_bmp &= ~ULSDU_INFO_HEAD_FLAG_RETX_WI_SN) 
#define CLR_DRB_ULSDU_HFN_SYNC_PDU(_p) \
           (GET_ULSDU_INFO_HEAD(_p)->flag_bmp &= ~ULSDU_INFO_HEAD_FLAG_HFN_SYNC_PDU) 
