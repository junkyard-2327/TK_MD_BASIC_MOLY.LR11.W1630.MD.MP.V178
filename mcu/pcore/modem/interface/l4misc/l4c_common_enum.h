...
typedef enum
{
    ...
    L4C_TIMER_ID_RSIM_PLUGIN, //18: RSIM plugin timer
    L4C_TIMER_ID_ERSIMAUTH,//19: RSIM AUTH timer
    L4C_TIMER_ID_OP12_LOCK_TIMER,   // 20 op12 reg lock to send dereg if needed    
    L4C_TIMER_ID_OP12_UNLOCK_TIMER, // 20 op12 reg unlock to send reg if needed
    L4C_TIMER_ID_MAX
} l4c_timer_id_enum;
