...
void kpalv_ut_setup_ipv4_connection_3(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result, kal_bool is_tcp) {
...
void kpalv_ut_setup_ipv4_connection_2(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result, kal_bool is_tcp) {
...
void kpalv_ut_setup_ipv4_connection(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result, kal_bool is_tcp) {
...
void kpalv_ut_setup_ipv6_connection(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result, kal_bool is_tcp) {
...
void kpalv_ut_setup_ipv6_query(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result) {
...
void kpalv_ut_setup_ipv4_query(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result) {
    kal_uint8 src_ipv4_addr[4] = {192,168,0,2};
    kal_uint8 dst_ipv4_addr[4] = {223,104,201,163};
    req_ptr->req_type = KPALV_REQ_QUERY;
    req_ptr->ip_type = KPALV_REQ_IPTYPE_IPV4TCP;
...
void kpalv_ut_setup_ipv4_query_udp(imsp_kpalv_keepalive_req_struct *req_ptr, kal_bool parsing_result) {
    kal_uint8 src_ipv4_addr[4] = {192,168,0,2};
    kal_uint8 dst_ipv4_addr[4] = {223,104,201,163};
    req_ptr->req_type = KPALV_REQ_QUERY;
    req_ptr->ip_type = KPALV_REQ_IPTYPE_IPV4UDP;
...
void kpalv_ut_disable_keep_alive(imsp_kpalv_keepalive_req_struct *req_ptr, kal_uint8 conn_id, kal_bool parsing_result) {
...
void kpalv_ut_send_ilm_to_kpalv(kal_uint8 ps_idx, imsp_kpalv_keepalive_req_struct *req_ptr)
{   
    ilm_struct        ilm;

    ilm.src_mod_id = MOD_IMSP + ps_idx; //0 for SIM1
    ilm.dest_mod_id = MOD_KPALV;
    ilm.sap_id = KPALV_SAP;
    ilm.msg_id = MSG_ID_IMSP_KPALV_KEEPALIVE_REQ;
...
void kpalv_ut_connections_reset(void) {
    imsp_kpalv_keepalive_req_struct *disable_req_ptr;
    kal_uint8 proto_idx = 0;
    disable_req_ptr = (imsp_kpalv_keepalive_req_struct *)construct_local_para(sizeof(imsp_kpalv_keepalive_req_struct), TD_RESET);
...
{
    imsp_kpalv_keepalive_req_struct *enable_req_ptr;
    kal_uint8 proto_idx =0;
    /*it mus be first connection*/
    enable_req_ptr = (imsp_kpalv_keepalive_req_struct *)construct_local_para(sizeof(imsp_kpalv_keepalive_req_struct), TD_RESET);
...
void kpalv_ut_query_connection(kal_bool parse_result) {
    kal_uint8 proto_idx =0;
    imsp_kpalv_keepalive_req_struct *req_ptr;       
    req_ptr = (imsp_kpalv_keepalive_req_struct *)construct_local_para(sizeof(imsp_kpalv_keepalive_req_struct), TD_RESET);
...
kal_bool kpalv_enable_req_with_parsing_result_and_ip_type(kal_bool parse_result, kal_bool is_tcp) {
    ...
    imsp_kpalv_keepalive_req_struct *req_ptr = NULL;
    kal_uint8 proto_idx = 0;
    /*it mus be first connection*/
    req_ptr = (imsp_kpalv_keepalive_req_struct *)construct_local_para(sizeof(imsp_kpalv_keepalive_req_struct), TD_RESET);
