...
void FT_Rf_Operation(ilm_struct *ptrMsg)
{
    ...
    FT_SEND_MSG(MOD_FT, MOD_GL1TST, FT_GL1TST_SAP, MSG_ID_FT_TO_GL1TST, &rfMessage);    
}
/**
 * Confirm message handler for MOD_GL1TST
 */
...
void FT_RfCheckFunctionSupported(kal_uint32 query_op_code)
{
    ...
    FT_SEND_MSG(MOD_FT, MOD_GL1TST, FT_GL1TST_SAP, MSG_ID_FT_TO_GL1TST, &ilm_ptr);   
}
