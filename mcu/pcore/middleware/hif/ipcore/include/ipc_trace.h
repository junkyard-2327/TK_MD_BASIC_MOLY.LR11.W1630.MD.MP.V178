...
BEGIN_TRACE_MAP(MOD_IPCORE)
    ...
    TRC_MSG(IPC_ON_DOWNLINK_RA_RPOXY, "[IPCORE] End of ipc_on_downlink_ra_proxy()")
    TRC_MSG(IPC_ON_DOWNLINK_RA_RPOXY_SPD, "[IPCORE] ipc_on_downlink_ra_proxy(): pdn_id = 0x%X, copy RA spd to GPD 0x%x")
    TRC_MSG(IPC_ON_DOWNLINK_RA_RPOXY_GPD, "[IPCORE] ipc_on_downlink_ra_proxy(): pdn_id = 0x%X, Get RA GPD 0x%x from list")
