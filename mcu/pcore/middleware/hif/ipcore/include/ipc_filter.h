...
/*!
 * Check for current GPD/SPD contains ICMPv6 RA packets
 * @param   gpd         [IN] currnet DL GPD
 * @param   ip_packet   [IN] IP contents from SPD entry
 * @param   ip_packet   [IN] IP packet lenght from SPD entry
 */
