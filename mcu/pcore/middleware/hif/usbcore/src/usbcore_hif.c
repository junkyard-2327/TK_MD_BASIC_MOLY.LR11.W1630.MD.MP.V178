...
#ifdef __USBCORE_TARGET_DEBUG__
            usbc_data_trace(USBCORE_POLL_QUEUE_LEN_TX, i, gpd_len, bd_len, spd_len);
#endif
        }
    }
...
#ifdef __USBCORE_TARGET_DEBUG__
        usbc_data_trace(USBCORE_POLL_QUEUE_LEN_RX, i, gpd_len, bd_len, spd_len);
#endif
