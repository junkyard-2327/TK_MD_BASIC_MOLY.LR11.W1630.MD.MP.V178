...
#if defined(MT6276) || defined(MT6256) || defined(DRV_SIM_6575_SERIES) || defined(MT6255) || defined(MT6250) || defined(DRV_SIM_6256_SERIES) || defined(DRV_SIM_6290_SERIES) || defined(DRV_SIM_6291_SERIES)
...
#if defined(MT6595) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
#define __SIM_HOT_PLUG_SINGLE_MD_QUERY_STR__
#endif
...
#if defined(MTK_SLEEP_ENABLE) && !defined(ATEST_DRV_ENABLE) && !defined(__FPGA__)
...
#endif // #if defined(MTK_SLEEP_ENABLE) && !defined(ATEST_DRV_ENABLE) && !defined(__FPGA__)

#ifdef __SIM_DRV_SWITCH_MT6306__
#undef __ABNORMAL_CARD__ 
#else
#if defined(MT6595) || (defined(MT6752) && defined(__MD1__)) || (defined(MT6735) && defined(__MD1__))  || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
...
#if defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
 #if defined(__CGLA__) && defined(__CCCIRPC_SUPPORT__)
#define	__LOCK_VSIM__	1
 #endif // #if defined(__CGLA__) && defined(__CCCIRPC_SUPPORT__)
#endif

#if defined( __SIM_DRV_GEMINI_WITH_MT6306__)
#define  SIM_DRV_GEMINI_WITH_MT6306
#endif

#if defined(MT6757) || defined(MT6750S)
