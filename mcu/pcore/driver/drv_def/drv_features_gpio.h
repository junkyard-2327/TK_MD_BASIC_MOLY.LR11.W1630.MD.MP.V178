...
/**************** GPIO Feature Option******************/
  ...
  #define DRV_GPIO_6280_SPECIAL_SET_REG
   ...
   #define DRV_GPIO_WO_GPO
   #define DRV_GPIO_OFF 
  #elif defined(DRV_GPIO_6755_SERIES)
   #define DRV_GPIO_REG_AS_6755
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_6750S_SERIES)
   #define DRV_GPIO_REG_AS_6750S
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_6797_SERIES)
   #define DRV_GPIO_REG_AS_6797
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_6757_SERIES)
   #define DRV_GPIO_REG_AS_6757
   #define DRV_GPIO_FULL_FUNC
  #else
   #define DRV_GPIO_OFF 
  #endif
