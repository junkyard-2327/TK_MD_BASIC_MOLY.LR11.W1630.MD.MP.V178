...
void SP_CC_Init()
{
   ...
   ASSERT( CC_IRQ_SUCCESS == cc_irq_register_callback(CC_IRQ_L2P_DSP, cc_irq_lisr_aud) );
    
   //- unmask CC IRQ
   ASSERT( CC_IRQ_SUCCESS == cc_irq_unmask(CC_IRQ_L2P_DSP) );
...
void cc_4G_Call_Open_temp(kal_uint32 enc_mod, kal_uint32 dec_mod, kal_uint32 dtx, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 u32CurTime64us)
{
	  int i;	
    kal_uint32 P2L_Buf[CC_BUFFER_SIZE]; 
    kal_uint32 L2P_Buf[CC_BUFFER_SIZE];
...
void cc_4G_EVS_Codec_Call_Open(kal_uint32 band_mod, kal_uint32 delR, kal_uint32 delW, kal_uint32 delM, kal_uint32 u32CurTime64us)
{
    int i;	
    kal_uint32 P2L_Buf[CC_BUFFER_SIZE]; 
    kal_uint32 L2P_Buf[CC_BUFFER_SIZE];
