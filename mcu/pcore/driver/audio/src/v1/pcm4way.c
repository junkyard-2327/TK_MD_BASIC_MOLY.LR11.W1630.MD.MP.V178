	...
	switch(type) {
		case P4W_APP_CTM: 
			Del_PcmEx_Start(pcm4way_hdlr, NULL,
				USE_D2M_PATH + USE_M2D_PATH , // ul1  select p4w before ENH to ensure DSP is fixed to WB
				USE_D2M_PATH + USE_M2D_PATH , // ul2
				USE_D2M_PATH + USE_M2D_PATH , // ul3
				USE_D2M_PATH + USE_M2D_PATH , // ul4
				USE_D2M_PATH + USE_M2D_PATH + DATA_SELECT_AFTER_ENH); //dl  select p4w after ENH to ensure DSP is fixed 
			break;
