 ...
 *
 * 11 30 2016 sungshen.wu
 * [MOLY00216036] [Rosa] bringup prepare
 * .add rosa chip option
 *
 * 03 03 2016 ys.hsieh
 * [MOLY00167298] Olympus pre-bring up chip define check in
 * Olympus pre-bring up chip define check in
 *
 * 02 04 2016 ting-ni.chen
 * [MOLY00160864] [Klocwork]There are some potential code defects in //UMOLY/TRUNK/LR11/mcu/pcore/driver/audio/src/v1/afes/afe_6291.c
 * [Klocwork] defects
 *
 * 08 03 2015 ting-ni.chen
 * [MOLY00134893] Everest chip define check-in
 *
 * 08 03 2015 ting-ni.chen
 * [MOLY00134893] Everest chip define check-in
 * Everest bringup
 ...
 * .
 *
 * 05 25 2015 ting-ni.chen
 * [MOLY00109599] 通?中由?牙模式切?到手柄模式概率性出?接收?音异常?大，引起听筒破音
 * BT voice crack. AFE delay bug fix.
 *
...
#if (defined(MT6595) || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S))  && (MDAFE_DVT_CASE1 || APAUDSYS_DVT_32K)
	afe.voice8kMode = 2;
#elif (defined(MT6595) || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)) && (MDAFE_DVT_CASE3 || APAUDSYS_DVT_8K) // 8k
	afe.voice8kMode = 0;
#else
