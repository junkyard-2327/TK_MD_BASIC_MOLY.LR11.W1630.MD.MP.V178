...
#define _SAL_MIC34_SUPPORT_      (defined(MT6595) || defined(MT6752) || defined(MT6735) || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)) 
#define _SAL_ANC_SUPPORT_        (defined(MT6595) || defined(MT6752) || defined(MT6735) || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)) 
...
#define SPH_OD_HANDSHAKE_MD_BIT_UL     SAL_BIT0
#define SPH_OD_HANDSHAKE_MD_BIT_DL     SAL_BIT1
#define SPH_OD_BYPASS_MD_BIT_UL        SAL_BIT2
#define SPH_OD_BYPASS_MD_BIT_DL        SAL_BIT3
...
#define SAL_FLTCOEFLEN_SRCPLUS 75
...
#define SAL_DSPINT_PRIO_OD_UL_GET	19
#define SAL_DSPINT_PRIO_OD_UL_PUT	20
#define SAL_DSPINT_PRIO_OD_DL_GET	21
#define SAL_DSPINT_PRIO_OD_DL_PUT	22
#define SAL_DSPINT_PRIO_EXTCOD_UL2 23
#define SAL_DSPINT_PRIO_MAX     24
...
#define SAL_DSPINT_ID_OD_UL_GET		(1 << SAL_DSPINT_PRIO_OD_UL_GET)
#define SAL_DSPINT_ID_OD_UL_PUT		(1 << SAL_DSPINT_PRIO_OD_UL_PUT)
#define SAL_DSPINT_ID_OD_DL_GET		(1 << SAL_DSPINT_PRIO_OD_DL_GET)
#define SAL_DSPINT_ID_OD_DL_PUT		(1 << SAL_DSPINT_PRIO_OD_DL_PUT)
#define SAL_DSPINT_ID_EXTCOD_UL2		(1 << SAL_DSPINT_PRIO_EXTCOD_UL2)
