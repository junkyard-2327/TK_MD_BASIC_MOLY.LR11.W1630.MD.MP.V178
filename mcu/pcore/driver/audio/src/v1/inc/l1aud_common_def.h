...
#define SHARE2_D2MCON    ((APBADDR)(SHARE_base+0x0030))       /* DSP-to-MCU Interrupt Control Register     */
#define SHARE_D2MSTA    ((APBADDR)(SHARE_base+0x0034))       /* DSP-to-MCU Interrupt Status Register      */
...
#define SPE_LOUDSPK_DMNR (defined(MT6582)|| defined(MT6290) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(TK6291) || defined(MT6755)) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
...
#define __RELOAD_HW_COEFF__  ( defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6290) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(TK6291) || defined(MT6755)) || defined(MT6797)  || defined(MT6757) || defined(MT6750S)
...
#if defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)  //TK6291 is single RF, this feature is no long needed
...
#if defined(__G_CODEC_SUPPORT__) || defined(__EVS_CODEC_SUPPORT__)
#define __SP4G_USE_EXT_CODEC__
#endif //#if defined(__G_CODEC_SUPPORT__) || defined(__EVS_CODEC_SUPPORT__)
