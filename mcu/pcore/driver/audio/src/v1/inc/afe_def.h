...
#define AFE_base (L1_BASE_MADDR_AFE)
#define MD2GCONFG_base  (L1_BASE_MADDR_MD2G_CONFG)
//#define MODEM2G_CONFG_base  (0xF60F0000)
...
#elif defined(MT6595) || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
