...
#if defined(TK6291)
#include "dpram_6291.h"
#endif

#if defined(MT6755)
#include "dpram_6755.h"
#endif

#if defined(MT6750S)
#include "dpram_6750S.h"
#endif

#if defined(MT6797)
#include "dpram_6797.h"
#endif

#if defined(MT6757)
#include "dpram_6757.h"
#endif
...
#define DSP_IID_SPEECH_OD_UL_GET    6
#define DSP_IID_SPEECH_OD_UL_PUT    7
#define DSP_IID_SPEECH_OD_DL_GET    8
#define DSP_IID_SPEECH_OD_DL_PUT    9
...
#elif defined(MT6595) || defined(MT6752) || defined(MT6735) || defined(TK6291)
#define DSP_SPH_ST_ADAPT_GAIN        DSP_DM_ADDR(5, 0x37CE)
#elif defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
#define DSP_SPH_ST_ADAPT_GAIN        DPRAM2_base(SPH_ST_ADAPTIVE_GAIN)
#else
...
#if defined(MT6797)
#define DSP_SPH_OD_CTRL             DPRAM2_base(SPH_OD_CTRL)         
#define DSP_SPH_OD_HANDSHAKE_MD     DPRAM2_base(SPH_OD_HANDSHAKE_MD)    
#define DSP_SPH_OD_POLL_THRES_DL    DPRAM2_base(SPH_OD_POLL_THRES_DL)    
#define DSP_SPH_OD_POLL_THRES_UL    DPRAM2_base(SPH_OD_POLL_THRES_UL)    
#define DSP_SPH_OD_NXP_STATUS       DPRAM2_base(SPH_OD_NXP_STATUS) 
#define DSP_SPH_OD_DL_CNTR          DPRAM2_base(SPH_OD_DL_CNTR) 
#define DSP_SPH_OD_UL_CNTR          DPRAM2_base(SPH_OD_UL_CNTR)  
#else
#define DSP_SPH_OD_CTRL             DPRAM2_base(SPH_BKCP_DUMMY)         
#define DSP_SPH_OD_HANDSHAKE_MD     DPRAM2_base(SPH_BKCP_DUMMY)    
#define DSP_SPH_OD_POLL_THRES_DL    DPRAM2_base(SPH_BKCP_DUMMY)    
#define DSP_SPH_OD_POLL_THRES_UL    DPRAM2_base(SPH_BKCP_DUMMY)
#define DSP_SPH_OD_NXP_STATUS       DPRAM2_base(SPH_BKCP_DUMMY)   
#define DSP_SPH_OD_DL_CNTR          DPRAM2_base(SPH_BKCP_DUMMY) 
#define DSP_SPH_OD_UL_CNTR          DPRAM2_base(SPH_BKCP_DUMMY)  
#endif
...
#if defined(MT6595) || defined(MT6752) || defined(MT6735) || defined(MT6755) || defined(MT6797)  || defined(MT6757) || defined(MT6750S)
#define DSP_SPH_DL_VAD_FLAG       DSP_DM_ADDR(5, 0x2FE9)
#else
#define DSP_SPH_DL_VAD_FLAG       DPRAM2_base(SPH_BKCP_DUMMY)
#endif
