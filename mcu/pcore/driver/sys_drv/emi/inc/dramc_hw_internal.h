 ...
 * $Log$
 *
 * 11 15 2013 guo-huei.chang
 * [MOLY00042691] [MT6290E2] EMI/DRAMC fine clock off feature
 * 1.add EMI/RAMC fine clock off feature
 * 2.update initial dram
 * 3.enable SSC with -8%
 *
 * 10 02 2013 guo-huei.chang
 * [MOLY00040060] Update EMI/DRAMC Settings
 * 	Update DRAMC Setting for Power Saving about PADRGEN
 * 	Update EMI Setting for LMAC Underflow
 *
 * 06 04 2013 guo-huei.chang
 * [MOLY00024870] [MT6290] DRAMC Auto-k Code Update for FF Corner IC
 * update dramc auto-k for FF corner IC
 * fix ssc features
 *
 * 05 09 2013 guo-huei.chang
 ...
 *
 * 02 26 2013 cindy.tu
 * [MOLY00010870] MT6290 Bootloader Implementation Phase 1
