 ...
 * Version
 *******************************************************************************/
#define HW_VER                   ((volatile UINT16P)(PS_CONFIG_base+0x0000))
#define FW_VER                   ((volatile UINT16P)(PS_CONFIG_base+0x0004))
#define SW_VER                   FW_VER
#define HW_CODE                  ((volatile UINT16P)(PS_CONFIG_base+0x0008))
#define HW_SUBCODE               ((volatile UINT16P)(PS_CONFIG_base+0x000C))

/*******************************************************************************
 * System special register
 *******************************************************************************/
#define SW_MISC_L                ((volatile UINT32P)(PS_CONFIG_base+0x10))
#define SW_MISC_H                ((volatile UINT32P)(PS_CONFIG_base+0x14))
