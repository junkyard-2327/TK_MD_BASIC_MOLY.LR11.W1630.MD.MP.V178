...
/*******************************************************************************
 * PSCore Boot slave register base
 *******************************************************************************/

#define MCU_BOOTSLV_JUMP_ADDR         (BASE_MADDR_MDPERIMISC + 0x4)
#define MCU_BOOTSLV_JUMP_ADDR_UPDATE  (BASE_MADDR_MDPERIMISC + 0x8)
#define MCU_BOOTSLV_JUMP_KEY_ADDR     (BASE_MADDR_MDPERIMISC + 0xC)
#define MCU_BOOTSLV_JUMP_KEY_VALUE    (0x00005500)
#define MCU_BOOTSLV_JUMP_NONKEY_VALUE (0xFFFFAABB)
