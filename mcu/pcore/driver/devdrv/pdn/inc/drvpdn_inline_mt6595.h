 ...
 *
 * 01 17 2014 gh.huang
 * [MOLY00054243] Update PDN Support by DCM Owner Request
 *
 *
 ****************************************************************************/
...
DRVPDN_INLINE_MODIFIER DRVPDN_INLINE void PDN_SET(PDN_DEVICE dev)
{
    ...
    switch (dev)
    {
        ...
        case PDN_MDMCU_BUSMON:
            DRVPDN_4GIP_OFF(0, MDMCU_BUSMON);
            break;
        case PDN_MDINFRA_BUSMON:
            DRVPDN_4GIP_OFF(0, MDINFRA_BUSMON);
            break;
        case PDN_ELM:
...
DRVPDN_INLINE_MODIFIER DRVPDN_INLINE void PDN_CLR(PDN_DEVICE dev)
{
    ...
    switch (dev)
    {
        ...
        case PDN_RSVD13:
            ...
            break;
        case PDN_MDMCU_BUSMON:
            DRVPDN_4GIP_ON(0, MDMCU_BUSMON);
            break;
        case PDN_MDINFRA_BUSMON:
            DRVPDN_4GIP_ON(0, MDINFRA_BUSMON);
            break;
        case PDN_ELM:
...
DRVPDN_INLINE_MODIFIER DRVPDN_INLINE kal_uint32 PDN_STS(PDN_DEVICE dev)
{
    ...
    switch (dev)
    {
        ...
        case PDN_RSVD13:
            ...
            break;
        case PDN_MDMCU_BUSMON:
            ret = DRVPDN_4GIP_STS(0, MDMCU_BUSMON);
            break;
        case PDN_MDINFRA_BUSMON:
            ret = DRVPDN_4GIP_STS(0, MDINFRA_BUSMON);
            break;
        case PDN_ELM:
