...
#elif defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
#define PMIC_WRAP_TIMEOUT               12800 // APB Bus Latency + other subsys access latency
#endif

#if defined(DRV_PMIC_WRAP_6589_REG)
#define PMIC_WRAP_REG_COUNT              0x190
#elif defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6582_REG) || defined(DRV_PMIC_WRAP_6571_REG) || defined(DRV_PMIC_WRAP_6595_REG)
#define PMIC_WRAP_REG_COUNT              0x190
#elif defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG)
#define PMIC_WRAP_REG_COUNT              0x190
#elif defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
#define PMIC_WRAP_REG_COUNT              0x340
#endif

#if defined(DRV_PMIC_WRAP_6755_REG)
#define PERIBUS_DEBUG

#if defined(PERIBUS_DEBUG)
#define PERIBUS_DBG_REG_COUNT  0x20

typedef struct
{
   kal_uint32 peribus_dbg0;
   kal_uint32 peribus_dbg1;
   kal_uint32 peribus_dbg2;
   kal_uint32 peribus_dbg3;
   kal_uint32 peribus_dbg4;
   kal_uint32 peribus_dbg5;
   kal_uint32 peribus_dbg6;
}PERIBUS_DBG_LOG;
PERIBUS_DBG_LOG peribus_dbg_log;
#endif
#endif

#if defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
#define DRV_GET_CURRENT_TIME_WORKAROUND
#endif
...
const kal_uint32 pmic_wrap_dump_regions[] = {
   PMIC_WRAP_BASE,   PMIC_WRAP_REG_COUNT, 2,    /* PMIC_WRAPPER */
};
#if defined(PERIBUS_DEBUG)
EX_BBREG_DUMP peribus_dbg_dump;
const kal_uint32 peribus_dbg_dump_regions[] = {
   PERIBUS_DBG_BASE,   PERIBUS_DBG_REG_COUNT, 2,    /* PERIBUS_DBG */
};
#endif
...
void pmic_wrap_dump_peribus_dbg(void){
	...
	peribus_dbg_log.peribus_dbg0=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG0);
	peribus_dbg_log.peribus_dbg1=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG1);
	peribus_dbg_log.peribus_dbg2=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG2);
	peribus_dbg_log.peribus_dbg3=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG3);
	peribus_dbg_log.peribus_dbg4=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG4);
	peribus_dbg_log.peribus_dbg5=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG5);
    peribus_dbg_log.peribus_dbg6=PMIC_WRAP_DRV_Reg32(PERIBUS_DBG6);
}
#endif

#if defined(DRV_PMIC_WRAP_6757_REG)
#define APBBUS_DEBUG

#if defined(APBBUS_DEBUG)

typedef struct
{
   kal_uint32 reserved[2];
   kal_uint32 apc_ao_con[8];
   kal_uint32 apc_mask[8];
   kal_uint32 apc_sta[8];

}APBBUS_DBG_LOG;
APBBUS_DBG_LOG apbbus_dbg_log;

#define APC_AO_CON_DBG_BASE			(0xC000E000)
#define APC_MASK_DBG_BASE			(0xC0207000)
#define APC_STA_DBG_BASE			(0xC0207400)

void pmic_wrap_dump_apbbus_dbg(void){

	kal_uint32 rdata = 0;
	int i;
	//set reserved register 0x10001240[29:24] = 6?�b111111 and read 0x10001240[29:24]
	rdata = PMIC_WRAP_DRV_Reg32(0xC0001240);
	apbbus_dbg_log.reserved[0] = rdata;
	rdata |= (0x3f << 24);
	PMIC_WRAP_DRV_WriteReg32(0xC0001240,rdata);
	apbbus_dbg_log.reserved[1] = PMIC_WRAP_DRV_Reg32(0xC0001240);

	//device_apc_ao_con:
	//read 0x1000E000/0x1000E100/0x1000E200/0x1000E300/0x1000E400/0x1000E500/0x1000E600/0x1000E700
	//device_apc_mask:
	//read 0x10207000/0x10207004/0x10207008/0x1020700C/0x10207010/0x10207014/0x10207018/0x1020701C
	//device_apc_sta:
	//read 0x10207400/0x10207404/0x10207408/0x1020740C/0x10207410/0x10207414/0x10207418/0x1020741C

	for(i = 0; i<8; i++)
	{
		apbbus_dbg_log.apc_ao_con[i]= PMIC_WRAP_DRV_Reg32(APC_AO_CON_DBG_BASE+0x100*i);
		apbbus_dbg_log.apc_mask[i]  = PMIC_WRAP_DRV_Reg32(APC_MASK_DBG_BASE+ i*4);
		apbbus_dbg_log.apc_sta[i]   = PMIC_WRAP_DRV_Reg32(APC_STA_DBG_BASE + i*4);
	}
}
#endif
#endif
...
#if defined(PERIBUS_DEBUG)
   peribus_dbg_dump.regions = (kal_uint32*)peribus_dbg_dump_regions;
   peribus_dbg_dump.num = sizeof(peribus_dbg_dump_regions) / (sizeof(kal_uint32) * 3);
   peribus_dbg_dump.bbreg_dump_callback = NULL;
   EX_REGISTER_BBREG_DUMP(&peribus_dbg_dump);
#endif
}
#endif /* __MTK_TARGET__ */
...
static inline kal_uint32 wait_for_cipher_ready(kal_uint32 x)
{
    ...
    return (x != 0x01);
#else /*defined(MT6325) || defined(MT6328) || defined(MT6331) || defined(MT6332) || defined(MT6336) || defined(MT6351) || defined(MT6353) and later */
    return (x != 0x03);
#endif
}
...
kal_uint32 DrvPWRAP_Init(void)
{
...
#if defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
	...
	// Toggle PMIC_WRAP and pwrap_spictl reset
	//###############################
	PMIC_WRAP_DRV_WriteReg32(INFRA_GLOBALCON_RST2_SET, 0x01);
	PMIC_WRAP_DRV_WriteReg32(INFRA_GLOBALCON_RST2_CLR, 0x01);

	//###############################
	// Set SPI_CK_freq  52MHz or 26MHz
	//###############################
#ifdef ULPOSC
  	PMIC_WRAP_DRV_WriteReg32(ULPOSC_CON, 0x0001); // enable ulposc
  	{
  	        kal_uint32 delay_start = 0;
  		delay_start = ust_get_current_time();
  		while(1)
  		{
  			if(ust_get_duration(delay_start, ust_get_current_time()) > 1)
  			{
  					break;
  			}
  		}

		PMIC_WRAP_DRV_WriteReg32(ULPOSC_CON, 0x0003); // reset ulposc
		delay_start = ust_get_current_time();
		while(1)
  		{
  			if(ust_get_duration(delay_start, ust_get_current_time()) > 30)
  			{
  					break;
  			}
  		}
  		PMIC_WRAP_DRV_WriteReg32(ULPOSC_CON, 0x0001); // release reset ulposc
		delay_start = ust_get_current_time();
		while(1)
  		{
  			if(ust_get_duration(delay_start, ust_get_current_time()) > 130)
  			{
  					break;
  			}
  		}

  		PMIC_WRAP_DRV_WriteReg32(ULPOSC_CON, 0x0005); // release reset ulposc
		PMIC_WRAP_DRV_WriteReg32(CLK_CFG_5_SET, 0x0002); // 52MHz [1:0]
		delay_start = ust_get_current_time();
		while(1)
  		{
  			if(ust_get_duration(delay_start, ust_get_current_time()) > 20)
  			{
  					break;
  			}
  		}
        }
		//*GPIO_DUMMY = 0x80000000; remove by ECO
		PMIC_WRAP_DRV_WriteReg32(PMICW_CLOCK_CTRL, 0x0000); // pmicw_sw_en
		PMIC_WRAP_DRV_WriteReg32(CLK_CFG_UPDATE, 0x00080000); // clock configure update
		PMIC_WRAP_DRV_WriteReg32(MODULE_SW_CG_0_SET, 0x0000000F); // sys_ck cg enable
		PMIC_WRAP_DRV_WriteReg32(MODULE_SW_CG_0_CLR, 0x0000000F); // sys_ck cg disable
#else
		PMIC_WRAP_DRV_WriteReg32(CLK_CFG_5_CLR, 0x1); // 26MHz [1:0]
		PMIC_WRAP_DRV_WriteReg32(MODULE_SW_CG_0_SET, 0x0000000F); // sys_ck cg enable
		PMIC_WRAP_DRV_WriteReg32(MODULE_SW_CG_0_CLR, 0x0000000F); // sys_ck cg disable
#endif
...
////////////////////////////////////////////////////////////////////////////////
    ...
    // Enable DCM
    //###############################
#if defined(DRV_PMIC_WRAP_6595_REG) || defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
...
#elif defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG)
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_HIPRIO_ARB_EN, 0x20); // HIPRIO_ARB enable for each source. (Set WACS2 highest priority)
#elif defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_HIPRIO_ARB_EN, 0x800); // HIPRIO_ARB enable for each source. (Set WACS2 highest priority)
#else
...
//    sub_return = DrvPWRAP_InitRegClk(PMIC_WRAP_REG_CLOCK_36MHZ); // 0:safe mode, 1:18MHz, 2:36MHz
    ...
    sub_return = DrvPWRAP_InitRegClk(PMIC_WRAP_REG_CLOCK_36MHZ); // 0:safe mode, 1:18MHz, 2:36MHz
#elif defined(DRV_PMIC_WRAP_V2)
#if defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
    // 0:safe mode, 1:18MHz
...
#elif defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
...
#elif defined(MT6320) || defined(MT6323)
...
#elif defined(MT6351)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_WRITE_TEST, MT6351_DEW_WRITE_TEST_VALUE, &rdata); // Write Test
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6351_DEW_WRITE_TEST, 0x00, &rdata);

    if(rdata != MT6351_DEW_WRITE_TEST_VALUE)  {
        /* TERR="Error: [WriteTest] fail, rdata=%x, exp=0xa55a", rdata*/
        ASSERT(0);
        return PMIC_WRAP_WRITE_TEST_FAIL;
    }
#elif defined(MT6353)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_WRITE_TEST, MT6353_DEW_WRITE_TEST_VALUE, &rdata); // Write Test
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6353_DEW_WRITE_TEST, 0x00, &rdata);

    if(rdata != MT6353_DEW_WRITE_TEST_VALUE)  {
        /* TERR="Error: [WriteTest] fail, rdata=%x, exp=0xa55a", rdata*/
        ASSERT(0);
        return PMIC_WRAP_WRITE_TEST_FAIL;
    }
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_WRITE_TEST, MT6351_DEW_WRITE_TEST_VALUE, &rdata); // Write Test
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, PMIC_DEW_WRITE_TEST, 0x00, &rdata);

    if(rdata != PMIC_DEW_WRITE_TEST_VALUE)  {
        /* TERR="Error: [WriteTest] fail, rdata=%x, exp=0xa55a", rdata*/
        ASSERT(0);
        return PMIC_WRAP_WRITE_TEST_FAIL;
    }
...
#if defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
    //###############################
    ...
    //###############################
#if defined(MT6325)
    DrvPWRAP_WACS2_NoChk(1, MT6325_DEW_CRC_EN, 0x1, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIG_ADR, MT6325_DEW_CRC_VAL);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STAUPD_GRPEN, 0x15);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CRC_EN, 0x1);
#endif

#if defined(MT6351)
    DrvPWRAP_WACS2_NoChk(1, MT6351_DEW_CRC_EN, 0x1, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIG_ADR, MT6351_DEW_CRC_VAL);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STAUPD_GRPEN, 0x75);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CRC_EN, 0x1);
  	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_EINT_STA0_ADR, MT6351_INT_STA);


	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_ADC_CMD_ADDR, MT6351_AUXADC_RQST1_SET);
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_PWRAP_ADC_CMD, 0x0100);
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_ADC_RDATA_ADDR, MT6351_AUXADC_ADC16);

    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR_LATEST, MT6351_AUXADC_ADC32);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR_WP, MT6351_AUXADC_MDBG_1);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR0, MT6351_AUXADC_BUF0);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR1, MT6351_AUXADC_BUF1);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR2, MT6351_AUXADC_BUF2);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR3, MT6351_AUXADC_BUF3);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR4, MT6351_AUXADC_BUF4);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR5, MT6351_AUXADC_BUF5);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR6, MT6351_AUXADC_BUF6);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR7, MT6351_AUXADC_BUF7);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR8, MT6351_AUXADC_BUF8);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR9, MT6351_AUXADC_BUF9);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR10, MT6351_AUXADC_BUF10);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR11, MT6351_AUXADC_BUF11);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR12, MT6351_AUXADC_BUF12);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR13, MT6351_AUXADC_BUF13);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR14, MT6351_AUXADC_BUF14);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR15, MT6351_AUXADC_BUF15);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR16, MT6351_AUXADC_BUF16);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR17, MT6351_AUXADC_BUF17);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR18, MT6351_AUXADC_BUF18);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR19, MT6351_AUXADC_BUF19);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR20, MT6351_AUXADC_BUF20);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR21, MT6351_AUXADC_BUF21);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR22, MT6351_AUXADC_BUF22);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR23, MT6351_AUXADC_BUF23);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR24, MT6351_AUXADC_BUF24);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR25, MT6351_AUXADC_BUF25);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR26, MT6351_AUXADC_BUF26);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR27, MT6351_AUXADC_BUF27);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR28, MT6351_AUXADC_BUF28);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR29, MT6351_AUXADC_BUF29);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR30, MT6351_AUXADC_BUF30);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR31, MT6351_AUXADC_BUF31);
#endif

#if defined(MT6353)
    DrvPWRAP_WACS2_NoChk(1, MT6353_DEW_CRC_EN, 0x1, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIG_ADR, MT6353_DEW_CRC_VAL);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STAUPD_GRPEN, 0x75);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CRC_EN, 0x1);
  	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_EINT_STA0_ADR, MT6353_INT_STA);


	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_ADC_CMD_ADDR, MT6353_AUXADC_RQST1_SET);
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_PWRAP_ADC_CMD, 0x0100);
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_ADC_RDATA_ADDR, MT6353_AUXADC_ADC16);

    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR_LATEST, MT6353_AUXADC_ADC32);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR_WP, MT6353_AUXADC_MDBG_1);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR0, MT6353_AUXADC_BUF0);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR1, MT6353_AUXADC_BUF1);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR2, MT6353_AUXADC_BUF2);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR3, MT6353_AUXADC_BUF3);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR4, MT6353_AUXADC_BUF4);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR5, MT6353_AUXADC_BUF5);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR6, MT6353_AUXADC_BUF6);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR7, MT6353_AUXADC_BUF7);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR8, MT6353_AUXADC_BUF8);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR9, MT6353_AUXADC_BUF9);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR10, MT6353_AUXADC_BUF10);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR11, MT6353_AUXADC_BUF11);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR12, MT6353_AUXADC_BUF12);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR13, MT6353_AUXADC_BUF13);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR14, MT6353_AUXADC_BUF14);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR15, MT6353_AUXADC_BUF15);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR16, MT6353_AUXADC_BUF16);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR17, MT6353_AUXADC_BUF17);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR18, MT6353_AUXADC_BUF18);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR19, MT6353_AUXADC_BUF19);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR20, MT6353_AUXADC_BUF20);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR21, MT6353_AUXADC_BUF21);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR22, MT6353_AUXADC_BUF22);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR23, MT6353_AUXADC_BUF23);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR24, MT6353_AUXADC_BUF24);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR25, MT6353_AUXADC_BUF25);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR26, MT6353_AUXADC_BUF26);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR27, MT6353_AUXADC_BUF27);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR28, MT6353_AUXADC_BUF28);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR29, MT6353_AUXADC_BUF29);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR30, MT6353_AUXADC_BUF30);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR31, MT6353_AUXADC_BUF31);
#endif
#if defined(MT6355)
//TBD
#endif
#endif // End of #if defined(DRV_PMIC_WRAP_6291_REG) || defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)

#if defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
    // latency is smaller than 10us, pop up to group"1"
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_HARB_HPRIO, 0x0007); // [0]:MD_HW [1]:C2K_HW [2]:MD_DVFS _HW

    // starvation enable
    //[0]=MD_HW, latency= 2.6us, target= (2.6/1.2)-1=1
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_0, 0x0401); // [10]: enable starvation, [9:0]: target setting
    //[1]=C2K_HW, latency= 2.6us, target= (2.6/1.2)-1=1
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_1, 0x0401); // [10]: enable starvation, [9:0]: target setting
    //[2]=MD_DVFS_HW,latency= 5.2us, target= (5.2/1.2)-1=3
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_2, 0x0403); // [10]: enable starvation, [9:0]: target setting
    //[3]=WACS0(MD_SW0), latency=40us, target= (40/1.2)-1=32
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_3, 0x0420); // [10]: enable starvation, [9:0]: target setting
    //[4]=SPM_HW, latency=40us, target= (40/1.2)-1=32
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_4, 0x0420); // [10]: enable starvation, [9:0]: target setting
    //[5]=WACS3(C2K_SW), latency=40us, target= (40/1.2)-1=32
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_5, 0x0420); // [10]: enable starvation, [9:0]: target setting
    //[6]=DCXO_CONNINF, latency=50us, target= (50/1.2)-1=40
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_6, 0x0428); // [10]: enable starvation, [9:0]: target setting
    //[7]=DCXO_NFCINF, latency=50us, target= (50/1.2)-1=40
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_7, 0x0428); // [10]: enable starvation, [9:0]: target setting
    //[8]=MD_ADCINF, latency=29us, target= (29/1.2)-1= 23
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_8, 0x0417); // [10]: enable starvation, [9:0]: target setting
    //[9]=STAUPD, latency=428us, target= (428/1.2)-1=355
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_9, 0x0563); // [10]: enable starvation, [9:0]: target setting
    //[10]=GPS_HW, latency=150us, target= (150/1.2)-1=124
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_10, 0x047C); // [10]: enable starvation, [9:0]: target setting
    //[11]=WACS2(AP_SW), latency=1000us, target= (1000/1.2)-1=832
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_11, 0x0740); // [10]: enable starvation, [9:0]: target setting
    //[12]=WACS1(MD_SW1), latency=1000us, target= (1000/1.2)-1=832
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STARV_COUNTER_12, 0x0740); // [10]: enable starvation, [9:0]: target setting
#endif // End of #if defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
...
#if defined(DRV_PMIC_WRAP_6735_REG) || defined(DRV_PMIC_WRAP_6291_REG)
...
#if defined(DRV_PMIC_WRAP_6291_REG)
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_INT0_EN, 0x7FFFFBFF); // Interrupt enable for each source, except for [31] debug_int.
#elif defined(DRV_PMIC_WRAP_6755_REG) || defined(DRV_PMIC_WRAP_6797_REG) || defined(DRV_PMIC_WRAP_6750_REG)
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_INT0_EN, 0xffffffff); // Interrupt enable for each source, except for [31] debug_int.
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_INT1_EN, 0x0001ffff); // Interrupt enable for each source, except for [31] debug_int.
#else
...
#elif defined(MT6351)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_DIO_EN, dio_en, &rdata); // Enable dual I/O mode for SPI slave.
#elif defined(MT6353)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_DIO_EN, dio_en, &rdata); // Enable dual I/O mode for SPI slave.
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_DIO_EN, dio_en, &rdata); // Enable dual I/O mode for SPI slave.
#endif
...
#elif defined(MT6351)
#if !defined(DRV_PMIC_WRAP_6757_REG)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6351_DEW_READ_TEST, 0x00, &rdata);
    if(rdata != MT6351_DEW_READ_TEST_VALUE)
    {
        ASSERT(0);
        /* TERR="Error: [DrvPWRAP_InitDio][Read Test] fail, dio_en = %x, READ_TEST rdata=%x, exp=0x5aa5", dio_en, rdata */
        return PMIC_WRAP_READ_TEST_FAIL;
...
#endif
#elif defined(MT6353)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6353_DEW_READ_TEST, 0x00, &rdata);
    if(rdata != MT6353_DEW_READ_TEST_VALUE)
    {
        ASSERT(0);
        /* TERR="Error: [DrvPWRAP_InitDio][Read Test] fail, dio_en = %x, READ_TEST rdata=%x, exp=0x5aa5", dio_en, rdata */
        return PMIC_WRAP_READ_TEST_FAIL;
...
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, PMIC_DEW_READ_TEST, 0x00, &rdata);
    if(rdata != MT6351_DEW_READ_TEST_VALUE)
    {
        ASSERT(0);
        /* TERR="Error: [DrvPWRAP_InitDio][Read Test] fail, dio_en = %x, READ_TEST rdata=%x, exp=0x5aa5", dio_en, rdata */
...
#elif defined(MT6351)
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6351_DEW_DIO_EN, dio_en & 0x1, &rdata); // Disable / Enable dual I/O mode for SPI slave.

    if(sub_return != 0)  {
        /* TERR="Error: [DrvPWRAP_SwitchDio][Set MT6351_DEW_DIO_EN] DrvPWRAP_WACS2 fail, return=%x, exp=0x0", sub_return*/
        ASSERT(0);
        return PMIC_WRAP_SWITCH_DIO_FAIL;
    }
#elif defined(MT6353)
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6353_DEW_DIO_EN, dio_en & 0x1, &rdata); // Disable / Enable dual I/O mode for SPI slave.

    if(sub_return != 0)  {
        /* TERR="Error: [DrvPWRAP_SwitchDio][Set MT6353_DEW_DIO_EN] DrvPWRAP_WACS2 fail, return=%x, exp=0x0", sub_return*/
        ASSERT(0);
        return PMIC_WRAP_SWITCH_DIO_FAIL;
    }
#else /* #if defined(MT6351) and later */
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_WRITE, PMIC_DEW_DIO_EN, dio_en & 0x1, &rdata); // Disable / Enable dual I/O mode for SPI slave.
...
#elif defined(MT6351)
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_READ, MT6351_DEW_READ_TEST, 0, &rdata);
    if((sub_return != 0) || (rdata != MT6351_DEW_READ_TEST_VALUE)){
        /* TERR="Error: [DrvPWRAP_SwitchDio][Read Test] DrvPWRAP_WACS2() fail, dio_en = %x, return=%x, exp=0, rdata=%x, exp=0x5aa5", dio_en, sub_return, rdata */
        ASSERT(0);
        return PMIC_WRAP_READ_TEST_FAIL;
    }
#elif defined(MT6353)
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_READ, MT6353_DEW_READ_TEST, 0, &rdata);
    if((sub_return != 0) || (rdata != MT6353_DEW_READ_TEST_VALUE)){
        /* TERR="Error: [DrvPWRAP_SwitchDio][Read Test] DrvPWRAP_WACS2() fail, dio_en = %x, return=%x, exp=0, rdata=%x, exp=0x5aa5", dio_en, sub_return, rdata */
        ASSERT(0);
        return PMIC_WRAP_READ_TEST_FAIL;
    }
#else
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_READ, PMIC_DEW_READ_TEST, 0, &rdata);
    if((sub_return != 0) || (rdata != PMIC_DEW_READ_TEST_VALUE)){
        /* TERR="Error: [DrvPWRAP_SwitchDio][Read Test] DrvPWRAP_WACS2() fail, dio_en = %x, return=%x, exp=0, rdata=%x, exp=0x5aa5", dio_en, sub_return, rdata */
        ASSERT(0);
        return PMIC_WRAP_READ_TEST_FAIL;
    }
...
#elif defined(MT6351)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_SWRST,   0x01,  &rdata); // Enabl CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_SWRST,   0x00,  &rdata); // Disble CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_KEY_SEL, 0x01,  &rdata); // All keys are hard-wired
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_IV_SEL,  0x02,  &rdata); // Set 0 to choose manual initial vector, otherwise, choose other Hard-wired initial vectors.
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_EN,   0x01,  &rdata); // CIPHER Engine Enable
#elif defined(MT6353)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_SWRST,   0x01,  &rdata); // Enabl CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_SWRST,   0x00,  &rdata); // Disble CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_KEY_SEL, 0x01,  &rdata); // All keys are hard-wired
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_IV_SEL,  0x02,  &rdata); // Set 0 to choose manual initial vector, otherwise, choose other Hard-wired initial vectors.
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_EN,   0x01,  &rdata); // CIPHER Engine Enable
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_SWRST,   0x01,  &rdata); // Enabl CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_SWRST,   0x00,  &rdata); // Disble CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_KEY_SEL, 0x01,  &rdata); // All keys are hard-wired
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_IV_SEL,  0x02,  &rdata); // Set 0 to choose manual initial vector, otherwise, choose other Hard-wired initial vectors.
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_EN,   0x01,  &rdata); // CIPHER Engine Enable
...
/* under construction !*/
    ...
    do
    {
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6351_DEW_CIPHER_RDY, 0x00, &rdata); // Wait until CIPHER Data Ready (Data should be ready before enable CIPHER_MODE)
        #if 0 // NEED TO CHECK
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_MODE, 0x01, &rdata); // CIPHER Mode Enable
#elif defined(MT6353)
    do
    {
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6353_DEW_CIPHER_RDY, 0x00, &rdata); // Wait until CIPHER Data Ready (Data should be ready before enable CIPHER_MODE)
        #if 0 // NEED TO CHECK
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_MODE, 0x01, &rdata); // CIPHER Mode Enable
#else
    do
    {
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, PMIC_DEW_CIPHER_RDY, 0x00, &rdata); // Wait until CIPHER Data Ready (Data should be ready before enable CIPHER_MODE)
        #if 0 // NEED TO CHECK
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_MODE, 0x01, &rdata); // CIPHER Mode Enable
#endif
    return_value = wait_for_state_ready_init(wait_for_wacs_fsm_idle_and_sync_idle, PMIC_WRAP_TIMEOUT, PMIC_WRAP_WACS2_RDATA, 0);
    if(return_value != 0)
    {
...
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, PMIC_DEW_READ_TEST, 0x00, &rdata);
    if(rdata != PMIC_DEW_READ_TEST_VALUE)
    {
        /* TERR="Error: [DrvPWRAP_InitCIPHER][Read Test] fail, READ_TEST rdata=%x, exp=0x5aa5", rdata */
        ASSERT(0);
        return PMIC_WRAP_READ_TEST_FAIL;
...
#elif defined(MT6351)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_EN, 0x00, &rdata); // CIPHER Engine Disable
#elif defined(MT6353)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_EN, 0x00, &rdata); // CIPHER Engine Disable
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_EN, 0x00, &rdata); // CIPHER Engine Disable
#endif
...
#elif defined(MT6351)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6351_DEW_CIPHER_MODE, 0x00, &rdata); // CIPHER MODE Disable
#elif defined(MT6353)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6353_DEW_CIPHER_MODE, 0x00, &rdata); // CIPHER MODE Disable
#else /* #if defined(MT6355) and later */
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, PMIC_DEW_CIPHER_MODE, 0x00, &rdata); // CIPHER MODE Disable
#endif
...
kal_uint32 DrvPWRAP_InitSiStrobe( void )
{
    ...
    kal_int32 ind;
	kal_int32 sidly = 0;
	kal_int32 i = 0, fail_cnt = 0;
	kal_int32 test_data[30] = {0x6996,0x9669,0x6996,0x9669,0x6996,0x9669,0x6996,0x9669,0x6996,0x9669,
    ...
    for(ind = 0; ind < 24; ind++) // 24 sampling clock edge
    {
		...
		{
#if defined MT6351
			DrvPWRAP_WACS2_NoChk(1, MT6351_DEW_WRITE_TEST, test_data[i], &rdata);
			DrvPWRAP_WACS2_NoChk(0, MT6351_DEW_WRITE_TEST, 0, &rdata);
#endif
	...
	if(sidly != 0)
		sidly--;
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIDLY, sidly); // Configure SIDLY
#if defined(MT6351)
	DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6351_DEW_READ_TEST, 0x00, &rdata);
    if(rdata != MT6351_DEW_READ_TEST_VALUE)
    {
...
kal_uint32 DrvPWRAP_InitSiStrobe( void )
{
...
#if defined(ULPOSC)
    long long  result, inds, indf, tmp1, tmp2;
#else
    kal_uint32 tmp1, tmp2;
    kal_uint32 result;
#endif
	...
	for(ind = 0; ind < 44; ind++) // 44 sampling clock edge
  	{
   		PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SI_CK_CON, (ind >> 2) & 0xf);
   		PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIDLY, 0x3 - (ind & 0x3));
#if defined MT6351
		DrvPWRAP_WACS2_NoChk(0, MT6351_DEW_READ_TEST, 0, &rdata);
    	if(rdata == MT6351_DEW_READ_TEST_VALUE )
#elif defined MT6353
		DrvPWRAP_WACS2_NoChk(0, MT6353_DEW_READ_TEST, 0, &rdata);
    	if(rdata == MT6353_DEW_READ_TEST_VALUE )
#else /* #if defined MT6355 and later */
		DrvPWRAP_WACS2_NoChk(0, PMIC_DEW_READ_TEST, 0, &rdata);
    	if(rdata == PMIC_DEW_READ_TEST_VALUE )
#endif
    	{
	...
	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SI_CK_CON, (ind >> 2) & 0xF); // Configure SI_EN_SEL & SI_CK_SEL
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIDLY, 0x3 - (ind & 0x3)); // Configure SIDLY

#else // Else of #if ULPOSC
    //---------------------------------------------------------------------
    // Scan all possible input strobe by READ_TEST
    //---------------------------------------------------------------------
    result = 0;
    ...
    for(ind = 0; ind < 24; ind++) // 24 sampling clock edge
    {
        ...
        if(rdata == MT6328_DEW_READ_TEST_VALUE)
#elif defined(MT6351)
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6351_DEW_READ_TEST, 0, &rdata);
        if(rdata == MT6351_DEW_READ_TEST_VALUE)
#elif defined(MT6353)
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6353_DEW_READ_TEST, 0, &rdata);
        if(rdata == MT6353_DEW_READ_TEST_VALUE)
#else
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, PMIC_DEW_READ_TEST, 0, &rdata);
        if(rdata == PMIC_DEW_READ_TEST_VALUE)
#endif
        {
            /* TINFO="[DrvPWRAP_InitSiStrobe][Read Test] pass, ind=%x", ind */
    ...
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SI_CK_CON, (ind >> 2) & 0x7); // Configure SI_EN_SEL & SI_CK_SEL
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIDLY, 0x3 - (ind & 0x3)); // Configure SIDLY
#endif // End of #if defined(ULPOSC)
...
kal_uint32 DrvPWRAP_ManAccess(kal_uint32 write, kal_uint32 adr, kal_uint32 wdata, kal_uint32 *rdata )
{
    ...
    if((adr   & ~(0xffff)) != 0)  return PMIC_WRAP_INVALID_ADDR; // Address should no larger than 0xFFFF
    if((wdata & ~(0xffff)) != 0)  return PMIC_WRAP_INVALID_WDATA; // Write DATA should be no larger than 0xFFFF
#if defined(MT6331) || defined(MT6332) || defined(MT6325) || defined(MT6328) || defined(MT6351) || defined(MT6353)
    ...
    man_wdata = adr >> 1;
    DrvPWRAP_Man(OP_WR,  OP_OUTD, (man_wdata & 0xff), &man_rdata);
#else /* defined(MT6331) || defined(MT6332) || defined(MT6325) || defined(MT6328) || defined(MT6351) || defined(MT6353)  || defined(MT6353) and later */
...
#elif defined(MT6351)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6351_DEW_CRC_SWRST, 0x01, &rdata); // Set 1 to reset CRC calculation circuit.
#elif defined(MT6353)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6353_DEW_CRC_SWRST, 0x01, &rdata); // Set 1 to reset CRC calculation circuit.
#else
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, PMIC_DEW_CRC_SWRST, 0x01, &rdata); // Set 1 to reset CRC calculation circuit.
#endif
...
#elif defined(MT6351)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6351_DEW_CRC_SWRST, 0x00, &rdata); // Set 0 to reset CRC calculation circuit.
#elif defined(MT6353)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6353_DEW_CRC_SWRST, 0x00, &rdata); // Set 0 to reset CRC calculation circuit.
#else
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, PMIC_DEW_CRC_SWRST, 0x00, &rdata); // Set 0 to reset CRC calculation circuit.
#endif
...
//        wdata = rdata & ~(0x8000); // 26Mhz
    ...
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0x88);
  	...
  	DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_RDDMY_NO, 0xD, &rdata);
  	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0xDD);
#else
	// Set Dummy cycle 6351 (assume 18MHz)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6351_DEW_RDDMY_NO, 0x08, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0x88);
#endif // End of #ifdef ULPOSC
#elif defined(MT6353)
#ifdef ULPOSC
  	// Set Dummy cycle 6353 (assume 18MHz)
  	DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_RDDMY_NO, 0xD, &rdata);
  	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0xDD);
#else
	// Set Dummy cycle 6353 (assume 18MHz)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6353_DEW_RDDMY_NO, 0x08, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0x88);
#endif // End of #ifdef ULPOSC
#else /* #if defined(MT6355) and later */
#ifdef ULPOSC
  	// Set Dummy cycle 6351 (assume 18MHz)
  	DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_RDDMY_NO, 0xD, &rdata);
  	PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0xDD);
#else
	// Set Dummy cycle 6351 (assume 18MHz)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, PMIC_DEW_RDDMY_NO, 0x08, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0x88);
#endif // End of #ifdef ULPOSC
#endif
...
#endif // End of #if defined(MT6325) || defined(MT6328) || defined(MT6351) || defined(MT6353)
...
kal_uint32 DrvPWRAP_Read_Test(kal_bool NoChk)
{
    ...
    {
        DrvPWRAP_WACS2(PMIC_WRAP_READ, MT6351_DEW_READ_TEST, 0x00, &rdata);
    }
    ...
    {
        DrvPWRAP_WACS2(PMIC_WRAP_READ, MT6353_DEW_READ_TEST, 0x00, &rdata);
    }
    ...
    {
        DrvPWRAP_WACS2(PMIC_WRAP_READ, PMIC_DEW_READ_TEST, 0x00, &rdata);
    }
