...
#define UART1_HDMA_RX_CHANNEL		4
//MD1 UART
#define UART2_HDMA_TX_CHANNEL		3
#define UART2_HDMA_RX_CHANNEL		5
//AP0 UART
#define UART3_HDMA_TX_CHANNEL		1
#define UART3_HDMA_RX_CHANNEL		3
...
#define GDMA_GISAR_UART				(GDMA_BASE_ADDR + 0x608)                                        //GDMA_GISAR3
#define GDMA_GIMRK_UART				(GDMA_BASE_ADDR + 0x628)                                        //GDMA_GIMRK3
