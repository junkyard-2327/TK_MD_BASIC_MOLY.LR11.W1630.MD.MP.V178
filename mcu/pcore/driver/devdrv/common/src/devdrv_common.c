...
#if !defined(TK6291) && defined(__SIM_HOT_SWAP_SUPPORT__)
...
const kal_uint32 devdrv_dump_regions[] = {
  ...
  /*Base Address,                length,   type(0/1=byte access, 2=16-bit access, 4=32-bit access)  */
    ...
    (BASE_ADDR_L2ULSBDMA+0x100), 0x014c, 4,
    BASE_ADDR_L2ULHBDMA,         0x00b4, 4,
    (BASE_ADDR_L2DLSBDMA+0x100), 0x0148, 4,
    BASE_ADDR_L2DLHBDMA,         0x0234, 4,
    BASE_ADDR_L2PSEUPHY,         0x0078, 4,
    (BASE_ADDR_L2SOINDMA+0x100), 0x00f4, 4,
    (BASE_ADDR_L2SOOUTDMA+0x100),0x00bc, 4,
    BASE_ADDR_L2ULLMAC,          0x0070, 4,
    BASE_ADDR_L2DLLMAC,          0x0340, 4,
    ...
    BASE_ADDR_L2DLSECCTL,        0x0130, 4,
    BASE_ADDR_L2SOSECCTL,        0x0020, 4,
    BASE_ADDR_L2MISC,            0x032c, 4,
    BASE_ADDR_L2ULBUFMNG,        0x0364, 4,
    (BASE_ADDR_L2ULBUFMNG+0x500),0x0060, 4,
    BASE_ADDR_L2DLBUFMNG,        0x03f0, 4,
    (BASE_ADDR_L2DLBUFMNG+0x500),0x0060, 4,
    BASE_MADDR_PSMCU_BUSMON,     0x0608, 4,
    BASE_MADDR_MDINFRABUSMON,    0x0608, 4,
    BASE_MADDR_MDINFRAMISC, 	 0x0210, 4,
    BASE_MADDR_MDBUSRECORDER,    0x0418, 4,
    BASE_MADDR_MDSYS_CLKCTL, 	 0x00C0, 4,
    (BASE_MADDR_MDSYS_CLKCTL+0x1000), 	 0x0008, 4,
    BASE_MADDR_MDTOP_GLBCON, 	 0x0110, 4,
    (BASE_MADDR_MDTOP_GLBCON+0x400), 	 0x0004, 4,
    (BASE_MADDR_MDTOP_GLBCON+0x800), 	 0x0008, 4,
    (BASE_MADDR_MDTOP_GLBCON+0xC00), 	 0x0010, 4,
    (BASE_MADDR_MDTOP_GLBCON+0x1000), 	 0x0008, 4,
    BASE_MADDR_MDTOP_PLLMIXED, 	 0x0098, 4,
    (BASE_MADDR_MDTOP_PLLMIXED+0x200), 	 0x0008, 4,
    (BASE_MADDR_MDTOP_PLLMIXED+0x300), 	 0x0010, 4,
    (BASE_MADDR_MDTOP_PLLMIXED+0x400), 	 0x0138, 4,
    (BASE_MADDR_MDTOP_PLLMIXED+0x600), 	 0x0034, 4,
    (BASE_MADDR_MDTOP_PLLMIXED+0x800), 	 0x0008, 4,
    (BASE_MADDR_MDTOP_PLLMIXED+0x1000), 	 0x0008, 4,
    BASE_MADDR_MDTOP_CLKSW, 	 0x0048, 4,
    (BASE_MADDR_MDTOP_CLKSW+0x100), 	 0x0008, 4,
    (BASE_MADDR_MDTOP_CLKSW+0x1000), 	 0x0008, 4,
    #if defined(MT6755)||defined(MT6797)||defined(MT6757)||defined(MT6750S)
    (BASE_MADDR_INFRASYS_CONFIG_REGS+0x250),	0x0010, 4,
    (BASE_MADDR_APINFRA_MD_SMI+0x100),	0x0528, 4,
    #endif
    (BASE_MADDR_MDGDMA), 0x720, 4,
  #else /* MT6290 */
