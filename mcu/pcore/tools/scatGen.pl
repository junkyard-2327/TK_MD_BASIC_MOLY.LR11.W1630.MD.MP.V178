...
my $COPRO_INFO_FILE_2       = $COPRO_INFO_FILE."2";
...
CommonUtil::HashStringParser(CommonUtil::GetFileContent($COPRO_INFO_FILE_2), \%MAKEFILE_OPTIONS) if (-e $COPRO_INFO_FILE_2);	
my %CmplOption;
my %RelOption;
...
# return:      x
# require:    pcore/tools/scatGenLib.pl -> scatGen_main();
#****************************************************************************
sub GenMAUIScatter
{
    #$Is_Flashtool_Layout : 0=normal layout, 1=flashtool required layout
