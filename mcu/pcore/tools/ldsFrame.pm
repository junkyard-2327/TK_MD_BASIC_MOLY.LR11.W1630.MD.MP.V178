...
sub ldsFrame_verno
{
    return " u0.03";
           ...
           # u0.01,   2014/02/20 by BM,  Initial version
...
sub GetPath
{
    ...
    my $strDefaultSystemFolder = "./pcore/custom/system";
...
sub AvoidOrphanSECTIONS
{
    ...
    $strLayout = " "x4 ."\/\* If build fail with logs in link.log like this \n".
                 ...
                 " "x8 ."Please use correct input section name by following the rules in mcu/pcore/custom/system/Template/lds_config/InputSectionRule.txt\n".
