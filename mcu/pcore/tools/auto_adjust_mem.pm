...
# Constants
#****************************************************************************
my $AAPMC_VERNO     = " LR11_v0.01";
           # LR11_v0.01,   2015/08/31,  Carl,   Reduce total memory size of MT6755 and MT6797 from 160MB to 128MB (add error code TOTAL_MD_MEMORY_SIZE_EXCEED_LIMIT)
...
use constant TOTAL_MD_MEMORY_SIZE_EXCEED_LIMIT => 6;
...
sub QueryErrMeaning
{
    ...
    return "[$ERR]TOTAL_MD_MEMORY_SIZE_EXCEED_LIMIT, FAIL" if($ERR == TOTAL_MD_MEMORY_SIZE_EXCEED_LIMIT);
