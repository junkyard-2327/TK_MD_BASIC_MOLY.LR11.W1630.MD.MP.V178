...
# 2 >>> Run Process
#****************************************************************************
$g_exit = &RunProcess("perl pcore/tools/sysGen1.pl $BB_PATH", 0);
$g_exit = &RunProcess("perl pcore/tools/scatGen.pl $ARGV[0] $ARGV[1] \"$ARGV[2]\" $ARGV[3] $ARGV[4] $ARGV[5] $ARGV[6] $ARGV[7] $ARGV[8]", $g_exit);
