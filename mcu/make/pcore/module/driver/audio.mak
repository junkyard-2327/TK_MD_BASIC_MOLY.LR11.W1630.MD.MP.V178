...
SRC_LIST += $(strip $(AUDFOLDER))/am.c \
            ...
            ${CORE_ROOT}/driver/audio/src/audio_create.c \
            $(strip $(AUDFOLDER))/speech_service.c

SRC_LIST += $(strip $(AUDFOLDER))/od_memcpy.S

# AFE part
AFE_SPLIT_DRIVER_PLATFORM  = MT6280 MT6589 MT6572 MT6582 MT6290 MT6592 MT6571 MT6595 TK6291 MT6755 MT6797 MT6750 MT6757 MT6750S
ifneq ($(filter $(strip $(MODULE_DEFS)), $(AFE_SPLIT_DRIVER_PLATFORM)),)
   ...
   ifeq ($(strip $(PLATFORM)),TK6291)
     SRC_LIST += $(strip $(AUDFOLDER))/afes/afe_6291.c
   endif
...
ifneq ($(filter __VOLTE_SUPPORT__, $(strip $(MODULE_DEFS))),)
   ...
   ifneq ($(filter __EVS_SUPPORT__, $(strip $(MODULE_DEFS))),)   
      SRC_LIST += $(strip $(AUDFOLDER))/pcmrb.c
      SRC_LIST += $(strip $(AUDFOLDER))/streamrb.c
   endif   
endif
...
INC_DIR = $(strip $(AUDFOLDER)) \
          ...
          ${CORE_ROOT}/driver/audio/lib/MTKINC \
...
ifneq ($(filter __CENTRALIZED_SLEEP_MANAGER__, $(strip $(MODULE_DEFS))),)
  INC_DIR    += ${CORE_ROOT}/driver/sleep_drv/public/inc
endif
...
SRC_PATH += ${CORE_ROOT}/driver/audio/src
