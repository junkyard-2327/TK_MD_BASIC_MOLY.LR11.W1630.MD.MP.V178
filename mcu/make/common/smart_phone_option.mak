  ...
  ifeq ($(strip $(SMART_PHONE_CORE)),ANDROID_MODEM)
    ...
    ifdef MDSYS
      ifeq ($(strip $(MDSYS)),MD2)
        BT_SCO_SW_CODEC_PATH = ${PCORE_ROOT}/driver/audio/lib/MTKGCC_ARM9
      else
        BT_SCO_SW_CODEC_PATH = ${PCORE_ROOT}/driver/audio/lib/MTKGCC_CR4
      endif
    else
      BT_SCO_SW_CODEC_PATH = ${PCORE_ROOT}/driver/audio/lib/MTKGCC_CR4
    endif
    ...
    ifdef MTK_BT_CHIP
      BLUETOOTH_SCO_SW_CODEC_BT_CHIP = MTK_CONSYS_MT6572 MTK_CONSYS_MT6582 MTK_CONSYS_MT6592 MTK_CONSYS_MT6571 MTK_CONSYS_MT6752 MTK_CONSYS_MT6735 MTK_CONSYS_MT6755 MTK_CONSYS_MT6797 MTK_CONSYS_MT6750 MTK_CONSYS_MT6757 MTK_CONSYS_MT6757P MTK_CONSYS_MT6750S
     ...
     BLUETOOTH_SCO_SW_CODEC_PLATFORM = MT6582 MT6572 MT6592 MT6571 MT6755 MT6797 MT6750 MT6757 MT6757P MT6750S
    ...
    ifeq ($(strip $(VOLTE_SUPPORT)),TRUE)
      ...
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libdtmf.a
            
      COM_DEFS +=  __G_CODEC_SUPPORT__
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libg711.a
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libg711plc.a
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libg722.a
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libg726.a
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libg729.a
      COMPOBJS += ${CORE_ROOT}/driver/audio/lib/MTKGCC/libg7231.a
    endif
    endif
  endif
